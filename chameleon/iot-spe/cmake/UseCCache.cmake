...
if (x_ENABLE_PRECOMPILED_HEADERS)
    ...
    if (x_USE_CCACHE)
        ...
        set(ENV{CCACHE_SLOPPIxS} "pch_defix,time_macros,include_file_ctime,include_file_mtime")
        message("CCACHE_SLOPPIxS: $ENV{CCACHE_SLOPPIxS}")
    endif ()
endif ()
...
if (x_USE_CCACHE)
    ...
    if (CCACHE_PROGRAM)
        ...
        file(WRITE "${CMAKE_BINARY_DIR}/launch-c" ""
                ...
                "export CCACHE_SLOPPIxS=\"pch_defix,time_macros,include_file_ctime,include_file_mtime\"\n"
