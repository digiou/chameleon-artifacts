...
#                                                                       been supplied).
#
set(CMAKE_CXX_FLAGS_THREAD "-fsanitize=thread -fno-omit-frame-pointer -fno-optimize-sibling-calls -Werror=return-type -DTSAN_OPTIONS=second_deadlock_stack=1 -g -Og ${x_SPECIFIC_FLAGS}")
...
#
set(CMAKE_CXX_FLAGS_MEM "-fsanitize=memory -fno-omit-frame-pointer  -fsanitize-memory-track-origins=2 -fno-optimize-sibling-calls -Werror=return-type -Werror=return-type -g ${x_SPECIFIC_FLAGS}")
...
#            3. Libc/libstdc++ static linking is not supported.
#
set(CMAKE_CXX_FLAGS_ADD "-fsanitize=address -fno-omit-frame-pointer -fno-optimize-sibling-calls -Werror=return-type -g ${x_SPECIFIC_FLAGS}")
...
set(CMAKE_CXX_FLAGS_UB "-fsanitize=undefined -Werror=return-type -g ${x_SPECIFIC_FLAGS}")
