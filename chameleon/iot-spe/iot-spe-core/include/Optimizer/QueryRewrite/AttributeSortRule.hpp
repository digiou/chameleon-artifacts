...
#ifndef x_CORE_INCLUDE_OPTIMIZER_QUERYREWRITE_ATTRIBUTESORTRULE_HPP_
#define x_CORE_INCLUDE_OPTIMIZER_QUERYREWRITE_ATTRIBUTESORTRULE_HPP_
...
#endif// x_CORE_INCLUDE_OPTIMIZER_QUERYREWRITE_ATTRIBUTESORTRULE_HPP_
