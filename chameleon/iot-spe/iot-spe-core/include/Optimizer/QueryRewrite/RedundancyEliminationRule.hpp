...
#ifndef x_CORE_INCLUDE_OPTIMIZER_QUERYREWRITE_REDUNDANCYELIMINATIONRULE_HPP_
#define x_CORE_INCLUDE_OPTIMIZER_QUERYREWRITE_REDUNDANCYELIMINATIONRULE_HPP_
...
class RedundancyEliminationRule : public BaseRewriteRule {
  ...
  private:
     ...
     */
    static x::ExpressionNodePtr eliminateRedundancy(const ExpressionNodePtr& predicate);
     ...
     * @return updated predicate
     */
    static x::ExpressionNodePtr constantMoving(const ExpressionNodePtr& predicate);
     ...
     * @return updated predicate
     */
    static x::ExpressionNodePtr constantFolding(const ExpressionNodePtr& predicate);
     ...
     * @return updated predicate
     */
    static x::ExpressionNodePtr arithmeticSimplification(const ExpressionNodePtr& predicate);
     ...
     * @return updated predicate
     */
    static x::ExpressionNodePtr conjunctionDisjunctionSimplification(const ExpressionNodePtr& predicate);
};

}// namespace x::Optimizer

#endif// x_CORE_INCLUDE_OPTIMIZER_QUERYREWRITE_REDUNDANCYELIMINATIONRULE_HPP_
