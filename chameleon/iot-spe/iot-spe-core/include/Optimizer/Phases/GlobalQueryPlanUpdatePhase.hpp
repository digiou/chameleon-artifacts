...
#ifndef x_CORE_INCLUDE_OPTIMIZER_PHASES_GLOBALQUERYPLANUPDATEPHASE_HPP_
#define x_CORE_INCLUDE_OPTIMIZER_PHASES_GLOBALQUERYPLANUPDATEPHASE_HPP_
...
class Request;
using xRequestPtr = std::shared_ptr<Request>;
...
class GlobalQueryPlanUpdatePhase {
  public:
     ...
     */
    GlobalQueryPlanPtr execute(const std::vector<xRequestPtr>& xRequests);
  ...
  private:
     ...
     */
    void processRemoveTopologyLinkRequest(const x::Experimental::RemoveTopologyLinkRequestPtr& removeTopologyLinkRequest);

    /**
     * @brief Process Remove Topology Node request
     * @param removeTopologyNodeRequest: Remove Topology Node request
     */
    void processRemoveTopologyNodeRequest(const x::Experimental::RemoveTopologyNodeRequestPtr& removeTopologyNodeRequest);
...
#endif// x_CORE_INCLUDE_OPTIMIZER_PHASES_GLOBALQUERYPLANUPDATEPHASE_HPP_
