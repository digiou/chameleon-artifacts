...
#ifndef x_CORE_INCLUDE_OPTIMIZER_PHASES_TYPEINFERENCEPHASECONTEXT_HPP_
#define x_CORE_INCLUDE_OPTIMIZER_PHASES_TYPEINFERENCEPHASECONTEXT_HPP_

#include <Catalogs/UDF/UDFCatalog.hpp>
#include <memory>

namespace x::Catalogs {
...
#endif// x_CORE_INCLUDE_OPTIMIZER_PHASES_TYPEINFERENCEPHASECONTEXT_HPP_
