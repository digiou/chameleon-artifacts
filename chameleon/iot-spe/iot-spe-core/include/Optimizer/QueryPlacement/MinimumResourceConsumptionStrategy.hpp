...
#ifndef x_CORE_INCLUDE_OPTIMIZER_QUERYPLACEMENT_MINIMUMRESOURCECONSUMPTIONSTRATEGY_HPP_
#define x_CORE_INCLUDE_OPTIMIZER_QUERYPLACEMENT_MINIMUMRESOURCECONSUMPTIONSTRATEGY_HPP_
...
class MinimumResourceConsumptionStrategy : public BasePlacementStrategy {
  ...
  public:
    ...
    static std::unique_ptr<MinimumResourceConsumptionStrategy> create(xTopologyPlanPtr xTopologyPlan) {
        return std::make_unique<MinimumResourceConsumptionStrategy>(MinimumResourceConsumptionStrategy(xTopologyPlan));
    }

  private:
    MinimumResourceConsumptionStrategy(xTopologyPlanPtr xTopologyPlan);
...
#endif// x_CORE_INCLUDE_OPTIMIZER_QUERYPLACEMENT_MINIMUMRESOURCECONSUMPTIONSTRATEGY_HPP_
