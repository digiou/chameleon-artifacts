...
#ifndef x_CORE_INCLUDE_OPTIMIZER_QUERYPLACEMENT_IFCOPSTRATEGY_HPP_
#define x_CORE_INCLUDE_OPTIMIZER_QUERYPLACEMENT_IFCOPSTRATEGY_HPP_
...
class IFCOPStrategy : public BasePlacementStrategy {
  ...
  private:
     ...
     */
    PlacementMatrix getPlacementCandidate(x::QueryPlanPtr queryPlan);
     ...
     */
    double getCost(const PlacementMatrix& placementCandidate, x::QueryPlanPtr queryPlan, double costRatio);
     ...
     */
    double getLocalCost(const std::vector<bool>& nodePlacement, x::QueryPlanPtr queryPlan);
     ...
     */
    double
    getNetworkCost(const TopologyNodePtr currentNode, const PlacementMatrix& placementCandidate, x::QueryPlanPtr queryPlan);
     ...
     */
    void assignRemainingOperator(x::QueryPlanPtr queryPlan,
                                 uint32_t topoIdx,
...
#endif// x_CORE_INCLUDE_OPTIMIZER_QUERYPLACEMENT_IFCOPSTRATEGY_HPP_
