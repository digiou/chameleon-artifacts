...
#ifndef x_CORE_INCLUDE_OPTIMIZER_QUERYPLACEMENT_BASEPLACEMENTSTRATEGY_HPP_
#define x_CORE_INCLUDE_OPTIMIZER_QUERYPLACEMENT_BASEPLACEMENTSTRATEGY_HPP_
...
class xExecutionPlan;
using xExecutionPlanPtr = std::shared_ptr<xExecutionPlan>;
...
class BasePlacementStrategy {
  ...
  public:
     ...
     */
    static void pinOperators(QueryPlanPtr queryPlan, const TopologyPtr& topology, x::Optimizer::PlacementMatrix& matrix);
...
#endif// x_CORE_INCLUDE_OPTIMIZER_QUERYPLACEMENT_BASEPLACEMENTSTRATEGY_HPP_
