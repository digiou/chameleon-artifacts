...
#ifndef x_CORE_INCLUDE_OPTIMIZER_QUERYVALIDATION_SEMANTICQUERYVALIDATION_HPP_
#define x_CORE_INCLUDE_OPTIMIZER_QUERYVALIDATION_SEMANTICQUERYVALIDATION_HPP_
...
class SemanticQueryValidation {
  ...
  private:
     ...
     * @param sourceCatalog: source catalog
     */
    static void logicalSourceValidityCheck(const x::QueryPlanPtr& queryPlan,
     ...
     * @param sourceCatalog: source catalog
     */
    static void physicalSourceValidityCheck(const x::QueryPlanPtr& queryPlan,
                                            const Catalogs::Source::SourceCatalogPtr& sourceCatalog);
...
#endif// x_CORE_INCLUDE_OPTIMIZER_QUERYVALIDATION_SEMANTICQUERYVALIDATION_HPP_
