...
#ifndef x_CORE_INCLUDE_VIEWS_MATERIALIZEDVIEW_HPP_
#define x_CORE_INCLUDE_VIEWS_MATERIALIZEDVIEW_HPP_
 ...
 * Materialized views in x 'materialize' the result of streaming queryIdAndCatalogEntryMapping for further processing.
 */
class MaterializedView {
...
#endif// x_CORE_INCLUDE_VIEWS_MATERIALIZEDVIEW_HPP_
