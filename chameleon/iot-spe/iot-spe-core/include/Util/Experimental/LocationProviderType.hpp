...
#ifndef x_CORE_INCLUDE_UTIL_EXPERIMENTAL_LOCATIONPROVIDERTYPE_HPP_
#define x_CORE_INCLUDE_UTIL_EXPERIMENTAL_LOCATIONPROVIDERTYPE_HPP_
...
#endif// x_CORE_INCLUDE_UTIL_EXPERIMENTAL_LOCATIONPROVIDERTYPE_HPP_
