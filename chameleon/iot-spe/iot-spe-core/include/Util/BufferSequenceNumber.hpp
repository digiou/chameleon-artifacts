...
#ifndef x_CORE_INCLUDE_UTIL_BUFFERSEQUENCENUMBER_HPP_
#define x_CORE_INCLUDE_UTIL_BUFFERSEQUENCENUMBER_HPP_
...
namespace std {
template<>
struct hash<x::BufferSequenceNumber> {
    uint64_t operator()(const x::BufferSequenceNumber& sn) const { return sn.getSequenceNumber() ^ sn.getOriginId(); }
};
}// namespace std
#endif// x_CORE_INCLUDE_UTIL_BUFFERSEQUENCENUMBER_HPP_
