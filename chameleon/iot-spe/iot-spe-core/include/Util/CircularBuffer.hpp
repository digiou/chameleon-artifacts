...
#ifndef x_CORE_INCLUDE_UTIL_CIRCULARBUFFER_HPP_
#define x_CORE_INCLUDE_UTIL_CIRCULARBUFFER_HPP_
 ...
 * takes as argument the const-xs (true/false) to avoid
...
#endif// x_CORE_INCLUDE_UTIL_CIRCULARBUFFER_HPP_
