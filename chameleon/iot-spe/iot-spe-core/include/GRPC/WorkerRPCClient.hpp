...
#ifndef x_CORE_INCLUDE_GRPC_WORKERRPCCLIENT_HPP_
#define x_CORE_INCLUDE_GRPC_WORKERRPCCLIENT_HPP_
...
class WorkerRPCClient {
  public:
     ...
     */
    x::Spatial::DataTypes::Experimental::Waypoint getWaypoint(const std::string& address);
...
#endif// x_CORE_INCLUDE_GRPC_WORKERRPCCLIENT_HPP_
