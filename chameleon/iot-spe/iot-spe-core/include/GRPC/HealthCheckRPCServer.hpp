...
#ifndef x_CORE_INCLUDE_GRPC_HEALTHCHECKRPCSERVER_HPP_
#define x_CORE_INCLUDE_GRPC_HEALTHCHECKRPCSERVER_HPP_
#include <map>
#include <mutex>
...
#endif// x_CORE_INCLUDE_GRPC_HEALTHCHECKRPCSERVER_HPP_
