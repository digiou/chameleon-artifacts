...
#ifndef x_CORE_INCLUDE_GRPC_COORDINATORRPCSERVER_HPP_
#define x_CORE_INCLUDE_GRPC_COORDINATORRPCSERVER_HPP_
...
#endif// x_CORE_INCLUDE_GRPC_COORDINATORRPCSERVER_HPP_
