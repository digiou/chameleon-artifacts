...
#ifndef x_CORE_INCLUDE_GRPC_SERIALIZATION_OPERATORSERIALIZATIONUTIL_HPP_
#define x_CORE_INCLUDE_GRPC_SERIALIZATION_OPERATORSERIALIZATIONUTIL_HPP_
...
class OperatorSerializationUtil {
  public:
    ...
    */
     ...
     */
    static void serializeOpenCLOperator(const x::OpenCLLogicalOperatorNode& openCLLogicalOperatorNode,
                                        SerializableOperator& serializedOperator);
...
#endif// x_CORE_INCLUDE_GRPC_SERIALIZATION_OPERATORSERIALIZATIONUTIL_HPP_
