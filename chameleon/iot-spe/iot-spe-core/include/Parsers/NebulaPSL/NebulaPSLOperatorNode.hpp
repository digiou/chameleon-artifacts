...
#ifndef x_CORE_INCLUDE_PARSERS_IoTSPEPSL_IoTSPEPSLOPERATORNODE_HPP_
#define x_CORE_INCLUDE_PARSERS_IoTSPEPSL_IoTSPEPSLOPERATORNODE_HPP_
...
/**
 * @brief This class defix the attributes and methods used by the PatternParsingService.
 * This enables the parsing of declarative patterns into x queries.
...
class IoTSPEPSLOperatorNode {
  public:
    //Constructors
    explicit IoTSPEPSLOperatorNode(int32_t id);
    // Getter and Setter
    int32_t getId() const;
...
#endif// x_CORE_INCLUDE_PARSERS_IoTSPEPSL_IoTSPEPSLOPERATORNODE_HPP_
