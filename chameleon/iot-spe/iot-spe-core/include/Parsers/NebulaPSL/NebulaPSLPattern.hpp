...
#ifndef x_CORE_INCLUDE_PARSERS_IoTSPEPSL_IoTSPEPSLPATTERN_HPP_
#define x_CORE_INCLUDE_PARSERS_IoTSPEPSL_IoTSPEPSLPATTERN_HPP_
 ...
 */
class IoTSPEPSLPattern {
  public:
    //Constructors
    IoTSPEPSLPattern() = default;
    // Getter and Setter
    const std::map<int32_t, std::string>& getSources() const;
    void setSources(const std::map<int32_t, std::string>& sources);
    const std::map<int32_t, IoTSPEPSLOperatorNode>& getOperatorList() const;
    void setOperatorList(const std::map<int32_t, IoTSPEPSLOperatorNode>& operatorList);
     ...
     * @param opNode
     */
    void addOperatorNode(IoTSPEPSLOperatorNode operatorNode);

  private:
    std::map<int32_t, std::string> sourceList;
    std::map<int32_t, IoTSPEPSLOperatorNode> operatorList;// contains the operators from the PATTERN clause
...
#endif// x_CORE_INCLUDE_PARSERS_IoTSPEPSL_IoTSPEPSLPATTERN_HPP_
