...
#ifndef x_CORE_INCLUDE_PARSERS_IoTSPEPSL_IoTSPEPSLQUERYPLANCREATOR_HPP_
#define x_CORE_INCLUDE_PARSERS_IoTSPEPSL_IoTSPEPSLQUERYPLANCREATOR_HPP_
...
#include <Parsers/IoTSPEPSL/gen/xCEPBaseListener.h>
 ...
 */
class xCEPQueryPlanCreator : public xCEPBaseListener {
  public:
     ...
     * each keyword in the AST has its two functions, enter (when X is visited) and exist (called after all children of X have been visited), contained in the parent class xCEPBaseListener,
     * auto-generated by the ANTLR dependency (gen-folders)
     */

    //ListEvents
    /** @brief mix pattern from the PATTERN clause
      * @param context
      */
    void enterListEvents(xCEPParser::ListEventsContext* context) override;
    ...
    void enterEventElem(xCEPParser::EventElemContext* context) override;
    ...
    void enterEvent(xCEPParser::EventContext* context) override;*/
    ...
    /**
      ...
      * @param context
      */
    void exitOperatorRule(xCEPParser::OperatorRuleContext* context) override;

    // FROM clause
    /** @brief substitutes the input stream alias by its real name in every subPattern
      * @param context
      */
    void exitInputStream(xCEPParser::InputStreamContext* context) override;

    // WHERE clause
    /** @brief marks that the tree walker starts parsing a WHERE clause
      * @param context
      */
    void enterWhereExp(xCEPParser::WhereExpContext* context) override;

    /** @brief marks that the tree walker finished parsing the WHERE clause
      * @param context
      */
    void exitWhereExp(xCEPParser::WhereExpContext* context) override;
    ...
    /**
      ...
      * @param context
      */
    void enterSink(xCEPParser::SinkContext* context) override;

    /** @brief append the list of sinks to the query plan
      * @param context
      */
    void exitSinkList(xCEPParser::SinkListContext* context) override;

    // WITHIN clause
    /** @brief
      * @param context
      */
    void exitInterval(xCEPParser::IntervalContext* cxt) override;

    /**
      * @brief collects all projection attributes
      * @param context
      */
    void enterOutAttribute(xCEPParser::OutAttributeContext* context) override;

    /**
      * @brief add the appropriate iteration operator to the OperatorList
      * @param context
      */
    void enterQuantifiers(xCEPParser::QuantifiersContext* context) override;

    /**
         * @brief extracts WHERE Expressions
         * @param context
         */
    void exitBinaryComparisonPredicate(xCEPParser::BinaryComparasionPredicateContext* context) override;

    /**
         * @brief extracts Attributes in the WHERE
         * @param context
         */
    void enterAttribute(xCEPParser::AttributeContext* context) override;

    /**
     * @brief this method creates the query from the xPattern
     */
    ...
    QueryPlanPtr addBinaryOperatorToQueryPlan(std::string operaterName,
                                              std::map<int, IoTSPEPSLOperatorNode>::const_iterator iterator,
...
#endif// x_CORE_INCLUDE_PARSERS_IoTSPEPSL_IoTSPEPSLQUERYPLANCREATOR_HPP_
