...
#ifndef x_CORE_INCLUDE_PARSERS_IoTSPEPSL_GEN_xCEPPARSER_H_
#define x_CORE_INCLUDE_PARSERS_IoTSPEPSL_GEN_xCEPPARSER_H_

#include <antlr4-runtime.h>

namespace x::Parsers {

class xCEPParser : public antlr4::Parser {
  public:
    enum {
        T__0 = 1,
        T__1 = 2,
    ...
    explicit xCEPParser(antlr4::TokenStream* input);
    ~xCEPParser();
    ...
    class BinaryComparasionPredicateContext : public PredicateContext {
      public:
        ...
        xCEPParser::PredicateContext* left = nullptr;
        xCEPParser::PredicateContext* right = nullptr;
    ...
    class BitExpressionAtomContext : public ExpressionAtomContext {
      public:
        ...
        xCEPParser::ExpressionAtomContext* left = nullptr;
        xCEPParser::ExpressionAtomContext* right = nullptr;
    ...
    class xtedExpressionAtomContext : public ExpressionAtomContext {
      public:
        xtedExpressionAtomContext(ExpressionAtomContext* ctx);
...
#endif// x_CORE_INCLUDE_PARSERS_IoTSPEPSL_GEN_xCEPPARSER_H_
