...
#ifndef x_CORE_INCLUDE_RUNTIME_INMEMORYLINEAGEMANAGER_HPP_
#define x_CORE_INCLUDE_RUNTIME_INMEMORYLINEAGEMANAGER_HPP_
...
class InMemoryLineageManager : public AbstractLineageManager {
  ...
  private:
    ///this unordered map maps new buffer sequence numbers to old ox, which tuple buffer had before a statefull operator
...
#endif// x_CORE_INCLUDE_RUNTIME_INMEMORYLINEAGEMANAGER_HPP_
