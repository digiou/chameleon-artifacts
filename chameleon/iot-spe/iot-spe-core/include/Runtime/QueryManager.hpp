...
*/
#ifndef x_CORE_INCLUDE_RUNTIME_QUERYMANAGER_HPP_
#define x_CORE_INCLUDE_RUNTIME_QUERYMANAGER_HPP_
...
class AbstractQueryManager : public x::detail::virtual_enable_shared_from_this<AbstractQueryManager, false>,
                             public Reconfigurable {
  public:
    using inherited0 = x::detail::virtual_enable_shared_from_this<AbstractQueryManager, false>;
    ...
    */
    ...
    virtual ~AbstractQueryManager() x_NOEXCEPT(false) override;
...
#endif// x_CORE_INCLUDE_RUNTIME_QUERYMANAGER_HPP_
