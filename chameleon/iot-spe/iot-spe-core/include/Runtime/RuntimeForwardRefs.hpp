...
#ifndef x_CORE_INCLUDE_RUNTIME_RUNTIMEFORWARDREFS_HPP_
#define x_CORE_INCLUDE_RUNTIME_RUNTIMEFORWARDREFS_HPP_
...
enum class NumaAwarexsFlag : int8_t { ENABLED, DISABLED };
...
#endif// x_CORE_INCLUDE_RUNTIME_RUNTIMEFORWARDREFS_HPP_
