...
*/
#ifndef x_CORE_INCLUDE_RUNTIME_GPURUNTIME_CUDAKERNELWRAPPER_HPP_
#define x_CORE_INCLUDE_RUNTIME_GPURUNTIME_CUDAKERNELWRAPPER_HPP_
...
/**
 * @brief This class is a wrapper for executing CUDA kernel as part of ExecutablePipelixtage
  ...
  public:
    ...
    void execute(InputRecord* hostInputBuffer,
        ...
        if (gpuBufferSize < numberOfInputTuples * sizeof(InputRecord)) {
            x_ERROR("Tuples to process exceed the allocated GPU buffer.");
...
#endif// x_CORE_INCLUDE_RUNTIME_GPURUNTIME_CUDAKERNELWRAPPER_HPP_
