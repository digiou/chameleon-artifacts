...
#ifndef x_CORE_INCLUDE_RUNTIME_NODEENGINE_HPP_
#define x_CORE_INCLUDE_RUNTIME_NODEENGINE_HPP_
 ...
 * query processing part of x. It provides basic functionality
 * such as deploying, undeploying, starting, and stopping.
 *
 */
class NodeEngine : public Network::ExchangeProtocolListener,
                   public x::detail::virtual_enable_shared_from_this<NodeEngine>,
  ...
  public:
    ...
    */
     ...
     */
    x::Experimental::MaterializedView::MaterializedViewManagerPtr getMaterializedViewManager() const;

    ///// Network Callback //////

    /**
     * @brief this callback is called once a tuple buffer arrives on the network manager
     * for a given x partition
     */
    void onDataBuffer(Network::xPartition, TupleBuffer&) override;

    /**
     * @brief this callback is called once a tuple buffer arrives on the network manager
     * for a given x partition
     */
    void onEvent(Network::xPartition, Runtime::BaseEvent&) override;
  ...
  public:
    ...
    explicit NodeEngine(std::vector<PhysicalSourcePtr> physicalSources,
                        ...
                        x::Experimental::MaterializedView::MaterializedViewManagerPtr&&,
                        OpenCLManagerPtr&&,
  ...
  private:
    ...
    AbstractQueryStatusListenerPtr xWorker;
...
#endif// x_CORE_INCLUDE_RUNTIME_NODEENGINE_HPP_
