...
#ifndef x_CORE_INCLUDE_RUNTIME_EXECUTION_EXECUTABLEQUERYPLAN_HPP_
#define x_CORE_INCLUDE_RUNTIME_EXECUTION_EXECUTABLEQUERYPLAN_HPP_
 ...
 * Each executable query plan contains a set of sources, pipelix, and sinks.
...
class ExecutableQueryPlan : public Reconfigurable, public RuntimeEventListener {
    friend class x::Network::NetworkSink;
  ...
  public:
     ...
     * @param pipelix vector of pipelix
     ...
     * @return
     */
    const std::vector<ExecutablePipelinePtr>& getPipelix() const;
...
#endif// x_CORE_INCLUDE_RUNTIME_EXECUTION_EXECUTABLEQUERYPLAN_HPP_
