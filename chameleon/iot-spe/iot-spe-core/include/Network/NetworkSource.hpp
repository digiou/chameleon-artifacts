...
#ifndef x_CORE_INCLUDE_NETWORK_NETWORKSOURCE_HPP_
#define x_CORE_INCLUDE_NETWORK_NETWORKSOURCE_HPP_
...
class NetworkSource : public DataSource {
   ...
   */
    ...
    friend bool operator<(const NetworkSource& lhs, const NetworkSource& rhs) { return lhs.xPartition < rhs.xPartition; }
...
#endif// x_CORE_INCLUDE_NETWORK_NETWORKSOURCE_HPP_
