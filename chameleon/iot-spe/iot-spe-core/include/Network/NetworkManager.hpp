...
#ifndef x_CORE_INCLUDE_NETWORK_NETWORKMANAGER_HPP_
#define x_CORE_INCLUDE_NETWORK_NETWORKMANAGER_HPP_
...
class NetworkManager {
  public:
     ...
     * @param xPartition the id of the logical channel between sender and receiver
     ...
     */
    bool registerSubpartitionConsumer(const xPartition& xPartition,
     ...
     */
    bool unregisterSubpartitionConsumer(const xPartition& xPartition) const;
     ...
     * @return true if the partition was registered fully, false otherwise
     */
    bool unregisterSubpartitionProducer(const xPartition& xPartition) const;
     ...
     */
    [[nodiscard]] PartitionRegistrationStatus isPartitionConsumerRegistered(const xPartition& xPartition) const;
     ...
     * @return true if the partition is registered
     */
    [[nodiscard]] PartitionRegistrationStatus isPartitionProducerRegistered(const xPartition& xPartition) const;
     ...
     * @param xPartition indicates the partition
...
#endif// x_CORE_INCLUDE_NETWORK_NETWORKMANAGER_HPP_
