...
#ifndef x_CORE_INCLUDE_NETWORK_NETWORKSINK_HPP_
#define x_CORE_INCLUDE_NETWORK_NETWORKSINK_HPP_
...
class NetworkSink : public SinkMedium, public Runtime::RuntimeEventListener {
  ...
  public:
    ...
    */
    ...
    friend bool operator<(const NetworkSink& lhs, const NetworkSink& rhs) { return lhs.xPartition < rhs.xPartition; }
...
#endif// x_CORE_INCLUDE_NETWORK_NETWORKSINK_HPP_
