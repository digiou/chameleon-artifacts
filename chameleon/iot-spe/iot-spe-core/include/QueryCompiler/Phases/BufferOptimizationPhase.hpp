...
*/
#ifndef x_CORE_INCLUDE_QUERYCOMPILER_PHASES_BUFFEROPTIMIZATIONPHASE_HPP_
#define x_CORE_INCLUDE_QUERYCOMPILER_PHASES_BUFFEROPTIMIZATIONPHASE_HPP_
...
/**
 * @brief This phase scans all pipelix and determix if the OutputBufferOptimizationLevel (level) requested by the user can be applied.
...
#endif// x_CORE_INCLUDE_QUERYCOMPILER_PHASES_BUFFEROPTIMIZATIONPHASE_HPP_
