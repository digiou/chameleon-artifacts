...
*/
#ifndef x_CORE_INCLUDE_QUERYCOMPILER_PHASES_ADDSCANANDEMITPHASE_HPP_
#define x_CORE_INCLUDE_QUERYCOMPILER_PHASES_ADDSCANANDEMITPHASE_HPP_
...
/**
 * @brief Simple phase to add scan and emit operator to pipelix in necessary.
...
#endif// x_CORE_INCLUDE_QUERYCOMPILER_PHASES_ADDSCANANDEMITPHASE_HPP_
