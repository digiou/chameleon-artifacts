...
*/
#ifndef x_CORE_INCLUDE_QUERYCOMPILER_PHASES_PREDICATIONOPTIMIZATIONPHASE_HPP_
#define x_CORE_INCLUDE_QUERYCOMPILER_PHASES_PREDICATIONOPTIMIZATIONPHASE_HPP_
...
/**
 * @brief This phase scans all pipelix. If enabled, it replaces all suited filter operator with equivalent predicated filter operators.
...
#endif// x_CORE_INCLUDE_QUERYCOMPILER_PHASES_PREDICATIONOPTIMIZATIONPHASE_HPP_
