...
*/
#ifndef x_CORE_INCLUDE_QUERYCOMPILER_PHASES_TRANSLATIONS_DEFAULTPHYSICALOPERATORPROVIDER_HPP_
#define x_CORE_INCLUDE_QUERYCOMPILER_PHASES_TRANSLATIONS_DEFAULTPHYSICALOPERATORPROVIDER_HPP_
...
class DefaultPhysicalOperatorProvider : public PhysicalOperatorProvider {
  ...
  private:
    ...
    /**
     * @brief Lowers the stream xted loop join
     * @param streamJoinOperatorNodes
     * @param streamJoinConfig
     */
    void lowerStreamingxtedLoopJoin(const StreamJoinOperatorNodes& streamJoinOperatorNodes,
                                      const StreamJoinConfigs& streamJoinConfig);
};

}// namespace x::QueryCompilation

#endif// x_CORE_INCLUDE_QUERYCOMPILER_PHASES_TRANSLATIONS_DEFAULTPHYSICALOPERATORPROVIDER_HPP_
