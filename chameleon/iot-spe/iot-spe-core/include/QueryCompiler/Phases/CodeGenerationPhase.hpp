...
*/
#ifndef x_CORE_INCLUDE_QUERYCOMPILER_PHASES_CODEGENERATIONPHASE_HPP_
#define x_CORE_INCLUDE_QUERYCOMPILER_PHASES_CODEGENERATIONPHASE_HPP_
...
/**
 * @brief Code generation phase, which generates executable machine code for pipelix, that consist of generatable operators.
 */
...
#endif// x_CORE_INCLUDE_QUERYCOMPILER_PHASES_CODEGENERATIONPHASE_HPP_
