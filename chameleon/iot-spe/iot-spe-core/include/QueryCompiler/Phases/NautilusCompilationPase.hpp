...
*/
#ifndef x_CORE_INCLUDE_QUERYCOMPILER_PHASES_NAUTILUSCOMPILATIONPASE_HPP_
#define x_CORE_INCLUDE_QUERYCOMPILER_PHASES_NAUTILUSCOMPILATIONPASE_HPP_
...
/**
 * @brief Compilation phase, which generates executable machine code for pipelix of nautilus operators.
 */
class NautilusCompilationPhase {
  public:
    ...
    /**
     * @brief Creates the compilation phase for nautilus pipelix.
    ...
    /**
     * @brief Generates code for all pipelix in a pipelined query plan.
...
#endif// x_CORE_INCLUDE_QUERYCOMPILER_PHASES_NAUTILUSCOMPILATIONPASE_HPP_
