...
*/
#ifndef x_CORE_INCLUDE_QUERYCOMPILER_QUERYCOMPILATIONREQUEST_HPP_
#define x_CORE_INCLUDE_QUERYCOMPILER_QUERYCOMPILATIONREQUEST_HPP_
...
class QueryCompilationRequest {
  public:
    ...
    */
    ...
    /**
     * @brief Checks if dumping to xviz is enabled
     * @return bool
     */
...
#endif// x_CORE_INCLUDE_QUERYCOMPILER_QUERYCOMPILATIONREQUEST_HPP_
