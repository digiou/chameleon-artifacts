...
#ifndef x_CORE_INCLUDE_QUERYCOMPILER_GENERATABLETYPES_ANONYMOUSUSERDEFINEDDATATYPE_HPP_
#define x_CORE_INCLUDE_QUERYCOMPILER_GENERATABLETYPES_ANONYMOUSUSERDEFINEDDATATYPE_HPP_
 ...
 * This is usually used to generate code for Runtime types, which are not covered by the x type system.
 */
...
#endif// x_CORE_INCLUDE_QUERYCOMPILER_GENERATABLETYPES_ANONYMOUSUSERDEFINEDDATATYPE_HPP_
