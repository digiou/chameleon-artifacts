...
#ifndef x_CORE_INCLUDE_QUERYCOMPILER_GENERATABLETYPES_GENERATABLETYPESFACTORY_HPP_
#define x_CORE_INCLUDE_QUERYCOMPILER_GENERATABLETYPES_GENERATABLETYPESFACTORY_HPP_
...
class GeneratableTypesFactory {
  public:
    /**
     * @brief Create a annonymus data type, which is used to represent types of the Runtime system that are not covered by the x type system.
     * @param type
    ...
    /**
    * @brief Create a generatable data type, which corresponds to a particular x data type.
    * @param type x data type
    * @return GeneratableDataTypePtr
    */
...
#endif// x_CORE_INCLUDE_QUERYCOMPILER_GENERATABLETYPES_GENERATABLETYPESFACTORY_HPP_
