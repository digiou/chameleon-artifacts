...
#ifndef x_CORE_INCLUDE_QUERYCOMPILER_CODEGENERATOR_GENERATEDCODE_HPP_
#define x_CORE_INCLUDE_QUERYCOMPILER_CODEGENERATOR_GENERATEDCODE_HPP_
...
class GeneratedCode {
   ...
   * important when multiple levels of xting occur
...
#endif// x_CORE_INCLUDE_QUERYCOMPILER_CODEGENERATOR_GENERATEDCODE_HPP_
