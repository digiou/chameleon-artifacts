...
#ifndef x_CORE_INCLUDE_QUERYCOMPILER_CODEGENERATOR_LEGACYEXPRESSION_HPP_
#define x_CORE_INCLUDE_QUERYCOMPILER_CODEGENERATOR_LEGACYEXPRESSION_HPP_
...
enum class PredicateItemMutation : uint8_t { ATTRIBUTE, VALUE };
...
#endif// x_CORE_INCLUDE_QUERYCOMPILER_CODEGENERATOR_LEGACYEXPRESSION_HPP_
