...
#ifndef x_CORE_INCLUDE_QUERYCOMPILER_CODEGENERATOR_CCODEGENERATOR_CCODEGENERATOR_HPP_
#define x_CORE_INCLUDE_QUERYCOMPILER_CODEGENERATOR_CCODEGENERATOR_CCODEGENERATOR_HPP_
...
class CCodeGenerator : public CodeGenerator {
  ...
  public:
    ...
    */
    ...
    bool generateCodeForNonKeyedSliceStoreAppend(PipelineContextPtr context, uint64_t windowOperatorIndex) override;
    ...
    */
    ...
    uint64_t generateNonKeyedSliceMergingOperatorSetup(
        Windowing::LogicalWindowDefinitionPtr window,
        PipelineContextPtr context,
        uint64_t id,
        uint64_t windowOperatorIndex,
    ...
    uint64_t generateNonKeyedThreadLocalPreAggregationSetup(
        Windowing::LogicalWindowDefinitionPtr window,
        SchemaPtr windowOutputSchema,
        PipelineContextPtr context,
        uint64_t id,
    ...
    */
    ...
    bool generateCodeForNonKeyedThreadLocalPreAggregationOperator(
        Windowing::LogicalWindowDefinitionPtr window,
        std::vector<QueryCompilation::GeneratableOperators::GeneratableWindowAggregationPtr> aggregation,
        PipelineContextPtr context,
        uint64_t windowOperatorIndex) override;
    ...
    bool generateCodeForNonKeyedSliceMergingOperator(
        Windowing::LogicalWindowDefinitionPtr window,
        std::vector<QueryCompilation::GeneratableOperators::GeneratableWindowAggregationPtr> aggregation,
        PipelineContextPtr context,
        uint64_t windowOperatorIndex) override;
    ...
    bool generateCodeForNonKeyedTumblingWindowSink(Windowing::LogicalWindowDefinitionPtr window,
                                                   std::vector<GeneratableOperators::GeneratableWindowAggregationPtr> aggregation,
                                                   PipelineContextPtr context,
                                                   SchemaPtr resultSchema) override;
    ...
    bool generateCodeForNonKeyedSlidingWindowSink(Windowing::LogicalWindowDefinitionPtr window,
                                                  std::vector<GeneratableOperators::GeneratableWindowAggregationPtr> aggregation,
                                                  PipelineContextPtr context,
                                                  uint64_t windowOperatorIndex,
                                                  SchemaPtr resultSchema) override;
  ...
  private:
    ...
    /**
     * @brief returns getOperatorHandler<x::CEP::CEPOperatorHandler>(CEPOperatorIndex)
     * @param context
     * @param tupleBufferVariable
     * @param index
     * @return
    ...
    /**
     * @brief returns getJoinHandler<x::Join::JoinHandler,KeyType,leftType,rightType>()
     * @param pipelineContextVariable
     * @param KeyType
     * @param leftType
     * @param rightType
    ...
    /**
     * @brief returns getBatchJoinHandler<x::Join::Experimental::BatchJoinHandler,KeyType,buildType>()
     * @param pipelineContextVariable
     * @param KeyType
     * @param buildType
     * @return
...
#endif// x_CORE_INCLUDE_QUERYCOMPILER_CODEGENERATOR_CCODEGENERATOR_CCODEGENERATOR_HPP_
