...
#ifndef x_CORE_INCLUDE_QUERYCOMPILER_CODEGENERATOR_CCODEGENERATOR_DEFINITIONS_CLASSDEFINITION_HPP_
#define x_CORE_INCLUDE_QUERYCOMPILER_CODEGENERATOR_CCODEGENERATOR_DEFINITIONS_CLASSDEFINITION_HPP_
...
class ClassDefinition : public std::enable_shared_from_this<ClassDefinition> {
  public:
     ...
     */
    enum class Visibility : uint8_t { Public, Private };
...
#endif// x_CORE_INCLUDE_QUERYCOMPILER_CODEGENERATOR_CCODEGENERATOR_DEFINITIONS_CLASSDEFINITION_HPP_
