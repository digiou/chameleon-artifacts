...
#ifndef x_CORE_INCLUDE_QUERYCOMPILER_CODEGENERATOR_CCODEGENERATOR_STATEMENTS_UNARYOPERATORSTATEMENT_HPP_
#define x_CORE_INCLUDE_QUERYCOMPILER_CODEGENERATOR_CCODEGENERATOR_STATEMENTS_UNARYOPERATORSTATEMENT_HPP_
...
class UnaryOperatorStatement : public ExpressionStatement {
  ...
  private:
    ...
    UnaryOperatorType op{UnaryOperatorType::INVALID_UNARY_OPERATOR_TYPE};
    BracketMode bracket_mode{BracketMode::NO_BRACKETS};
};
...
#endif// x_CORE_INCLUDE_QUERYCOMPILER_CODEGENERATOR_CCODEGENERATOR_STATEMENTS_UNARYOPERATORSTATEMENT_HPP_
