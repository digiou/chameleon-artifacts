...
#ifndef x_CORE_INCLUDE_QUERYCOMPILER_CODEGENERATOR_CODEGENERATORFORWARDREF_HPP_
#define x_CORE_INCLUDE_QUERYCOMPILER_CODEGENERATOR_CODEGENERATORFORWARDREF_HPP_
#include <memory>
namespace x {
...
#endif// x_CORE_INCLUDE_QUERYCOMPILER_CODEGENERATOR_CODEGENERATORFORWARDREF_HPP_
