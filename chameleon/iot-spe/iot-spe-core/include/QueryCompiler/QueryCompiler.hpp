...
*/
#ifndef x_CORE_INCLUDE_QUERYCOMPILER_QUERYCOMPILER_HPP_
#define x_CORE_INCLUDE_QUERYCOMPILER_QUERYCOMPILER_HPP_
...
#endif// x_CORE_INCLUDE_QUERYCOMPILER_QUERYCOMPILER_HPP_
