...
*/
#ifndef x_CORE_INCLUDE_QUERYCOMPILER_OPERATORS_PHYSICALOPERATORS_CEP_CEPOPERATORHANDLER_CEPOPERATORHANDLER_HPP_
#define x_CORE_INCLUDE_QUERYCOMPILER_OPERATORS_PHYSICALOPERATORS_CEP_CEPOPERATORHANDLER_CEPOPERATORHANDLER_HPP_
...
class CEPOperatorHandler : public Runtime::Execution::OperatorHandler {
  public:
    ...
    */
    ...
    ~CEPOperatorHandler() override { x_DEBUG("~CEPOperatorHandler()"); }
...
#endif// x_CORE_INCLUDE_QUERYCOMPILER_OPERATORS_PHYSICALOPERATORS_CEP_CEPOPERATORHANDLER_CEPOPERATORHANDLER_HPP_
