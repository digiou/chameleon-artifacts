...
*/
#ifndef x_CORE_INCLUDE_QUERYCOMPILER_OPERATORS_GENERATABLEOPERATORS_WINDOWING_NONKEYEDTIMEWINDOW_GENERATABLENONKEYEDTUMBLINGWINDOWSINK_HPP_
#define x_CORE_INCLUDE_QUERYCOMPILER_OPERATORS_GENERATABLEOPERATORS_WINDOWING_NONKEYEDTIMEWINDOW_GENERATABLENONKEYEDTUMBLINGWINDOWSINK_HPP_
...
class GeneratableNonKeyedTumblingWindowSink : public GeneratableOperator {
  public:
    /**
  ...
  private:
    GeneratableNonKeyedTumblingWindowSink(OperatorId id,
                                          SchemaPtr inputSchema,
                                          SchemaPtr outputSchema,
                                          Windowing::LogicalWindowDefinitionPtr& windowDefinition,
                                          std::vector<GeneratableOperators::GeneratableWindowAggregationPtr> windowAggregation);
...
#endif// x_CORE_INCLUDE_QUERYCOMPILER_OPERATORS_GENERATABLEOPERATORS_WINDOWING_NONKEYEDTIMEWINDOW_GENERATABLENONKEYEDTUMBLINGWINDOWSINK_HPP_
