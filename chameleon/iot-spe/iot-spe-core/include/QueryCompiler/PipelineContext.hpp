...
#ifndef x_CORE_INCLUDE_QUERYCOMPILER_PIPELINECONTEXT_HPP_
#define x_CORE_INCLUDE_QUERYCOMPILER_PIPELINECONTEXT_HPP_
...
class PipelineContext {
  ...
  private:
    ...
    std::vector<PipelineContextPtr> nextPipelix;
...
#endif// x_CORE_INCLUDE_QUERYCOMPILER_PIPELINECONTEXT_HPP_
