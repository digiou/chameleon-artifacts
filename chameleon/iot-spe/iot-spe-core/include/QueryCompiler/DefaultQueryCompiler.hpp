...
*/
#ifndef x_CORE_INCLUDE_QUERYCOMPILER_DEFAULTQUERYCOMPILER_HPP_
#define x_CORE_INCLUDE_QUERYCOMPILER_DEFAULTQUERYCOMPILER_HPP_
#include <QueryCompiler/QueryCompiler.hpp>

namespace x::QueryCompilation {

/**
 * @brief The default query compiler for x.
...
#endif// x_CORE_INCLUDE_QUERYCOMPILER_DEFAULTQUERYCOMPILER_HPP_
