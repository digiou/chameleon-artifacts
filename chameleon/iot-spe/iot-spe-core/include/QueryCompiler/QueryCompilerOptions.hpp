...
*/
#ifndef x_CORE_INCLUDE_QUERYCOMPILER_QUERYCOMPILEROPTIONS_HPP_
#define x_CORE_INCLUDE_QUERYCOMPILER_QUERYCOMPILEROPTIONS_HPP_
...
class QueryCompilerOptions {
  public:
    ...
    enum class CompilationStrategy : uint8_t {
        ...
        OPTIMIZE,
        // Applies all compiler optimizations and inlix proxy functions.
        PROXY_INLINING
    };
...
#endif// x_CORE_INCLUDE_QUERYCOMPILER_QUERYCOMPILEROPTIONS_HPP_
