...
#ifndef x_CORE_INCLUDE_OPERATORS_LOGICALOPERATORS_SINKS_ZMQSINKDESCRIPTOR_HPP_
#define x_CORE_INCLUDE_OPERATORS_LOGICALOPERATORS_SINKS_ZMQSINKDESCRIPTOR_HPP_
...
class ZmqSinkDescriptor : public SinkDescriptor {
  ...
  public:
     ...
     * @param internal: defix if the zmq should send the message schema as a first message
  ...
  private:
    explicit ZmqSinkDescriptor(std::string host,
                               uint16_t port,
                               bool internal,
                               x::FaultToleranceType faultToleranceType,
...
#endif// x_CORE_INCLUDE_OPERATORS_LOGICALOPERATORS_SINKS_ZMQSINKDESCRIPTOR_HPP_
