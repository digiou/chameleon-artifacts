...
*/
#ifndef x_CORE_INCLUDE_SOURCES_PARSERS_PARSER_HPP_
#define x_CORE_INCLUDE_SOURCES_PARSERS_PARSER_HPP_
...
/**
 * @brief Base class for all input data parsers in x
 */
class Parser {
...
#endif// x_CORE_INCLUDE_SOURCES_PARSERS_PARSER_HPP_
