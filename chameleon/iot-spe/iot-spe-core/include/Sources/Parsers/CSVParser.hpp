...
#ifndef x_CORE_INCLUDE_SOURCES_PARSERS_CSVPARSER_HPP_
#define x_CORE_INCLUDE_SOURCES_PARSERS_CSVPARSER_HPP_
...
class CSVParser : public Parser {
   ...
   * @param physicalTypes vector with physical x data types
   * @param delimiter delimiter of input file
   */
    CSVParser(uint64_t numberOfSchemaFields, std::vector<x::PhysicalTypePtr> physicalTypes, std::string delimiter);
...
#endif// x_CORE_INCLUDE_SOURCES_PARSERS_CSVPARSER_HPP_
