...
#ifndef x_CORE_INCLUDE_SOURCES_DATASOURCE_HPP_
#define x_CORE_INCLUDE_SOURCES_DATASOURCE_HPP_
...
/**
* @brief Base class for all data sources in x
...
class DataSource : public Runtime::Reconfigurable, public DataEmitter {
  ...
  public:
     ...
     */
    virtual ~DataSource() x_NOEXCEPT(false) override;
    ...
    /**
     * @brief Returns the list of successor pipelix.
    ...
    /**
     * @brief Add a list of successor pipelix.
     */
    void addExecutableSuccessors(std::vector<Runtime::Execution::SuccessorExecutablePipeline> newPipelix);
  ...
  protected:
    ...
    x::Runtime::MemoryLayouts::DynamicTupleBuffer allocateBuffer();
...
#endif// x_CORE_INCLUDE_SOURCES_DATASOURCE_HPP_
