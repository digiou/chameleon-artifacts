...
#ifndef x_CORE_INCLUDE_SOURCES_STATICDATASOURCE_HPP_
#define x_CORE_INCLUDE_SOURCES_STATICDATASOURCE_HPP_
 ...
 */
class StaticDataSource : public GeneratorSource, public ::x::Runtime::BufferRecycler {
  public:
    /**
     ...
     * @return a nullopt
     */
    std::optional<::x::Runtime::TupleBuffer> receiveData() override;
    ...
    virtual void recyclePooledBuffer(::x::Runtime::detail::MemorySegment*) override{};

    /**
     * @brief Interface method for unpooled buffer recycling
     * @param buffer the buffer to recycle
     */
    virtual void recycleUnpooledBuffer(::x::Runtime::detail::MemorySegment*) override{};
  ...
  private:
    ...
    void fillBuffer(::x::Runtime::MemoryLayouts::DynamicTupleBuffer& buffer);
};
...
#endif// x_CORE_INCLUDE_SOURCES_STATICDATASOURCE_HPP_
