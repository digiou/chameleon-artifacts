...
#ifndef x_CORE_INCLUDE_SOURCES_ZMQSOURCE_HPP_
#define x_CORE_INCLUDE_SOURCES_ZMQSOURCE_HPP_
...
class ZmqSource : public DataSource {
  ...
  public:
     ...
     */
    ~ZmqSource() x_NOEXCEPT(false) override;
...
#endif// x_CORE_INCLUDE_SOURCES_ZMQSOURCE_HPP_
