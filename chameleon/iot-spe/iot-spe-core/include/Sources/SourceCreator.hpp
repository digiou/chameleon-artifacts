...
#ifndef x_CORE_INCLUDE_SOURCES_SOURCECREATOR_HPP_
#define x_CORE_INCLUDE_SOURCES_SOURCECREATOR_HPP_
 ...
 * @param xPartition the unique identifier of the network source that consumes the input buffers
 ...
 * @param metricCollector a pointer to a x::Monitoring::MetricCollector
...
DataSourcePtr createMaterializedViewSource(const SchemaPtr schema,
                                           ...
                                           const std::string& physicalSourceName,
                                           const std::vector<Runtime::Execution::SuccessorExecutablePipeline> successors,
                                           const x::Experimental::MaterializedView::MaterializedViewPtr view);
}// namespace Experimental::MaterializedView
...
#endif// x_CORE_INCLUDE_SOURCES_SOURCECREATOR_HPP_
