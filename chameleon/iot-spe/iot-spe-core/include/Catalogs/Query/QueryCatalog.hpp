...
#ifndef x_CORE_INCLUDE_CATALOGS_QUERY_QUERYCATALOG_HPP_
#define x_CORE_INCLUDE_CATALOGS_QUERY_QUERYCATALOG_HPP_
...
class QueryCatalog {
  public:
     ...
     */
    QueryCatalogEntryPtr createNewEntry(const std::string& queryString,
...
#endif// x_CORE_INCLUDE_CATALOGS_QUERY_QUERYCATALOG_HPP_
