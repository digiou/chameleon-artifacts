...
*/
#ifndef x_CORE_INCLUDE_CATALOGS_SOURCE_PHYSICALSOURCETYPES_LAMBDASOURCETYPE_HPP_
#define x_CORE_INCLUDE_CATALOGS_SOURCE_PHYSICALSOURCETYPES_LAMBDASOURCETYPE_HPP_
...
class LambdaSourceType : public PhysicalSourceType {
  public:
    ...
    create(std::function<void(x::Runtime::TupleBuffer& buffer, uint64_t numberOfTuplesToProduce)>&& generationFunction,
    ...
    std::function<void(x::Runtime::TupleBuffer&, uint64_t)> getGenerationFunction() const;
...
#endif// x_CORE_INCLUDE_CATALOGS_SOURCE_PHYSICALSOURCETYPES_LAMBDASOURCETYPE_HPP_
