...
#ifndef x_CORE_INCLUDE_CATALOGS_SOURCE_PHYSICALSOURCETYPES_STATICDATASOURCETYPE_HPP_
#define x_CORE_INCLUDE_CATALOGS_SOURCE_PHYSICALSOURCETYPES_STATICDATASOURCETYPE_HPP_
...
class StaticDataSourceType : public PhysicalSourceType {
  ...
  public:
    ...
    x::SourceMode getSourceMode() const;
...
#endif// x_CORE_INCLUDE_CATALOGS_SOURCE_PHYSICALSOURCETYPES_STATICDATASOURCETYPE_HPP_
