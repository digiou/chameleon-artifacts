...
#ifndef x_CORE_INCLUDE_WINDOWING_WINDOWAGGREGATIONS_WINDOWAGGREGATIONDESCRIPTOR_HPP_
#define x_CORE_INCLUDE_WINDOWING_WINDOWAGGREGATIONS_WINDOWAGGREGATIONDESCRIPTOR_HPP_
...
class WindowAggregationDescriptor {
  public:
    ...
    /**
    * Defix the field to which a aggregate output is assigned.
    * @param asField
...
#endif// x_CORE_INCLUDE_WINDOWING_WINDOWAGGREGATIONS_WINDOWAGGREGATIONDESCRIPTOR_HPP_
