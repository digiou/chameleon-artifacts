...
#include <atomic>
#include <memory>
#ifndef x_CORE_INCLUDE_WINDOWING_EXPERIMENTAL_SEQENCELOG_HPP_
#define x_CORE_INCLUDE_WINDOWING_EXPERIMENTAL_SEQENCELOG_HPP_
...
#endif// x_CORE_INCLUDE_WINDOWING_EXPERIMENTAL_SEQENCELOG_HPP_
