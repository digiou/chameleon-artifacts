...
#ifndef x_CORE_INCLUDE_WINDOWING_WINDOWACTIONS_BASEEXECUTABLEJOINACTION_HPP_
#define x_CORE_INCLUDE_WINDOWING_WINDOWACTIONS_BASEEXECUTABLEJOINACTION_HPP_
...
class BaseExecutableJoinAction {
  public:
    ...
    virtual void setup(Runtime::Execution::PipelineExecutionContextPtr pipelineExecutionContext, OriginId originId) {
        x_ASSERT(pipelineExecutionContext, "invalid pipelineExecutionContext");
...
#endif// x_CORE_INCLUDE_WINDOWING_WINDOWACTIONS_BASEEXECUTABLEJOINACTION_HPP_
