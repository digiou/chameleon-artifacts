...
#ifndef x_CORE_INCLUDE_WINDOWING_WINDOWACTIONS_BASEJOINACTIONDESCRIPTOR_HPP_
#define x_CORE_INCLUDE_WINDOWING_WINDOWACTIONS_BASEJOINACTIONDESCRIPTOR_HPP_
#include <Windowing/JoinForwardRefs.hpp>

namespace x::Join {

enum class JoinActionType : uint8_t { LazyxtedLoopJoin };
...
#endif// x_CORE_INCLUDE_WINDOWING_WINDOWACTIONS_BASEJOINACTIONDESCRIPTOR_HPP_
