...
#ifndef x_CORE_INCLUDE_WINDOWING_WINDOWHANDLER_BATCHJOINHANDLER_HPP_
#define x_CORE_INCLUDE_WINDOWING_WINDOWHANDLER_BATCHJOINHANDLER_HPP_
...
class BatchJoinHandler : public AbstractBatchJoinHandler {
  public:
    explicit BatchJoinHandler(const LogicalBatchJoinDefinitionPtr& batchJoinDefinition, uint64_t id)
        ...
        x_ASSERT(this->batchJoinDefinition, "invalid join definition");
...
#endif// x_CORE_INCLUDE_WINDOWING_WINDOWHANDLER_BATCHJOINHANDLER_HPP_
