...
*/
#ifndef x_CORE_INCLUDE_WINDOWING_WINDOWHANDLER_WINDOWOPERATORHANDLER_HPP_
#define x_CORE_INCLUDE_WINDOWING_WINDOWHANDLER_WINDOWOPERATORHANDLER_HPP_
...
class WindowOperatorHandler : public Runtime::Execution::OperatorHandler {
  public:
    ...
    */
    ...
    ~WindowOperatorHandler() override { x_DEBUG("~WindowOperatorHandler() {}", std::to_string(windowHandler.use_count())); }
...
#endif// x_CORE_INCLUDE_WINDOWING_WINDOWHANDLER_WINDOWOPERATORHANDLER_HPP_
