...
#ifndef x_CORE_INCLUDE_WINDOWING_WINDOWHANDLER_ABSTRACTJOINHANDLER_HPP_
#define x_CORE_INCLUDE_WINDOWING_WINDOWHANDLER_ABSTRACTJOINHANDLER_HPP_
...
class AbstractJoinHandler : public detail::virtual_enable_shared_from_this<AbstractJoinHandler, false>,
  ...
  public:
    ...
    ~AbstractJoinHandler() x_NOEXCEPT(false) override = default;
    ...
    */
    ...
    uint64_t getMinWatermark(JoinSides side) {
        if (side == JoinSides::leftSide) {
            ...
            x_THROW_RUNTIME_ERROR("getNumberOfMappings: invalid side");
            return -1;
        }
    }
...
#endif// x_CORE_INCLUDE_WINDOWING_WINDOWHANDLER_ABSTRACTJOINHANDLER_HPP_
