...
#ifndef x_CORE_INCLUDE_WINDOWING_WINDOWHANDLER_BATCHJOINOPERATORHANDLER_HPP_
#define x_CORE_INCLUDE_WINDOWING_WINDOWHANDLER_BATCHJOINOPERATORHANDLER_HPP_
...
class BatchJoinOperatorHandler : public Runtime::Execution::OperatorHandler {
  public:
    ...
    */
    void setProbePipelineID(uint64_t probePipelineID) {
        if (this->probePipelineID != 0) {
            x_WARNING("BatchJoinOperatorHandler::setProbePipelineID called a second time. Previous id: {} New id: {}",
    ...
    */
    void setBuildPipelineID(uint64_t buildPipelineID) {
        if (this->probePipelineID != 0) {
            x_WARNING("BatchJoinOperatorHandler::setBuildPipelineID called a second time. Previous id: {} New id: {} ",
  ...
  private:
    ...
    */
    ...
    // we save these pointers (DataSources or ExecutablePipelix) to manually start the joins predecessors
...
#endif// x_CORE_INCLUDE_WINDOWING_WINDOWHANDLER_BATCHJOINOPERATORHANDLER_HPP_
