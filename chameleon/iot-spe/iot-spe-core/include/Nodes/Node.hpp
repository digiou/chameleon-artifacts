...
#ifndef x_CORE_INCLUDE_NODES_NODE_HPP_
#define x_CORE_INCLUDE_NODES_NODE_HPP_
...
class Node : public std::enable_shared_from_this<Node> {
  public:
    ...
    */
     ...
     * @return string
     */
    virtual std::vector<std::string> toMultilixtring();
  ...
  private:
    ...
    */
     ...
     * It is empty if CMAKE_x_TRACE_NODE_CREATION == false.
     */
    std::string stackTrace;
};
}// namespace x

#endif// x_CORE_INCLUDE_NODES_NODE_HPP_
