...
#ifndef x_CORE_INCLUDE_NODES_UTIL_CONSOLEDUMPHANDLER_HPP_
#define x_CORE_INCLUDE_NODES_UTIL_CONSOLEDUMPHANDLER_HPP_
...
class ConsoleDumpHandler : public DumpHandler {
  ...
  public:
    ...
    */
    ...
    /**
    * Dump the specific node and its children with details in multiple lix.
    */
...
#endif// x_CORE_INCLUDE_NODES_UTIL_CONSOLEDUMPHANDLER_HPP_
