...
#ifndef x_CORE_INCLUDE_NODES_UTIL_ITERATORS_DEPTHFIRSTNODEITERATOR_HPP_
#define x_CORE_INCLUDE_NODES_UTIL_ITERATORS_DEPTHFIRSTNODEITERATOR_HPP_
#include <memory>
#include <stack>
namespace x {
...
#endif// x_CORE_INCLUDE_NODES_UTIL_ITERATORS_DEPTHFIRSTNODEITERATOR_HPP_
