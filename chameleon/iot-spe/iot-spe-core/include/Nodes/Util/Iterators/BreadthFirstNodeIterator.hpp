...
#ifndef x_CORE_INCLUDE_NODES_UTIL_ITERATORS_BREADTHFIRSTNODEITERATOR_HPP_
#define x_CORE_INCLUDE_NODES_UTIL_ITERATORS_BREADTHFIRSTNODEITERATOR_HPP_
#include <memory>
#include <queue>
namespace x {
...
#endif// x_CORE_INCLUDE_NODES_UTIL_ITERATORS_BREADTHFIRSTNODEITERATOR_HPP_
