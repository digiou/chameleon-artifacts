...
#ifndef x_CORE_INCLUDE_CONFIGURATIONS_CONFIGURATIONOPTION_HPP_
#define x_CORE_INCLUDE_CONFIGURATIONS_CONFIGURATIONOPTION_HPP_
  ...
  public:
    ...
    void setInputFormatEnum(std::string inputFormat) {
        if (inputFormat == "CSV") {
            ...
            x_ERROR("InputFormatEnum: value unknown.");
        }
    }
    ...
    void setTCPDecideMessageSizeEnum(std::string decideMessageSize) {
        if (decideMessageSize == "TUPLE_SEPARATOR") {
            ...
            x_ERROR("TCPDecideMessageSizeEnum: value unknown.");
        }
    }
...
#endif// x_CORE_INCLUDE_CONFIGURATIONS_CONFIGURATIONOPTION_HPP_
