...
*/
#ifndef x_CORE_INCLUDE_CONFIGURATIONS_CONFIGURATIONSNAMES_HPP_
#define x_CORE_INCLUDE_CONFIGURATIONS_CONFIGURATIONSNAMES_HPP_
#include <cstdint>
#include <string>
...
const std::string NUMA_AWARExS_CONFIG = "numaAwarexs";
...
//Different Source Types supported in x
...
#endif// x_CORE_INCLUDE_CONFIGURATIONS_CONFIGURATIONSNAMES_HPP_
