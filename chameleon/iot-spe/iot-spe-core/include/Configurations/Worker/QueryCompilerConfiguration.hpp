...
#ifndef x_CORE_INCLUDE_CONFIGURATIONS_WORKER_QUERYCOMPILERCONFIGURATION_HPP_
#define x_CORE_INCLUDE_CONFIGURATIONS_WORKER_QUERYCOMPILERCONFIGURATION_HPP_
...
class QueryCompilerConfiguration : public BaseConfiguration {
  public:
    ...
    EnumOption<QueryCompilation::QueryCompilerOptions::WindowingStrategy> windowingStrategy = {
        ...
        QueryCompilation::QueryCompilerOptions::WindowingStrategy::LEGACY,
    ...
    EnumOption<QueryCompilation::StreamJoinStrategy> joinStrategy = {
        ...
        "Indicates the windowingStrategy"
        "[HASH_JOIN_LOCAL|HASH_JOIN_GLOBAL_LOCKING|HASH_JOIN_GLOBAL_LOCK_FREE|xTED_LOOP_JOIN]. "};
...
#endif// x_CORE_INCLUDE_CONFIGURATIONS_WORKER_QUERYCOMPILERCONFIGURATION_HPP_
