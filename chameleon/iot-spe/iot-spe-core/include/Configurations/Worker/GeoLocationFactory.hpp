...
*/
#ifndef x_CORE_INCLUDE_CONFIGURATIONS_WORKER_GEOLOCATIONFACTORY_HPP_
#define x_CORE_INCLUDE_CONFIGURATIONS_WORKER_GEOLOCATIONFACTORY_HPP_
...
namespace x::Spatial::DataTypes::Experimental {
class GeoLocation;
}// namespace x::Spatial::DataTypes::Experimental

namespace x::Configurations::Spatial::Index::Experimental {
...
class GeoLocationFactory {
  ...
  public:
     ...
     */
    static x::Spatial::DataTypes::Experimental::GeoLocation
     ...
     * if the string was empty
     */
    static x::Spatial::DataTypes::Experimental::GeoLocation createFromYaml(Yaml::Node& yamlConfig);
};
}// namespace x::Configurations::Spatial::Index::Experimental
#endif// x_CORE_INCLUDE_CONFIGURATIONS_WORKER_GEOLOCATIONFACTORY_HPP_
