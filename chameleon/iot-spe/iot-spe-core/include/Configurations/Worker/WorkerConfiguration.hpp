...
#ifndef x_CORE_INCLUDE_CONFIGURATIONS_WORKER_WORKERCONFIGURATION_HPP_
#define x_CORE_INCLUDE_CONFIGURATIONS_WORKER_WORKERCONFIGURATION_HPP_
...
class WorkerConfiguration : public BaseConfiguration {
  public:
     ...
     */
    UIntOption rpcPort = {RPC_PORT_CONFIG, 0, "RPC server port of the x Worker."};

    /**
     * @brief Port of the Data server of this worker.
     * This is used to receive data.
     */
    UIntOption dataPort = {DATA_PORT_CONFIG, 0, "Data port of the x Worker."};

    /**
     * @brief Server IP of the x Coordinator to which the x Worker should connect.
     */
    StringOption coordinatorIp = {COORDINATOR_IP_CONFIG,
                                  "127.0.0.1",
                                  "Server IP of the x Coordinator to which the x Worker should connect."};
    /**
     * @brief RPC server Port of the x Coordinator to which the x Worker should connect. Needs to be set and needs
     * to be the same as rpcPort in Coordinator.
     */
    UIntOption coordinatorPort = {
        COORDINATOR_PORT_CONFIG,
        4000,
        "RPC server Port of the x Coordinator to which the x Worker should connect. Needs to be set and needs "
        "to be the same as rpcPort in Coordinator."};
     ...
     */
    UIntOption numberOfSlots = {NUMBER_OF_SLOTS_CONFIG, UINT16_MAX, "Number of computing slots for the x Worker."};
     ...
     */
    BoolOption numaAwarexs = {NUMA_AWARExS_CONFIG, false, "Enable Numa-Aware execution"};
     ...
     */
    WrapOption<x::Spatial::DataTypes::Experimental::GeoLocation,
     ...
     */
    EnumOption<x::Spatial::Experimental::SpatialType> nodeSpatialType = {
        SPATIAL_TYPE_CONFIG,
        x::Spatial::Experimental::SpatialType::NO_LOCATION,
...
#endif// x_CORE_INCLUDE_CONFIGURATIONS_WORKER_WORKERCONFIGURATION_HPP_
