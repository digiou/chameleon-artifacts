...
#ifndef x_CORE_INCLUDE_CONFIGURATIONS_COORDINATOR_LOGICALSOURCEFACTORY_HPP_
#define x_CORE_INCLUDE_CONFIGURATIONS_COORDINATOR_LOGICALSOURCEFACTORY_HPP_
...
class LogicalSourceFactory {
  ...
  private:
    /**
     * Return the appropriate x type from yaml string configuration. Ignores
...
#endif// x_CORE_INCLUDE_CONFIGURATIONS_COORDINATOR_LOGICALSOURCEFACTORY_HPP_
