...
#ifndef x_CORE_INCLUDE_PLANS_CHANGELOG_CHANGELOG_HPP_
#define x_CORE_INCLUDE_PLANS_CHANGELOG_CHANGELOG_HPP_
...
#endif// x_CORE_INCLUDE_PLANS_CHANGELOG_CHANGELOG_HPP_
