...
#ifndef x_CORE_INCLUDE_PLANS_GLOBAL_EXECUTION_EXECUTIONNODE_HPP_
#define x_CORE_INCLUDE_PLANS_GLOBAL_EXECUTION_EXECUTIONNODE_HPP_
...
class ExecutionNode : public Node {
  ...
  public:
    ...
    /**
     * Get the x node for the execution node.
     * @return the x node
     */
    ...
    std::vector<std::string> toMultilixtring() override;
...
#endif// x_CORE_INCLUDE_PLANS_GLOBAL_EXECUTION_EXECUTIONNODE_HPP_
