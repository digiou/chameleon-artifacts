...
#ifndef x_CORE_INCLUDE_PLANS_GLOBAL_QUERY_GLOBALQUERYPLAN_HPP_
#define x_CORE_INCLUDE_PLANS_GLOBAL_QUERY_GLOBALQUERYPLAN_HPP_
...
/**
 * @brief This class is responsible for storing all currently running and to be deployed QueryPlans in the x system.
...
class GlobalQueryPlan {
  public:
    ...
    getSharedQueryPlansConsumingSourcesAndPlacementStrategy(const std::string& sourceNames,
                                                            x::Optimizer::PlacementStrategy placementStrategy);
...
#endif// x_CORE_INCLUDE_PLANS_GLOBAL_QUERY_GLOBALQUERYPLAN_HPP_
