...
#ifndef x_CORE_INCLUDE_PLANS_UTILS_QUERYPLANITERATOR_HPP_
#define x_CORE_INCLUDE_PLANS_UTILS_QUERYPLANITERATOR_HPP_
...
#endif// x_CORE_INCLUDE_PLANS_UTILS_QUERYPLANITERATOR_HPP_
