...
#ifndef x_CORE_INCLUDE_API_QUERY_HPP_
#define x_CORE_INCLUDE_API_QUERY_HPP_
...
/**
     * @brief: This operator is a CEP operator, in CEP engix also called iteration operator. It
...
class Query {
  public:
    ...
    friend class x::Experimental::BatchJoinOperatorBuilder::JoinWhere;
     ...
     * @return object where where() function is defined and can be called by user
     */
    x::Experimental::BatchJoinOperatorBuilder::Join batchJoinWith(const Query& subQueryRhs);
...
#endif// x_CORE_INCLUDE_API_QUERY_HPP_
