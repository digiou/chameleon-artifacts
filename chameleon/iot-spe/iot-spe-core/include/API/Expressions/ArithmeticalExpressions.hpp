...
#ifndef x_CORE_INCLUDE_API_EXPRESSIONS_ARITHMETICALEXPRESSIONS_HPP_
#define x_CORE_INCLUDE_API_EXPRESSIONS_ARITHMETICALEXPRESSIONS_HPP_
...
/**
 * @brief Defix common arithmetical operations between expression nodes.
 */
...
/**
 * @brief Defix common binary arithmetical operations between a constant and an expression node.
 */
...
/**
 * @brief Defix common binary arithmetical operations between an expression node and a constant.
 */
...
/**
 * @brief Defix common binary arithmetical operations between two expression items.
 */
...
/**
 * @brief Defix common unary arithmetical operations on an expression items.
 */
...
#endif// x_CORE_INCLUDE_API_EXPRESSIONS_ARITHMETICALEXPRESSIONS_HPP_
