...
#ifndef x_CORE_INCLUDE_API_EXPRESSIONS_LOGICALEXPRESSIONS_HPP_
#define x_CORE_INCLUDE_API_EXPRESSIONS_LOGICALEXPRESSIONS_HPP_
...
/**
 * @brief Defix common logical operations between expression nodes.
 */
...
/**
 * @brief Defix common operations on at least one operator which is not of type ExpressionNodePtr but
...
#endif// x_CORE_INCLUDE_API_EXPRESSIONS_LOGICALEXPRESSIONS_HPP_
