...
#ifndef x_CORE_INCLUDE_API_WINDOWING_HPP_
#define x_CORE_INCLUDE_API_WINDOWING_HPP_
...
/**
 * @brief Defix a Sum Aggregation function on a particular field.
...
/**
 * @brief Defix a Min Aggregation function on a particular field.
 * @param ExpressionItem Attribute("field-name") the field which should be aggregated.
 * @return A descriptor of the aggregation function.
 */
...
/**
 * @brief Defix a Max Aggregation function on a particular field.
 * @param ExpressionItem Attribute("field-name") the field which should be aggregated.
 * @return A descriptor of the aggregation function.
 */
...
/**
 * @brief Defix a Count Aggregation function on a particular field.
 * @return A descriptor of the aggregation function.
 */
Windowing::WindowAggregationPtr Count();

/**
 * @brief Defix a Median Aggregation function on a particular field.
 * @return A descriptor of the aggregation function.
 */
Windowing::WindowAggregationPtr Median(const ExpressionItem& onField);

/**
 * @brief Defix a Agg Aggregation function on a particular field.
 * @param ExpressionItem Attribute("field-name") the field which should be aggregated.
 * @return A descriptor of the aggregation function.
 */
...
/**
 * @brief Defix event time as a time characteristic for a window.
 * @param ExpressionItem which defix the field name.
...
/**
 * @brief Defix a ingestion time as a time characteristic for a window.
 * @return A descriptor of the time characteristic.
 */
...
#endif// x_CORE_INCLUDE_API_WINDOWING_HPP_
