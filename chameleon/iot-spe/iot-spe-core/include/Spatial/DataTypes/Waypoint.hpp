...
*/
#ifndef x_CORE_INCLUDE_SPATIAL_DATATYPES_WAYPOINT_HPP_
#define x_CORE_INCLUDE_SPATIAL_DATATYPES_WAYPOINT_HPP_
...
#endif// x_CORE_INCLUDE_SPATIAL_DATATYPES_WAYPOINT_HPP_
