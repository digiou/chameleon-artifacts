...
*/
#ifndef x_CORE_INCLUDE_SPATIAL_DATATYPES_GEOLOCATION_HPP_
#define x_CORE_INCLUDE_SPATIAL_DATATYPES_GEOLOCATION_HPP_
...
class GeoLocation {
  ...
  public:
     ...
     */
    explicit GeoLocation(const x::Spatial::Protobuf::GeoLocation& geoLocation);
...
#endif// x_CORE_INCLUDE_SPATIAL_DATATYPES_GEOLOCATION_HPP_
