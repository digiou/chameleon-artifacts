...
*/
#ifndef x_CORE_INCLUDE_SPATIAL_MOBILITY_WORKERMOBILITYHANDLER_HPP_
#define x_CORE_INCLUDE_SPATIAL_MOBILITY_WORKERMOBILITYHANDLER_HPP_
...
class WorkerMobilityHandler {
  ...
  private:
     ...
     */
    bool
    sendNextPredictedReconnect(const std::optional<x::Spatial::Mobility::Experimental::ReconnectSchedule>& scheduledReconnects,
...
#endif// x_CORE_INCLUDE_SPATIAL_MOBILITY_WORKERMOBILITYHANDLER_HPP_
