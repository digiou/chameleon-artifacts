...
#ifndef x_CORE_INCLUDE_SPATIAL_MOBILITY_RECONNECTSCHEDULEPREDICTORS_RECONNECTSCHEDULEPREDICTOR_HPP_
#define x_CORE_INCLUDE_SPATIAL_MOBILITY_RECONNECTSCHEDULEPREDICTORS_RECONNECTSCHEDULEPREDICTOR_HPP_
...
class ReconnectSchedulePredictor {
  public:
    ...
    /**
     * Creates a new reconnect schedule predictor if x was compiles with x_USE_S2. Otherwise returns a nullptr
  ...
  private:
     ...
     */
    bool updatePredictedPath(const x::Spatial::DataTypes::Experimental::GeoLocation& newPathStart,
                             const x::Spatial::DataTypes::Experimental::GeoLocation& currentLocation);
    ...
    std::vector<x::Spatial::Mobility::Experimental::ReconnectPoint> reconnectPoints;
...
#endif// x_CORE_INCLUDE_SPATIAL_MOBILITY_RECONNECTSCHEDULEPREDICTORS_RECONNECTSCHEDULEPREDICTOR_HPP_
