...
#ifndef x_CORE_INCLUDE_SINKS_FORMATS_SINKFORMAT_HPP_
#define x_CORE_INCLUDE_SINKS_FORMATS_SINKFORMAT_HPP_
...
#include <optional>
/**
 * @brief this class covers the different output formats that we offer in x
 */
namespace x {
...
#endif// x_CORE_INCLUDE_SINKS_FORMATS_SINKFORMAT_HPP_
