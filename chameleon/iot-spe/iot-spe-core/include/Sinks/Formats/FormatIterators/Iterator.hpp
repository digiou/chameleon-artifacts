...
*/
#ifndef x_CORE_INCLUDE_SINKS_FORMATS_FORMATITERATORS_ITERATOR_HPP_
#define x_CORE_INCLUDE_SINKS_FORMATS_FORMATITERATORS_ITERATOR_HPP_
...
#endif// x_CORE_INCLUDE_SINKS_FORMATS_FORMATITERATORS_ITERATOR_HPP_
