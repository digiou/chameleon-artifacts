...
#ifndef x_CORE_INCLUDE_SINKS_MEDIUMS_MQTTSINK_HPP_
#define x_CORE_INCLUDE_SINKS_MEDIUMS_MQTTSINK_HPP_
...
class MQTTSink : public SinkMedium {
  public:
    ...
    ~MQTTSink() x_NOEXCEPT(false) override;
...
#endif
#endif// x_CORE_INCLUDE_SINKS_MEDIUMS_MQTTSINK_HPP_