...
#ifndef x_CORE_INCLUDE_SINKS_MEDIUMS_OPCSINK_HPP_
#define x_CORE_INCLUDE_SINKS_MEDIUMS_OPCSINK_HPP_
...
class OPCSink : public SinkMedium {
  ...
  public:
     ...
     * @brief dtor
     */
    ~OPCSink() x_NOEXCEPT(false) override;
...
#endif
#endif// x_CORE_INCLUDE_SINKS_MEDIUMS_OPCSINK_HPP_
