...
#ifndef x_CORE_INCLUDE_MONITORING_METRICS_GAUGE_REGISTRATIONMETRICS_HPP_
#define x_CORE_INCLUDE_MONITORING_METRICS_GAUGE_REGISTRATIONMETRICS_HPP_
...
/**
 * Class representing the static metrics that are transmitted during node registration in x.
...
class RegistrationMetrics {
  public:
     ...
     * @return the schema
     */
    static x::SchemaPtr getSchema(const std::string& prefix = "");
...
#endif// x_CORE_INCLUDE_MONITORING_METRICS_GAUGE_REGISTRATIONMETRICS_HPP_
