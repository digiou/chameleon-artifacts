...
#ifndef x_CORE_INCLUDE_MONITORING_METRICS_GAUGE_RUNTIMEMETRICS_HPP_
#define x_CORE_INCLUDE_MONITORING_METRICS_GAUGE_RUNTIMEMETRICS_HPP_
...
using RuntimexMetricsPtr = std::shared_ptr<RuntimeMetrics>;
...
#endif// x_CORE_INCLUDE_MONITORING_METRICS_GAUGE_RUNTIMEMETRICS_HPP_
