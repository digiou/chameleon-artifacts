...
#ifndef x_CORE_INCLUDE_MONITORING_METRICS_GAUGE_CPUMETRICS_HPP_
#define x_CORE_INCLUDE_MONITORING_METRICS_GAUGE_CPUMETRICS_HPP_
...
#endif// x_CORE_INCLUDE_MONITORING_METRICS_GAUGE_CPUMETRICS_HPP_
