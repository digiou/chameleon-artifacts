...
#ifndef x_CORE_INCLUDE_MONITORING_METRICS_METRIC_HPP_
#define x_CORE_INCLUDE_MONITORING_METRICS_METRIC_HPP_
...
/**
* @brief The metric class is a conceptual superclass that represents all metrics in x.
...
#endif// x_CORE_INCLUDE_MONITORING_METRICS_METRIC_HPP_
