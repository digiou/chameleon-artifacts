...
#ifndef x_CORE_INCLUDE_MONITORING_RESOURCESREADER_ABSTRACTSYSTEMRESOURCESREADER_HPP_
#define x_CORE_INCLUDE_MONITORING_RESOURCESREADER_ABSTRACTSYSTEMRESOURCESREADER_HPP_
...
class AbstractSystemResourcesReader {
  public:
    ...
    /**
    * @brief This methods reads runtime system metrics that are used within x (e.g., memory usage, cpu load).
    * @return A RuntimeMetrics object containing the metrics.
    */
    virtual RuntimeMetrics readRuntimexMetrics();

    /**
    * @brief This methods reads system metrics that are used within x (e.g., totalMemoryBytes, core num.).
...
#endif// x_CORE_INCLUDE_MONITORING_RESOURCESREADER_ABSTRACTSYSTEMRESOURCESREADER_HPP_
