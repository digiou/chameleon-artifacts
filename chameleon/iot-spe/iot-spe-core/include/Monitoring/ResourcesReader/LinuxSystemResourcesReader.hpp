...
#ifndef x_CORE_INCLUDE_MONITORING_RESOURCESREADER_LINUXSYSTEMRESOURCESREADER_HPP_
#define x_CORE_INCLUDE_MONITORING_RESOURCESREADER_LINUXSYSTEMRESOURCESREADER_HPP_
...
class LinuxSystemResourcesReader : public AbstractSystemResourcesReader {
  public:
    ...
    */
    RuntimeMetrics readRuntimexMetrics() override;

    /**
    * @brief This methods reads static system metrics that are used within x (e.g., totalMemoryBytes, core num.).
...
#endif// x_CORE_INCLUDE_MONITORING_RESOURCESREADER_LINUXSYSTEMRESOURCESREADER_HPP_
