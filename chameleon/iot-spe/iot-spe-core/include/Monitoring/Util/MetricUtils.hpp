...
#ifndef x_CORE_INCLUDE_MONITORING_UTIL_METRICUTILS_HPP_
#define x_CORE_INCLUDE_MONITORING_UTIL_METRICUTILS_HPP_
...
/**
 * @brief Pre-defined metrics used for x internally.
 */
class MetricUtils {
  public:
    /**
...
#endif// x_CORE_INCLUDE_MONITORING_UTIL_METRICUTILS_HPP_
