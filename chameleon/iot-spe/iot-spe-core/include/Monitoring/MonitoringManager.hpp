...
#ifndef x_CORE_INCLUDE_MONITORING_MONITORINGMANAGER_HPP_
#define x_CORE_INCLUDE_MONITORING_MONITORINGMANAGER_HPP_
...
class MonitoringManager {
  public:
    ...
    */
     ...
     * TupleBuffer is not supporting different xted schemas.
     * @param nodeId
     * @param tupleBuffer
    ...
    */
     ...
     * plan, MonitoringPlan::Default will be returned. If the node does not exist an x exception is thrown.
     * @param nodeId
    ...
    */
     ...
     */
    bool registerLogicalMonitoringStreams(const x::Configurations::CoordinatorConfigurationPtr config);
  ...
  private:
    ...
    x::QueryServicePtr queryService;
    x::QueryCatalogServicePtr catalogService;
};
...
#endif// x_CORE_INCLUDE_MONITORING_MONITORINGMANAGER_HPP_
