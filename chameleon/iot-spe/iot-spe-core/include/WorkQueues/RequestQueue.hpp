...
#ifndef x_CORE_INCLUDE_WORKQUEUES_REQUESTQUEUE_HPP_
#define x_CORE_INCLUDE_WORKQUEUES_REQUESTQUEUE_HPP_
...
class RequestQueue {
  ...
  public:
     ...
     */
    bool add(const xRequestPtr& request);
     ...
     */
    std::vector<xRequestPtr> getNextBatch();
  ...
  private:
    ...
    std::deque<xRequestPtr> requestQueue;
};
using RequestQueuePtr = std::shared_ptr<RequestQueue>;
}// namespace x
#endif// x_CORE_INCLUDE_WORKQUEUES_REQUESTQUEUE_HPP_
