...
#ifndef x_CORE_INCLUDE_WORKQUEUES_REQUESTTYPES_TOPOLOGYREQUESTS_REMOVETOPOLOGYLINKREQUEST_HPP_
#define x_CORE_INCLUDE_WORKQUEUES_REQUESTTYPES_TOPOLOGYREQUESTS_REMOVETOPOLOGYLINKREQUEST_HPP_
...
class RemoveTopologyLinkRequest : public Request {
  ...
  private:
    ...
    x::TopologyNodeId downstreamNodeId;
    x::TopologyNodeId upstreamNodeId;
};
}// namespace x::Experimental
#endif// x_CORE_INCLUDE_WORKQUEUES_REQUESTTYPES_TOPOLOGYREQUESTS_REMOVETOPOLOGYLINKREQUEST_HPP_
