...
#ifndef x_CORE_INCLUDE_WORKQUEUES_REQUESTTYPES_QUERYREQUESTS_ADDQUERYREQUEST_HPP_
#define x_CORE_INCLUDE_WORKQUEUES_REQUESTTYPES_QUERYREQUESTS_ADDQUERYREQUEST_HPP_
...
/**
 * @brief This request is used for running a new query in x cluster
 */
...
#endif// x_CORE_INCLUDE_WORKQUEUES_REQUESTTYPES_QUERYREQUESTS_ADDQUERYREQUEST_HPP_
