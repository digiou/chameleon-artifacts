...
*/
#ifndef x_CORE_INCLUDE_LISTENERS_QUERYSTATUSLISTENER_HPP_
#define x_CORE_INCLUDE_LISTENERS_QUERYSTATUSLISTENER_HPP_
...
#endif// x_CORE_INCLUDE_LISTENERS_QUERYSTATUSLISTENER_HPP_
