...
*/
#ifndef x_CORE_INCLUDE_WORKQUEUES_REQUESTTYPES_EXPERIMENTAL_FAILQUERYREQUEST_HPP_
#define x_CORE_INCLUDE_WORKQUEUES_REQUESTTYPES_EXPERIMENTAL_FAILQUERYREQUEST_HPP_
...
class FailQueryRequest : public AbstractRequest {
  public:
     ...
     */
    FailQueryRequest(x::QueryId queryId, x::QuerySubPlanId failedSubPlanId, uint8_t maxRetries);
    ...
    */
    static FailQueryRequestPtr create(x::QueryId queryId, x::QuerySubPlanId failedSubPlanId, uint8_t maxRetries);
...
#endif// x_CORE_INCLUDE_WORKQUEUES_REQUESTTYPES_EXPERIMENTAL_FAILQUERYREQUEST_HPP_
