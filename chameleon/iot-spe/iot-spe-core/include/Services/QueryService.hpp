...
#ifndef x_CORE_INCLUDE_SERVICES_QUERYSERVICE_HPP_
#define x_CORE_INCLUDE_SERVICES_QUERYSERVICE_HPP_
...
class QueryService {
  ...
  public:
    explicit QueryService(bool enableNewRequestExecutor,
                          ...
                          const x::RequestProcessor::Experimental::AsyncRequestProcessorPtr& asyncRequestExecutor,
  ...
  private:
    ...
    x::RequestProcessor::Experimental::AsyncRequestProcessorPtr asyncRequestExecutor;
...
#endif// x_CORE_INCLUDE_SERVICES_QUERYSERVICE_HPP_
