...
#ifndef x_CORE_INCLUDE_SERVICES_TOPOLOGYMANAGERSERVICE_HPP_
#define x_CORE_INCLUDE_SERVICES_TOPOLOGYMANAGERSERVICE_HPP_
...
class TopologyManagerService {
  ...
  public:
    TopologyManagerService(TopologyPtr topology, x::Spatial::Index::Experimental::LocationIndexPtr locationIndex);
     ...
     */
    bool addGeoLocation(TopologyNodeId topologyNodeId, x::Spatial::DataTypes::Experimental::GeoLocation&& geoLocation);
     ...
     * @return true if successful
     */
    bool updateGeoLocation(TopologyNodeId topologyNodeId, x::Spatial::DataTypes::Experimental::GeoLocation&& geoLocation);
    ...
    getNodesIdsInRange(x::Spatial::DataTypes::Experimental::GeoLocation center, double radius);
     ...
     */
    std::optional<x::Spatial::DataTypes::Experimental::GeoLocation> getGeoLocationForNode(TopologyNodeId nodeId);

    /**
      * @brief function to obtain JSON representation of a x Topology
...
#endif// x_CORE_INCLUDE_SERVICES_TOPOLOGYMANAGERSERVICE_HPP_
