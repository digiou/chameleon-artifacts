...
*/
#ifndef x_CORE_INCLUDE_SERVICES_REPLICATIONSERVICE_HPP_
#define x_CORE_INCLUDE_SERVICES_REPLICATIONSERVICE_HPP_
 ...
 * epoch barrier. It saves current  For the given query id it finds logical sources and maps them to the physical ox. For every physical source it creates
 * a RPCWorkerClient to send current epoch barrier.
 */
class ReplicationService {
  public:
    ReplicationService(xCoordinatorPtr coordinatorPtr);
  ...
  private:
    ...
    xCoordinatorPtr coordinatorPtr;
...
#endif// x_CORE_INCLUDE_SERVICES_REPLICATIONSERVICE_HPP_
