...
*/
#ifndef x_CORE_INCLUDE_SERVICES_LOCATIONSERVICE_HPP_
#define x_CORE_INCLUDE_SERVICES_LOCATIONSERVICE_HPP_
...
class LocationService {
  public:
    explicit LocationService(TopologyPtr topology, x::Spatial::Index::Experimental::LocationIndexPtr locationIndex);
     ...
     */
    bool updatePredictedReconnect(const std::vector<x::Spatial::Mobility::Experimental::ReconnectPoint>& addPredictions,
  ...
  private:
     ...
     * ]
     */
    static nlohmann::json convertLocationToJson(x::Spatial::DataTypes::Experimental::GeoLocation geoLocation);
...
#endif// x_CORE_INCLUDE_SERVICES_LOCATIONSERVICE_HPP_
