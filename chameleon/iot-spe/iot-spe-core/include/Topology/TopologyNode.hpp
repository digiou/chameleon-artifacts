...
#ifndef x_CORE_INCLUDE_TOPOLOGY_TOPOLOGYNODE_HPP_
#define x_CORE_INCLUDE_TOPOLOGY_TOPOLOGYNODE_HPP_
...
/**
 * @brief This class represents information about a physical node participating in the x infrastructure
 */
class TopologyNode : public Node {
  ...
  public:
     ...
     * @param spatialType
     */
    void setSpatialType(x::Spatial::Experimental::SpatialType spatialType);
     ...
     */
    x::Spatial::Experimental::SpatialType getSpatialNodeType();
...
namespace fmt {
template<>
struct formatter<x::TopologyNode> : formatter<std::string> {
    auto format(const x::TopologyNode& topology_node, format_context& ctx) -> decltype(ctx.out()) {
...
#endif// x_CORE_INCLUDE_TOPOLOGY_TOPOLOGYNODE_HPP_
