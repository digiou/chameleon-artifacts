...
*/
#ifndef x_CORE_INCLUDE_EXCEPTIONS_LOGICALSOURCENOTFOUNDEXCEPTION_HPP_
#define x_CORE_INCLUDE_EXCEPTIONS_LOGICALSOURCENOTFOUNDEXCEPTION_HPP_
...
/**
 * @brief This exception indicates, that a logical source was not found
 */
class LogicalSourceNotFoundException : public RequestExecutionException {
  public:
    /**
