...
#ifndef x_CORE_INCLUDE_REST_CONTROLLER_MONITORINGCONTROLLER_HPP_
#define x_CORE_INCLUDE_REST_CONTROLLER_MONITORINGCONTROLLER_HPP_
...
class MonitoringController : public oatpp::web::server::api::ApiController {
  ...
  public:
     ...
     * @param completeRouterPrefix - url consisting of base router prefix (e.g "v1/x/") and controller specific router prefix (e.g "monitoringController")
     */
...
#endif// x_CORE_INCLUDE_REST_CONTROLLER_MONITORINGCONTROLLER_HPP_
