...
*/
#ifndef x_CORE_INCLUDE_REST_CONTROLLER_QUERYCATALOGCONTROLLER_HPP_
#define x_CORE_INCLUDE_REST_CONTROLLER_QUERYCATALOGCONTROLLER_HPP_
...
class QueryCatalogController : public oatpp::web::server::api::ApiController {
  ...
  public:
     ...
     * @param coordinator - central entity of IoTSPE
     * @param globalQueryPlan - responsible for storing all currently running and to be deployed QueryPlans in the x system.
    ...
    QueryCatalogController(const std::shared_ptr<ObjectMapper>& objectMapper,
                           ...
                           const xCoordinatorWeakPtr& coordinator,
    ...
    ENDPOINT("GET", "/allRegisteredQueries", getAllRegisteredQueires) {
        ...
        try {
            ...
            x_ERROR("QueryCatalogController: handleGet -allRegisteredQueries: Exception occurred while building the "
    ...
    ENDPOINT("GET", "/getNumberOfProducedBuffers", getNumberOfProducedBuffers, QUERY(UInt64, queryId, "queryId")) {
        try {
            x_DEBUG("getNumberOfProducedBuffers called");
...
#endif// x_CORE_INCLUDE_REST_CONTROLLER_QUERYCATALOGCONTROLLER_HPP_
