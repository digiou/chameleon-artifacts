...
*/
#ifndef x_CORE_INCLUDE_REST_CONTROLLER_TOPOLOGYCONTROLLER_HPP_
#define x_CORE_INCLUDE_REST_CONTROLLER_TOPOLOGYCONTROLLER_HPP_
  ...
  public:
    ...
    ENDPOINT("GET", "", getTopology) {
        try {
            ...
            x_ERROR("TopologyController: handleGet -getTopology: Exception occurred while building the "
                      "topology: {}",
                      exc.what());
    ...
    ENDPOINT("POST", "/addParent", addParent, BODY_STRING(String, request)) {
        try {
            ...
            if (added) {
                x_DEBUG("TopologyController::handlePost:addParent: created link successfully new topology is=");
            } else {
                x_ERROR("TopologyController::handlePost:addParent: Failed");
    ...
    ENDPOINT("DELETE", "/removeParent", removeParent, BODY_STRING(String, request)) {
        try {
            ...
            if (removed) {
                x_DEBUG("TopologyController::handlePost:addParent: deleted link successfully");
            } else {
                x_ERROR("TopologyController::handlePost:addParent: Failed");
...
#endif// x_CORE_INCLUDE_REST_CONTROLLER_TOPOLOGYCONTROLLER_HPP_
