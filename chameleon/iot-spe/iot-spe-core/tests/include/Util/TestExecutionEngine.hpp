...
*/
#ifndef x_x_CORE_TESTS_INCLUDE_UTIL_TESTEXECUTIONENGINE_HPP_
#define x_x_CORE_TESTS_INCLUDE_UTIL_TESTEXECUTIONENGINE_HPP_
...
class TestExecutionEngine {
  public:
    explicit TestExecutionEngine(
        ...
        const QueryCompilation::StreamJoinStrategy& joinStrategy = QueryCompilation::StreamJoinStrategy::xTED_LOOP_JOIN,
...
#endif//x_x_CORE_TESTS_INCLUDE_UTIL_TESTEXECUTIONENGINE_HPP_
