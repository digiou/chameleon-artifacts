...
TEST_F(FilterPushDownTest, testCorrectResultsForFilterPushDownBelowTwoMaps) {
    ...
    x_INFO("FilterPushDownTest: Start testCorrectResultsForFilterPushDownBelowTwoMaps");
    ...
    std::vector<Output> expectedOutput = {{1543624260000, 95, 2},
                                          ...
                                          {1543626120000, 75, 1},
                                          {1543626420000, 75, 2}};
    x_INFO("FilterPushDownTest: Start testCorrectResultsForFilterPushDownBelowTwoMaps expected output size {},",
             expectedOutput.size());
...
TEST_F(FilterPushDownTest, testSameResultsForPushDownBelowMapWithNewField) {
    x_INFO("FilterPushDownTest: Start testSameResultsForPushDownBelowMapWithNewField");
