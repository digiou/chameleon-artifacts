...
class VariableLengthIntegrationTest : public Testing::BaseIntegrationTest {
  public:
    static void SetUpTestCase() {
        x::Logger::setupLogging("VariableLengthIntegrationTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup VariableLengthIntegrationTest test class.");
    }
...
TEST_F(VariableLengthIntegrationTest, testCsvSourceWithVariableLengthFields) {
    ...
    x_INFO("VariableLengthIntegrationTest: Start coordinator");
    ...
    EXPECT_NE(port, 0UL);
    x_DEBUG("VariableLengthIntegrationTest: Coordinator started successfully");
    x_DEBUG("VariableLengthIntegrationTest: Start worker 1");
    ...
    x_INFO("VariableLengthIntegrationTest: Worker1 started successfully");
    ...
    x_INFO("VariableLengthIntegrationTest: Remove query");
    ...
    x_INFO("VariableLengthIntegrationTest: content={}", content);
    x_INFO("VariableLengthIntegrationTest: expContent={}", expectedContent);
