...
class MultipleWindowsTest : public Testing::BaseIntegrationTest {
  public:
    static void SetUpTestCase() {
        x::Logger::setupLogging("MultipleWindowsTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup MultipleWindowsTest test class.");
    }
};
...
TEST_F(MultipleWindowsTest, testTwoCentralTumblingWindows) {
    ...
    x_INFO("MultipleWindowsTest: Start coordinator");
    ...
    x_INFO("MultipleWindowsTest: Submit query");
    ...
    x_INFO("MultipleWindowsTest: Remove query");

    EXPECT_TRUE(TestUtils::checkStoppedOrTimeout(queryId, queryCatalogService));

    x_INFO("MultipleWindowsTest: Stop worker 1");
    bool retStopWrk1 = wrk1->stop(true);
    EXPECT_TRUE(retStopWrk1);

    x_INFO("MultipleWindowsTest: Stop Coordinator");
    bool retStopCord = crd->stopCoordinator(true);
    EXPECT_TRUE(retStopCord);
    x_INFO("MultipleWindowsTest: Test finished");
}
...
TEST_F(MultipleWindowsTest, testTwoDistributedTumblingWindows) {
    ...
    x_INFO("MultipleWindowsTest: Stop worker 2");
...
TEST_F(MultipleWindowsTest, testThreeDifferentWindows) {
    ...
    x_DEBUG("MultipleWindowsTest: Submit query");
    ...
    x_DEBUG("MultipleWindowsTest: Remove query");

    EXPECT_TRUE(TestUtils::checkStoppedOrTimeout(queryId, queryCatalogService));

    x_DEBUG("MultipleWindowsTest: Stop worker 1");
    bool retStopWrk1 = wrk1->stop(true);
    EXPECT_TRUE(retStopWrk1);

    x_DEBUG("MultipleWindowsTest: Stop Coordinator");
    bool retStopCord = crd->stopCoordinator(true);
    EXPECT_TRUE(retStopCord);
    x_DEBUG("MultipleWindowsTest: Test finished");
}
...
|  |  |        SOURCE(8,window)
    ...
    x_INFO("MultipleWindowsTest: Start worker 3");
    ...
    x_INFO("MultipleWindowsTest: Worker3 started SUCCESSFULLY");
    ...
    x_DEBUG("MultipleWindowsTest: Stop worker 2");
    bool retStopWrk2 = wrk2->stop(true);
    EXPECT_TRUE(retStopWrk2);

    x_DEBUG("MultipleWindowsTest: Stop worker 3");
