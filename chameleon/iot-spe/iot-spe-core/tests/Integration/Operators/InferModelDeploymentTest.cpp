...
class InferModelDeploymentTest
  ...
  public:
    static void SetUpTestCase() {
        x::Logger::setupLogging("MLModelDeploymentTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup MLModelDeploymentTest test class.");
    }
...
TEST_F(InferModelDeploymentTest, DISABLED_testSimpleMLModelDeploymentMixedTypes) {
    ...
    //We set the predictions data type to FLOAT32 since the trained iris_95acc.tflite model defix tensors of data type float32 as output tensors.
