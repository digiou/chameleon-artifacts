...
class JoinDeploymentTest : public Testing::BaseIntegrationTest,
  ...
  public:
    static void SetUpTestCase() {
        x::Logger::setupLogging("JoinDeploymentTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("QueryExecutionTest: Setup JoinDeploymentTest test class.");
    }
    ...
    void SetUp() override {
        ...
        joinStrategy = x::Runtime::Execution::JoinDeploymentTest::GetParam();
    ...
    void runJoinQueryTwoLogicalStreams(const Query& query,
        ...
        auto actualResult = testHarxs.getOutput<ResultRecord>(expectedSinkBuffer.getNumberOfTuples());
