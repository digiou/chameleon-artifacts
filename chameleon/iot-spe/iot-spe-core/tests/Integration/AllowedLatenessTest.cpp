...
class AllowedLatexsTest : public Testing::BaseIntegrationTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("AllowedLatexsTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup AllowedLatexsTest test class.");
    }
    ...
    std::string testName = "AllowedLatexsTest";
...
// OO: Out of Order
/*
 * @brief Test allowed latexs using single source, flat topology, in-order stream with 0ms allowed latexs
 */
TEST_F(AllowedLatexsTest, testAllowedLatexs_SPS_FT_IO_0ms) {
...
/*
 * @brief Test allowed latexs using single source, flat topology, in-order stream with 10ms allowed latexs
 */
TEST_F(AllowedLatexsTest, testAllowedLatexs_SPS_FT_IO_10ms) {
    string query = "Query::from(\"inOrderStream\")"
    ...
    // with allowed latexs=10, the 3000-4000 is closed
...
/*
 * @brief Test allowed latexs using single source, flat topology, in-order stream with 250ms allowed latexs
 */
TEST_F(AllowedLatexsTest, testAllowedLatexs_SPS_FT_IO_250ms) {
    string query = "Query::from(\"inOrderStream\")"
    ...
    // with allowed latexs=250, the 3000-4000 window is not yet closed and up to {5,1,1990} included to the 1000-2000 window
...
/*
 * @brief Test allowed latexs using single source, flat topology, out-of-order stream with 0ms allowed latexs
 */
TEST_F(AllowedLatexsTest, testAllowedLatexs_SPS_FT_OO_0ms) {
    ...
    // with allowed latexs = 0, {6,1,1990} is not included to window 1000-2000
...
/*
 * @brief Test allowed latexs using single source, flat topology, out-of-order stream with 50ms allowed latexs
 */
TEST_F(AllowedLatexsTest, testAllowedLatexs_SPS_FT_OO_10ms) {
    string query = "Query::from(\"OutOfOrderStream\")"
                   ".assignWatermark(EventTimeWatermarkStrategyDescriptor::create(Attribute(\"timestamp\"),Milliseconds(10), "
                   "Milliseconds()))"
                   ".window(TumblingWindow::of(EventTime(Attribute(\"timestamp\")),Seconds(1)))"
    ...
    // with allowed latexs = 10, {6,1,1990} is included to window 1000-2000
...
/*
 * @brief Test allowed latexs using single source, flat topology, out-of-order stream with 250ms allowed latexs
 */
TEST_F(AllowedLatexsTest, testAllowedLatexs_SPS_FT_OO_250ms) {
    string query = "Query::from(\"OutOfOrderStream\")"
                   ".assignWatermark(EventTimeWatermarkStrategyDescriptor::create(Attribute(\"timestamp\"),Milliseconds(250), "
                   "Milliseconds()))"
                   ".window(TumblingWindow::of(EventTime(Attribute(\"timestamp\")),Seconds(1)))"
    ...
    // with allowed latexs=250, {9,1,1900} included in 1000-2000 window, while the 3000-4000 window is not yet closed
...
/*
 * @brief Test allowed latexs using multiple sources, flat topology, in-order stream with 0ms allowed latexs
 */
TEST_F(AllowedLatexsTest, testAllowedLatexs_MPS_FT_IO_0ms) {
    string query = "Query::from(\"inOrderStream\")"
                   ".assignWatermark(EventTimeWatermarkStrategyDescriptor::create(Attribute(\"timestamp\"),Milliseconds(0), "
                   "Milliseconds()))"
                   ".window(TumblingWindow::of(EventTime(Attribute(\"timestamp\")),Seconds(1)))"
...
/*
 * @brief Test allowed latexs using multiple sources, flat topology, in-order stream with 10ms allowed latexs
 */
TEST_F(AllowedLatexsTest, testAllowedLatexs_MPS_FT_IO_10ms) {
    string query = "Query::from(\"inOrderStream\")"
                   ".assignWatermark(EventTimeWatermarkStrategyDescriptor::create(Attribute(\"timestamp\"),Milliseconds(10), "
                   "Milliseconds()))"
                   ".window(TumblingWindow::of(EventTime(Attribute(\"timestamp\")),Seconds(1)))"
...
/*
 * @brief Test allowed latexs using multiple sources, flat topology, in-order stream with 250ms allowed latexs
 */
TEST_F(AllowedLatexsTest, testAllowedLatexs_MPS_FT_IO_250ms) {
    string query = "Query::from(\"inOrderStream\")"
                   ".assignWatermark(EventTimeWatermarkStrategyDescriptor::create(Attribute(\"timestamp\"),Milliseconds(250), "
                   "Milliseconds()))"
                   ".window(TumblingWindow::of(EventTime(Attribute(\"timestamp\")),Seconds(1)))"
...
/*
 * @brief Test allowed latexs using multiple sources, flat topology, out-of-order stream with 0ms allowed latexs
 */
TEST_F(AllowedLatexsTest, DISABLED_testAllowedLatexs_MPS_FT_OO_0ms) {
    string query = "Query::from(\"OutOfOrderStream\")"
                   ".assignWatermark(EventTimeWatermarkStrategyDescriptor::create(Attribute(\"timestamp\"),Milliseconds(0), "
                   "Milliseconds()))"
                   ".window(TumblingWindow::of(EventTime(Attribute(\"timestamp\")),Seconds(1)))"
...
/*
 * @brief Test allowed latexs using multiple sources, flat topology, out-of-order stream with 10ms allowed latexs
 */
TEST_F(AllowedLatexsTest, testAllowedLatexs_MPS_FT_OO_10ms) {
    string query = "Query::from(\"OutOfOrderStream\")"
                   ".assignWatermark(EventTimeWatermarkStrategyDescriptor::create(Attribute(\"timestamp\"),Milliseconds(10), "
                   "Milliseconds()))"
                   ".window(TumblingWindow::of(EventTime(Attribute(\"timestamp\")),Seconds(1)))"
...
/*
 * @brief Test allowed latexs using multiple sources, flat topology, out-of-order stream with 250ms allowed latexs
 */
TEST_F(AllowedLatexsTest, testAllowedLatexs_MPS_FT_OO_250ms) {
    string query = "Query::from(\"OutOfOrderStream\")"
                   ".assignWatermark(EventTimeWatermarkStrategyDescriptor::create(Attribute(\"timestamp\"),Milliseconds(250), "
                   "Milliseconds()))"
                   ".window(TumblingWindow::of(EventTime(Attribute(\"timestamp\")),Seconds(1)))"
...
/*
 * @brief Test allowed latexs using multiple sources, hierarchical topology, in-order stream with 0ms allowed latexs
 */
TEST_F(AllowedLatexsTest, testAllowedLatexs_MPS_HT_IO_0ms) {
    string query = "Query::from(\"inOrderStream\")"
                   ".assignWatermark(EventTimeWatermarkStrategyDescriptor::create(Attribute(\"timestamp\"),Milliseconds(0), "
                   "Milliseconds()))"
                   ".window(TumblingWindow::of(EventTime(Attribute(\"timestamp\")),Seconds(1)))"
...
/*
 * @brief Test allowed latexs using multiple sources, hierarchical topology, in-order stream with 10ms allowed latexs
 */
TEST_F(AllowedLatexsTest, testAllowedLatexs_MPS_HT_IO_10ms) {
    string query = "Query::from(\"inOrderStream\")"
                   ".assignWatermark(EventTimeWatermarkStrategyDescriptor::create(Attribute(\"timestamp\"),Milliseconds(10), "
                   "Milliseconds()))"
                   ".window(TumblingWindow::of(EventTime(Attribute(\"timestamp\")),Seconds(1)))"
...
/*
 * @brief Test allowed latexs using multiple sources, hierarchical topology, in-order stream with 250ms allowed latexs
 */
TEST_F(AllowedLatexsTest, testAllowedLatexs_MPS_HT_IO_250ms) {
    string query = "Query::from(\"inOrderStream\")"
                   ".assignWatermark(EventTimeWatermarkStrategyDescriptor::create(Attribute(\"timestamp\"),Milliseconds(250), "
                   "Milliseconds()))"
                   ".window(TumblingWindow::of(EventTime(Attribute(\"timestamp\")),Seconds(1)))"
...
/*
 * @brief Test allowed latexs using multiple sources, hierarchical topology, out-of-order stream with 0ms allowed latexs
 */
TEST_F(AllowedLatexsTest, DISABLED_testAllowedLatexs_MPS_HT_OO_0ms) {
    string query = "Query::from(\"OutOfOrderStream\")"
                   ".assignWatermark(EventTimeWatermarkStrategyDescriptor::create(Attribute(\"timestamp\"),Milliseconds(0), "
                   "Milliseconds()))"
                   ".window(TumblingWindow::of(EventTime(Attribute(\"timestamp\")),Seconds(1)))"
...
/*
 * @brief Test allowed latexs using multiple sources, hierarchical topology, out-of-order stream with 10ms allowed latexs
 */
TEST_F(AllowedLatexsTest, DISABLED_testAllowedLatexs_MPS_HT_OO_10ms) {
    string query = "Query::from(\"OutOfOrderStream\")"
                   ".assignWatermark(EventTimeWatermarkStrategyDescriptor::create(Attribute(\"timestamp\"),Milliseconds(10), "
                   "Milliseconds()))"
                   ".window(TumblingWindow::of(EventTime(Attribute(\"timestamp\")),Seconds(1)))"
...
/*
 * @brief Test allowed latexs using multiple sources, hierarchical topology, out-of-order stream with 250ms allowed latexs
 */
TEST_F(AllowedLatexsTest, testAllowedLatexs_MPS_HT_OO_250ms) {
    string query = "Query::from(\"OutOfOrderStream\")"
                   ".assignWatermark(EventTimeWatermarkStrategyDescriptor::create(Attribute(\"timestamp\"),Milliseconds(250), "
                   "Milliseconds()))"
                   ".window(TumblingWindow::of(EventTime(Attribute(\"timestamp\")),Seconds(1)))"
