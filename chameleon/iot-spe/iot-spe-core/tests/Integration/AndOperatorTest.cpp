...
class AndOperatorTest : public Testing::BaseIntegrationTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("AndOperatorTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup AndOperatorTest test class.");
    }
 ...
 */
TEST_F(AndOperatorTest, testPatternOximpleAnd) {
    // Setup Coordinator
    std::string window =
    ...
    x_INFO("AndOperatorTest: Worker1 started successfully");

    // Setup Worker 2
    x_INFO("AndOperatorTest: Start worker 2");
    ...
    x_INFO("AndOperatorTest: Worker2 started successfully");

    std::string outputFilePath = getTestResourceFolder() / "testAndPatternWithTestStream1.out";
    remove(outputFilePath.c_str());

    x_INFO("AndOperatorTest: Submit andWith pattern");
...
TEST_F(AndOperatorTest, DISABLED_testMultiAndPattern) {
    ...
    // Setup Worker 3
    x_INFO("AndOperatorTest: Start worker 3");
    ...
    x_INFO("AndOperatorTest: Worker3 started successfully");
