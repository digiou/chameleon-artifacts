...
class StateTest : public Testing::BaseUnitTest {
  public:
    static void SetUpTestCase() {
        x::Logger::setupLogging("StateTest.log", x::LogLevel::LOG_DEBUG);

        x_INFO("Setup StateTest test class.");
    }
    static void TearDownTestCase() { x_DEBUG("Tear down StateTest test class."); }
};
