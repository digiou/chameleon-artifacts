...
class SpatialExpressionNodeTest : public Testing::BaseUnitTest {
  protected:
    static void SetUpTestCase() {
        x::Logger::setupLogging("SpatialExpressionNodeTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup SpatialExpressionNodeTest test class.");
    }

    static void TearDownTestCase() { x_INFO("Tear down SpatialExpressionNodeTest test class."); }
};
