...
class MapJavaUDFLogicalOperatorNodeTest : public Testing::BaseUnitTest {
  protected:
    static void SetUpTestCase() { x::Logger::setupLogging("MapJavaUDFLogicalOperatorNodeTest", x::LogLevel::LOG_DEBUG); }
};
...
// Regression test for https://github.com/IoTSPE/IoTSPE/issues/3484
