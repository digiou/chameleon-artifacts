...
class ConvertLogicalToPhysicalSinkTest : public Testing::BaseIntegrationTest {
  public:
    static void SetUpTestCase() {
        x::Logger::setupLogging("ConvertLogicalToPhysicalSinkTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup ConvertLogicalToPhysicalSinkTest test class.");
    }
...
TEST_F(ConvertLogicalToPhysicalSinkTest, testConvertingNetworkLogicalToPhysicalSink) {
    ...
    SinkDescriptorPtr sinkDescriptor =
        Network::NetworkSinkDescriptor::create(nodeLocation, xPartition, std::chrono::seconds(1), 1);
