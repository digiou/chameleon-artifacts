...
class ConvertLogicalToPhysicalSourceTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("ConvertLogicalToPhysicalSourceTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup ConvertLogicalToPhysicalSourceTest test class.");
    }

    void SetUp() override {
        Testing::BaseUnitTest::SetUp();
        x_INFO("Setup ConvertLogicalToPhysicalSourceTest test instance.");
    ...
    void TearDown() override {
        x_INFO("TearDown ConvertLogicalToPhysicalSourceTest test instance.");
