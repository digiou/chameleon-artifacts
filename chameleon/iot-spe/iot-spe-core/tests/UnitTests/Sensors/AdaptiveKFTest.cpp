...
class AdaptiveKFTest : public Testing::BaseIntegrationTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("AdaptiveKFTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup AdaptiveKFTest test class.");
    }

    static void TearDownTestCase() { x_INFO("Tear down AdaptiveKFTest test class."); }

    void SetUp() override {
        Testing::BaseIntegrationTest::SetUp();
        x_INFO("Setup AdaptiveKFTest class.");
    ...
    void TearDown() override {
        x_INFO("Tear down AdaptiveKFTest class.");
