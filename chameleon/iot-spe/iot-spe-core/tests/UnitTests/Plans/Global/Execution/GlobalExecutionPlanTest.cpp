...
class GlobalExecutionPlanTest : public Testing::BaseUnitTest {
  ...
  public:
    ...
    static void SetUpTestCase() {
        Logger::setupLogging("GlobalExecutionPlanTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup GlobalExecutionPlanTest test case.");
    }
};
...
TEST_F(GlobalExecutionPlanTest, testGlobalExecutionPlanWithSingleExecutionNodeWithOnePlan) {
    ...
    x_INFO("GlobalExecutionPlanTest: Actual plan: \n{}", actualPlan);

    x_INFO("GlobalExecutionPlanTest: queryPlan.toString(): \n{}", plan->toString());
...
TEST_F(GlobalExecutionPlanTest, testGlobalExecutionPlanWithSingleExecutionNodeWithTwoPlan) {
    ...
    x_DEBUG("GlobalQueryPlanTest: Adding a query plan to the execution node");
    ...
    x_DEBUG("GlobalQueryPlanTest: Adding another query plan to the execution node");
...
/**
 * @brief This test is for validating behaviour for a global execution plan with xted execution node with one plan for different queryIdAndCatalogEntryMapping
 */
