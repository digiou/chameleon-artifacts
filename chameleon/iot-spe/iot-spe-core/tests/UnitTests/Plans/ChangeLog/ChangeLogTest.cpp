...
class ChangeLogTest : public Testing::BaseUnitTest {
  public:
    static void SetUpTestCase() {
        x::Logger::setupLogging("ChangeLogTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup ChangeLogTest test class.");
    }
...
TEST_F(ChangeLogTest, InsertAndFetchChangeLogEntry) {
    ...
    x_DEBUG("{}", queryPlan->toString());

    // Initialize change log
    auto changeLog = x::Optimizer::Experimental::ChangeLog::create();
    auto changelogEntry = x::Optimizer::Experimental::ChangeLogEntry::create({sourceOp1}, {sinkOp1});
...
TEST_F(ChangeLogTest, InsertAndFetchMultipleChangeLogEntries) {
    ...
    // Initialize change log
    auto changeLog = x::Optimizer::Experimental::ChangeLog::create();
    auto changelogEntry1 = x::Optimizer::Experimental::ChangeLogEntry::create({sourceOp1}, {sinkOp1});
    auto changelogEntry2 = x::Optimizer::Experimental::ChangeLogEntry::create({sourceOp1}, {sinkOp1});
    auto changelogEntry3 = x::Optimizer::Experimental::ChangeLogEntry::create({sourceOp1}, {sinkOp1});
    auto changelogEntry4 = x::Optimizer::Experimental::ChangeLogEntry::create({sourceOp1}, {sinkOp1});
    auto changelogEntry5 = x::Optimizer::Experimental::ChangeLogEntry::create({sourceOp1}, {sinkOp1});
    auto changelogEntry6 = x::Optimizer::Experimental::ChangeLogEntry::create({sourceOp1}, {sinkOp1});
...
TEST_F(ChangeLogTest, UpdateChangeLogProcessingTime) {
    ...
    auto changelogEntry1 = x::Optimizer::Experimental::ChangeLogEntry::create({sourceOp1}, {filterOp1});
    auto changelogEntry2 = x::Optimizer::Experimental::ChangeLogEntry::create({sourceOp1}, {filterOp1});
    auto changelogEntry3 = x::Optimizer::Experimental::ChangeLogEntry::create({sourceOp1}, {filterOp1});

    //two more overlapping change log entries
    auto changelogEntry4 = x::Optimizer::Experimental::ChangeLogEntry::create({filterOp2}, {sinkOp1});
    auto changelogEntry5 = x::Optimizer::Experimental::ChangeLogEntry::create({filterOp2}, {sinkOp1});
...
TEST_F(ChangeLogTest, PerformLogCompactionForPartiallyOverlappingChangeLogs) {
    ...
    auto changeLog = x::Optimizer::Experimental::ChangeLog::create();
    auto changelogEntry1 = x::Optimizer::Experimental::ChangeLogEntry::create({sourceOp1}, {filterOp1});
    auto changelogEntry2 = x::Optimizer::Experimental::ChangeLogEntry::create({filterOp2}, {sinkOp1});
    changeLog->addChangeLogEntry(1, std::move(changelogEntry1));
    changeLog->addChangeLogEntry(2, std::move(changelogEntry2));
...
TEST_F(ChangeLogTest, PerformLogCompactionForPartiallyNonOverlappingChangeLogs) {
    ...
    // Initialize change log
    auto changeLog = x::Optimizer::Experimental::ChangeLog::create();
    auto changelogEntry1 = x::Optimizer::Experimental::ChangeLogEntry::create({sourceOp1, sourceOp2}, {filterOp2});
    auto changelogEntry2 = x::Optimizer::Experimental::ChangeLogEntry::create({filterOp3}, {sinkOp1});
    changeLog->addChangeLogEntry(1, std::move(changelogEntry1));
    changeLog->addChangeLogEntry(2, std::move(changelogEntry2));
