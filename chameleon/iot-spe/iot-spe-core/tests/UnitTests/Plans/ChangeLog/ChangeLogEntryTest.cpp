...
class ChangeLogEntryTest : public Testing::BaseUnitTest {
  public:
    static void SetUpTestCase() {
        x::Logger::setupLogging("ChangeLogEntryTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup ChangeLogEntryTest test class.");
    }
...
TEST_F(ChangeLogEntryTest, FetchPoSetOfChangeLogEntryWithMultipleDownStreamOptrs) {
    ...
    auto changelogEntry = x::Optimizer::Experimental::ChangeLogEntry::create({sourceOp1}, {sinkOp1, sinkOp2});
...
TEST_F(ChangeLogEntryTest, FetchPoSetOfChangeLogEntryWithMultipleUpStreamOptrs) {
    ...
    // Initialize change log
    auto changelogEntry = x::Optimizer::Experimental::ChangeLogEntry::create({sourceOp1, sourceOp2}, {sinkOp1});
