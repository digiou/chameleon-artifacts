...
class MapUDFsToOpenCLOperatorsRuleTest : public Testing::BaseUnitTest {
  ...
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("RenameSourceToProjectOperatorRuleTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup RenameSourceToProjectOperatorRuleTest test case.");
    }
...
TEST_F(MapUDFsToOpenCLOperatorsRuleTest, testAddingSingleSourceRenameOperator) {
    ...
    x_INFO("{}", updatedQueryPlan->toString());
