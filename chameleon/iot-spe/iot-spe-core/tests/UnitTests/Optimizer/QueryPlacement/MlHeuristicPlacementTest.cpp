...
class MlHeuristicPlacementTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("MlHeuristicPlacementTest.log", x::LogLevel::LOG_DEBUG);
        x_DEBUG("Setup MlHeuristicPlacementTest test class.");
    }

    /* Will be called before a test is executed. */
    void SetUp() override {
        Testing::BaseUnitTest::SetUp();
        x_DEBUG("Setup MlHeuristicPlacementTest test case.");
...
TEST_F(MlHeuristicPlacementTest, testPlacingQueryWithMlHeuristicStrategy) {
    ...
    x_DEBUG("MlHeuristicPlacementTest: topology: \n{}", topology->toString());
    x_DEBUG("MlHeuristicPlacementTest: query plan \n{}", globalExecutionPlan->getAsString());
    x_DEBUG("MlHeuristicPlacementTest: shared plan \n{}", sharedQueryPlan->getQueryPlan()->toString());
