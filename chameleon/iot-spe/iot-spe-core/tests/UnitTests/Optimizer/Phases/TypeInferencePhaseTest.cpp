...
class TypeInferencePhaseTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("TypeInferencePhaseTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup TypeInferencePhaseTest test class.");
    }
};
...
TEST_F(TypeInferencePhaseTest, inferQueryPlan) {
    ...
    x_DEBUG("first={} second={}", map->getOutputSchema()->toString(), mappedSchema->toString());
...
TEST_F(TypeInferencePhaseTest, inferWindowQuery) {
    ...
    x_DEBUG("{}", resultPlan->getSinkOperators()[0]->getOutputSchema()->toString());
    // we just access the old references
...
TEST_F(TypeInferencePhaseTest, inferQuerySourceReplace) {
    ...
    x_INFO("{}", sink->getOutputSchema()->toString());
...
TEST_F(TypeInferencePhaseTest, inferQueryMapAssignment) {
    ...
    phase->execute(plan);
    x_DEBUG("result schema is={}", maps[0]->getOutputSchema()->toString());
...
TEST_F(TypeInferencePhaseTest, inferTypeForPowerOperatorQuery) {
    ...
    EXPECT_TRUE(sourceOutputSchema->hasFieldName("default_logical$f1"));
    EXPECT_TRUE(sourceOutputSchema->hasFieldName("default_logical$f2"));
    EXPECT_TRUE(sourceOutputSchema->hasFieldName("default_logical$f3"));
    ...
    EXPECT_TRUE(mapOutputSchema->hasFieldName("default_logical$powInt32"));
    EXPECT_TRUE(mapOutputSchema->hasFieldName("default_logical$powFloat32"));
    EXPECT_TRUE(mapOutputSchema->hasFieldName("default_logical$powInt64"));
    ...
    EXPECT_TRUE(sinkOutputSchema->hasFieldName("powInt32"));
    EXPECT_TRUE(sinkOutputSchema->hasFieldName("powFloat32"));
    EXPECT_TRUE(sinkOutputSchema->hasFieldName("powInt64"));
}
...
TEST_F(TypeInferencePhaseTest, inferQueryWithRenameSourceAndProjectWithFullyQualifiedNamesAndJoinOperator) {
    ...
    SchemaPtr filterOutputSchema = filterOperator[0]->getOutputSchema();
    x_DEBUG("expected = {}", filterOperator[0]->getOutputSchema()->toString());
...
TEST_F(TypeInferencePhaseTest, testInferQueryWithMultipleJoins) {
    ...
    SchemaPtr sourceOutputSchema = sourceOperator[0]->getOutputSchema();
    x_DEBUG("expected src0= {}", sourceOperator[0]->getOutputSchema()->toString());
    EXPECT_TRUE(sourceOutputSchema->fields.size() == 3);
    ...
    x_DEBUG("expected src2= {}", sourceOperator[1]->getOutputSchema()->toString());
    ...
    SchemaPtr projectOutputSchema = projectOperator[0]->getOutputSchema();
    x_DEBUG("expected = {}", projectOperator[0]->getOutputSchema()->toString());
    EXPECT_TRUE(projectOutputSchema->fields.size() == 2);
    ...
    SchemaPtr mapOutputSchema = mapOperator[0]->getOutputSchema();
    x_DEBUG("expected = {}", mapOperator[0]->getOutputSchema()->toString());
    EXPECT_TRUE(mapOutputSchema->fields.size() == 2);
    EXPECT_TRUE(mapOutputSchema->hasFieldName("f23"));
    EXPECT_TRUE(mapOutputSchema->hasFieldName("f44"));

    SchemaPtr renameSourceOutputSchema = renameSourceOperator[0]->getOutputSchema();
    x_DEBUG("expected = {}", renameSourceOperator[0]->getOutputSchema()->toString());
    EXPECT_TRUE(renameSourceOutputSchema->fields.size() == 2);
...
TEST_F(TypeInferencePhaseTest, inferMultiWindowQuery) {
    ...
    x_DEBUG("win1={}", windows[0]->getOutputSchema()->toString());
    ...
    x_DEBUG("win2={}", windows[1]->getOutputSchema()->toString());
    ...
    SchemaPtr sinkOutputSchema = sinkOperator[0]->getOutputSchema();
    x_DEBUG("expected = {}", sinkOperator[0]->getOutputSchema()->toString());
...
TEST_F(TypeInferencePhaseTest, inferBatchJoinQueryManuallyInserted) {
    ...
    SchemaPtr sinkOutputSchema = sinkOperator[0]->getOutputSchema();
    x_DEBUG("inferred output schema = {}", sinkOperator[0]->getOutputSchema()->toString());
...
TEST_F(TypeInferencePhaseTest, testJoinOnFourSources) {
    ...
    x_DEBUG("expected src3= {}", sourceOperator[2]->getOutputSchema()->toString());
    ...
    x_DEBUG("expected join1= {}", joinOperators[0]->getOutputSchema()->toString());
    ...
    x_DEBUG("expected join2= {}", joinOperators[1]->getOutputSchema()->toString());
    ...
    x_DEBUG("expected join3= {}", joinOperators[2]->getOutputSchema()->toString());
    ...
    SchemaPtr sinkOutputSchema = sinkOperator[0]->getOutputSchema();
    x_DEBUG("expected sinkOutputSchema= {}", sinkOutputSchema->toString());
...
TEST_F(TypeInferencePhaseTest, inferTypeForQueryWithMapUDF) {
    ...
    x_DEBUG("expected = {}", actualSinkOperator[0]->getOutputSchema()->toString());
