...
class Z3SignatureBasedPartialQueryMergerBottomUpRuleTest : public Testing::BaseUnitTest {
  ...
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("Z3SignatureBasedPartialQueryMergerBottomUpRuleTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup Z3SignatureBasedPartialQueryMergerBottomUpRuleTest test case.");
    }
