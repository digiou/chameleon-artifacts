...
class HashSignatureBasedPartialQueryMergerRuleTest : public Testing::BaseUnitTest {
  ...
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("HashSignatureBasedPartialQueryMergerRuleTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup HashSignatureBasedPartialQueryMergerRuleTest test case.");
    }
    ...
    /* Will be called before a test is executed. */
    void TearDown() override { x_INFO("Setup HashSignatureBasedCompleteQueryMergerRuleTest test case."); }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down HashSignatureBasedCompleteQueryMergerRuleTest test class."); }
};
