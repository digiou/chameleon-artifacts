...
class HashSignatureBasedCompleteQueryMergerRuleTest : public Testing::BaseUnitTest {
  ...
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("HashSignatureBasedCompleteQueryMergerRuleTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup HashSignatureBasedCompleteQueryMergerRuleTest test case.");
    }
