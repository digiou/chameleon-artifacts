...
class Z3SignatureBasedCompleteQueryMergerRuleTest : public Testing::BaseUnitTest {
  ...
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("Z3SignatureBasedCompleteQueryMergerRuleTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup Z3SignatureBasedCompleteQueryMergerRuleTest test case.");
    }
