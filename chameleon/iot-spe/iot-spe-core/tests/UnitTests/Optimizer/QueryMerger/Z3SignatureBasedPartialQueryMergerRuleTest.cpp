...
class Z3SignatureBasedPartialQueryMergerRuleTest : public Testing::BaseUnitTest {
  ...
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("Z3SignatureBasedPartialQueryMergerRuleTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup Z3SignatureBasedPartialQueryMergerRuleTest test case.");
    }
...
TEST_F(Z3SignatureBasedPartialQueryMergerRuleTest, testMergingPartiallyEqualQueriesMoreThanTwoQueries) {
    ...
    x_INFO("Shared Plan After Merging with Query 3\n{}", updatedSharedQueryPlan1->toString());
...
TEST_F(Z3SignatureBasedPartialQueryMergerRuleTest, testMergingPartiallyEqualQueriesWithQueryStopChangeLog) {
    ...
    x_INFO("{}", updatedSharedPlanAfterStop->toString());
