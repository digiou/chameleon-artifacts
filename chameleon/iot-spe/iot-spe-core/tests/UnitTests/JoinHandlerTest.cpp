...
class JoinHandlerTest : public Testing::BaseUnitTest {
  public:
    static void SetUpTestCase() {
        x::Logger::setupLogging("JoinHandlerTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup JoinHandlerTest test class.");
    }
...
TEST_F(JoinHandlerTest, testJoinHandlerSlicing) {
    ...
    Join::LogicalJoinDefinitionPtr joinDef = Join::LogicalJoinDefinition::create(
        ...
        FieldAccessExpressionNode::create(DataTypeFactory::createInt64(), "key")->as<FieldAccessExpressionNode>(),
        Windowing::TumblingWindow::of(Windowing::TimeCharacteristic::createIngestionTime(), x::API::Milliseconds(10)),
        distrType,
        triggerPolicy,
        triggerAction,
        1,
