...
class NonKeyedSlidingWindowQueryExecutionTest
  ...
  public:
    static void SetUpTestCase() {
        x::Logger::setupLogging("NonKeyedTumblingWindowQueryExecutionTest.cpp.log", x::LogLevel::LOG_DEBUG);
        x_DEBUG("QueryExecutionTest: Setup NonKeyedTumblingWindowQueryExecutionTest.cpp test class.");
    }
    ...
    void TearDown() override {
        x_DEBUG("QueryExecutionTest: Tear down NonKeyedTumblingWindowQueryExecutionTest.cpp test case.");
    ...
    static void TearDownTestCase() {
        x_DEBUG("QueryExecutionTest: Tear down NonKeyedTumblingWindowQueryExecutionTest.cpp test class.");
    }
