...
class ThresholdWindowQueryExecutionTest
  ...
  public:
    static void SetUpTestCase() {
        x::Logger::setupLogging("ThresholdWindowQueryExecutionTest.log", x::LogLevel::LOG_DEBUG);
        x_DEBUG("QueryExecutionTest: Setup ThresholdWindowQueryExecutionTest test class.");
    }
    ...
    void TearDown() override {
        x_DEBUG("QueryExecutionTest: Tear down ThresholdWindowQueryExecutionTest test case.");
        ASSERT_TRUE(executionEngine->stop());
        Testing::BaseUnitTest::TearDown();
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_DEBUG("QueryExecutionTest: Tear down ThresholdWindowQueryExecutionTest test class."); }
...
void fillBuffer(Runtime::MemoryLayouts::DynamicTupleBuffer& buf) {
    for (int recordIndex = 0; recordIndex < 9; recordIndex++) {
        ...
        x_DEBUG("Input tuples: f1={} f2={}", recordIndex, recordIndex * 10);
    }
    ...
    x_DEBUG("Input tuples: f1={} f2={}", 0, 0);
}
