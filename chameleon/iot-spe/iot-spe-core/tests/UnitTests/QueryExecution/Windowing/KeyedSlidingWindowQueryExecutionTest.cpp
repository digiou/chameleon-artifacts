...
class KeyedSlidingWindowQueryExecutionTest
  ...
  public:
    static void SetUpTestCase() {
        x::Logger::setupLogging("KeyedSlidingWindowQueryExecutionTest.cpp.log", x::LogLevel::LOG_DEBUG);
        x_DEBUG("QueryExecutionTest: Setup KeyedSlidingWindowQueryExecutionTest.cpp test class.");
    }
    ...
    void TearDown() override {
        x_DEBUG("QueryExecutionTest: Tear down KeyedSlidingWindowQueryExecutionTest.cpp test case.");
    ...
    static void TearDownTestCase() {
        x_DEBUG("QueryExecutionTest: Tear down KeyedSlidingWindowQueryExecutionTest.cpp test class.");
    }
