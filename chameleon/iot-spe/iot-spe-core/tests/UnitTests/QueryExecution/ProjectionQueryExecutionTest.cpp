...
class ProjectionQueryExecutionTest : public Testing::BaseUnitTest,
  ...
  public:
    static void SetUpTestCase() {
        x::Logger::setupLogging("ProjectionQueryExecutionTest.log", x::LogLevel::LOG_DEBUG);
        x_DEBUG("QueryCatalogServiceTest: Setup QueryCatalogServiceTest test class.");
    }
    ...
    void TearDown() override {
        x_DEBUG("QueryCatalogServiceTest: Tear down QueryCatalogServiceTest test case.");
        ASSERT_TRUE(executionEngine->stop());
        Testing::BaseUnitTest::TearDown();
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_DEBUG("QueryCatalogServiceTest: Tear down QueryCatalogServiceTest test class."); }
