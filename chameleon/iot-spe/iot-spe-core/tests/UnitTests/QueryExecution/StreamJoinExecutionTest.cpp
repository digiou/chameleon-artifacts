...
constexpr auto queryCompilerDumpMode = x::QueryCompilation::QueryCompilerOptions::DumpMode::NONE;
...
class StreamJoinQueryExecutionTest : public Testing::BaseUnitTest,
  ...
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("StreamJoinQueryExecutionTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("QueryExecutionTest: Setup StreamJoinQueryExecutionTest test class.");
    }
    ...
    void SetUp() override {
        ...
        auto joinStrategy = x::Runtime::Execution::StreamJoinQueryExecutionTest::GetParam();
    ...
    void TearDown() override {
        x_INFO("QueryExecutionTest: Tear down StreamJoinQueryExecutionTest test case.");
    ...
    std::vector<ResultRecord> runQueryWithCsvFiles(const std::vector<std::pair<SchemaPtr, std::string>>& inputs,
        ...
        x_INFO("Submitting query: {}", query.getQueryPlan()->toString())
