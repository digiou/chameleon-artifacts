...
class MergeQueryExecutionTest : public Testing::BaseUnitTest,
  ...
  public:
    static void SetUpTestCase() {
        x::Logger::setupLogging("MergeQueryExecutionTest.log", x::LogLevel::LOG_DEBUG);
        x_DEBUG("QueryExecutionTest: Setup MergeQueryExecutionTest test class.");
    }
    ...
    void TearDown() override {
        x_DEBUG("QueryExecutionTest: Tear down MergeQueryExecutionTest test case.");
        ASSERT_TRUE(executionEngine->stop());
        Testing::BaseUnitTest::TearDown();
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_DEBUG("QueryExecutionTest: Tear down MergeQueryExecutionTest test class."); }
