...
class LimitQueryExecutionTest : public Testing::BaseUnitTest {
  public:
    static void SetUpTestCase() {
        x::Logger::setupLogging("LimitQueryExecutionTest.log", x::LogLevel::LOG_DEBUG);
        x_DEBUG("LimitQueryExecutionTest: Setup LimitQueryExecutionTest test class.");
    }
    ...
    void TearDown() override {
        x_DEBUG("LimitQueryExecutionTest: Tear down LimitQueryExecutionTest test case.");
        ASSERT_TRUE(executionEngine->stop());
        Testing::BaseUnitTest::TearDown();
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_DEBUG("LimitQueryExecutionTest: Tear down LimitQueryExecutionTest test class."); }
