...
class QueryCompilerTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("QueryCompilerTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup QueryCompilerTest test class.");
    }
    ...
    void cleanUpPlan(Runtime::Execution::ExecutableQueryPlanPtr plan) {
        ...
        auto task = Runtime::ReconfigurationMessage(plan->getQueryId(),
                                                    ...
                                                    x::Runtime::ReconfigurationType::SoftEndOfStream,
                                                    plan);
...
class CustomPipelixtageOne : public Runtime::Execution::ExecutablePipelixtage {
  public:
    ExecutionResult
...
TEST_F(QueryCompilerTest, externalOperatorTest) {
    ...
    auto customPipelixtage = std::make_shared<CustomPipelixtageOne>();
    auto externalOperator = PhysicalExternalOperator::create(SchemaPtr(), SchemaPtr(), customPipelixtage);
