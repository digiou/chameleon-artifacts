...
class QueryCatalogServiceTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("QueryCatalogServiceTest.log", x::LogLevel::LOG_DEBUG);
        x_DEBUG("Setup QueryCatalogServiceTest test class.");
    }
    ...
    void SetUp() override {
        ...
        x_DEBUG("Setup QueryCatalogServiceTest test case.");
