...
class SourceCatalogServiceTest : public Testing::BaseIntegrationTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("SourceCatalogServiceTest.log", x::LogLevel::LOG_DEBUG);
        x_DEBUG("Setup x SourceCatalogService test class.");
    }

    /* Will be called before a test is executed. */
    void SetUp() override {
        Testing::BaseIntegrationTest::SetUp();
        x_DEBUG("Setup x SourceCatalogService test case.");
