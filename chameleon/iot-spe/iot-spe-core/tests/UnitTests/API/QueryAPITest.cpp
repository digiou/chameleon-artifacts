...
class QueryAPITest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("QueryTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup QueryTest test class.");
    }
...
TEST_F(QueryAPITest, windowAggregationWithAs) {
    ...
    x_DEBUG("QueryExecutionTest:: WindowAggWithAs outputSchema: {}", outputSchemaString);
