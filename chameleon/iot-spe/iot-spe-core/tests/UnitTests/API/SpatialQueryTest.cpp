...
class SpatialQueryTest : public Testing::BaseUnitTest {
  protected:
    static void SetUpTestCase() {
        x::Logger::setupLogging("SpatialQueryTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup SpatialQueryTest test class.");
    }
};
