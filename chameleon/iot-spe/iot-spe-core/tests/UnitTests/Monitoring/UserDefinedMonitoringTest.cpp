...
class UserDefinedMonitoringTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("UserDefinedMonitoringTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("ResourcesReaderTest: Setup UserDefinedMonitoringTest test class.");
    }

    /* Will be called before a  test is executed. */
    void SetUp() override {
        Testing::BaseUnitTest::SetUp();
        x_DEBUG("UserDefinedMonitoringTest: Setup UserDefinedMonitoringTest test case.");
...
TEST_F(UserDefinedMonitoringTest, testRuntimeConcepts) {
    ...
    x_DEBUG("UserDefinedMonitoringTest: Json Concepts: {}", metricsJson);
}
