...
class MetricCollectorTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("MetricCollectorTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("ResourcesReaderTest: Setup MetricCollectorTest test class.");
    }

    /* Will be called before a  test is executed. */
    void SetUp() override {
        Testing::BaseUnitTest::SetUp();
        x_DEBUG("MetricCollectorTest: Setup MetricCollectorTest test case.");
...
TEST_F(MetricCollectorTest, testNetworkCollectorWrappedMetrics) {
    ...
    if (reader->getReaderType() != SystemResourcesReaderType::AbstractReader) {
        ...
        x_DEBUG("MetricCollectorTest: Skipping testNetworkCollectorWrappedMetrics. Abstract reader found.");
    }
}
...
TEST_F(MetricCollectorTest, testNetworkCollectorSingleMetrics) {
    ...
    if (reader->getReaderType() != SystemResourcesReaderType::AbstractReader) {
        ...
        x_DEBUG("MetricCollectorTest: Skipping testNetworkCollectorSingleMetrics. Abstract reader found.");
    }
}
...
TEST_F(MetricCollectorTest, testCpuCollectorWrappedMetrics) {
    ...
    if (reader->getReaderType() != SystemResourcesReaderType::AbstractReader) {
        ...
        x_DEBUG("MetricCollectorTest: Skipping testCpuCollectorWrappedMetrics. Abstract reader found.");
    }
}
...
TEST_F(MetricCollectorTest, testCpuCollectorSingleMetrics) {
    ...
    if (reader->getReaderType() != SystemResourcesReaderType::AbstractReader) {
        ...
        x_DEBUG("MetricCollectorTest: Skipping testcpuCollectorSingleMetrics. Abstract reader found.");
    }
}
