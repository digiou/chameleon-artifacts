...
class KeyedEventTimeWindowHandlerTest : public testing::Test {
  public:
    ...
    static void SetUpTestCase() { x_DEBUG("Setup KeyedEventTimeWindowHandlerTest test class."); }

    /* Will be called before a test is executed. */
    void SetUp() override {
        x::Logger::setupLogging("KeyedEventTimeWindowHandlerTest.log", x::LogLevel::LOG_DEBUG);
        x_DEBUG("Setup KeyedEventTimeWindowHandlerTest test case.");
        size_t keySize = 8;
        size_t valueSize = 8;
    ...
    /* Will be called before a test is executed. */
    void TearDown() override { x_DEBUG("Tear down KeyedEventTimeWindowHandlerTest test case."); }
