...
class WindowAssignerTest : public Testing::BaseUnitTest {
  public:
    /* Will be called before any test in this class are executed. */
    static void SetUpTestCase() {
        x::Logger::setupLogging("WindowAssignerTest.log", x::LogLevel::LOG_DEBUG);
        x_DEBUG("Setup WindowAssignerTest test class.");
    }
};
