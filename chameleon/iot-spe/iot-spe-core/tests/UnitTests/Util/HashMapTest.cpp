...
namespace x {
class HashMapTest : public Testing::BaseUnitTest {
  public:
    static void SetUpTestCase() {
        x::Logger::setupLogging("HashMapTest.log", x::LogLevel::LOG_DEBUG);

        x_INFO("HashMapTest test class SetUpTestCase.");
    }
    static void TearDownTestCase() { x_INFO("HashMapTest test class TearDownTestCase."); }
