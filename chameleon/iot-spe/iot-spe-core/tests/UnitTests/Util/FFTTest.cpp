...
public:
    static void SetUpTestCase() {
        x::Logger::setupLogging("FFTTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("FFTTest test class SetUpTestCase.");
    }
    static void TearDownTestCase() { x_INFO("FFTTest test class TearDownTestCase."); }
};
