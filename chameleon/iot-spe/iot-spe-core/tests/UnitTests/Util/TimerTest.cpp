...
class TimerTest : public Testing::BaseUnitTest {
  public:
    static void SetUpTestCase() {
        x::Logger::setupLogging("TimerTest.log", x::LogLevel::LOG_DEBUG);

        x_INFO("TimerTest test class SetUpTestCase.");
    }
    static void TearDownTestCase() { x_INFO("TimerTest test class TearDownTestCase."); }
};
