...
class TopologyIteratorTest : public Testing::BaseUnitTest {
  public:
    static void SetUpTestCase() {
        ...
        x::Logger::setupLogging("TopologyIteratorTest.log", x::LogLevel::LOG_DEBUG);
        x_DEBUG("Setup TopologyIteratorTest test class.");
    }
...
TEST_F(TopologyIteratorTest, testLinearTopology) {
    ...
    x_DEBUG("TopologyIteratorTest::testLinearTopology topology: {}", topology->toString());
