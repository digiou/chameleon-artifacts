...
class RowMemoryLayoutTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("RowMemoryLayoutTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup RowMemoryLayoutTest test class.");
    }
    void SetUp() override {
...
TEST_F(RowMemoryLayoutTest, rowLayoutLayoutFieldBoundaryCheck) {
    ...
    ASSERT_THROW((RowLayoutField<uint32_t, true>::create(3, rowLayout, tupleBuffer)), x::Exceptions::RuntimeException);
    ASSERT_THROW((RowLayoutField<uint32_t, true>::create(4, rowLayout, tupleBuffer)), x::Exceptions::RuntimeException);
    ASSERT_THROW((RowLayoutField<uint32_t, true>::create(5, rowLayout, tupleBuffer)), x::Exceptions::RuntimeException);
...
TEST_F(RowMemoryLayoutTest, getFieldViaFieldNameRowLayout) {
    ...
    ASSERT_THROW((RowLayoutField<uint32_t, true>::create("t4", rowLayout, tupleBuffer)), x::Exceptions::RuntimeException);
    ASSERT_THROW((RowLayoutField<uint32_t, true>::create("t5", rowLayout, tupleBuffer)), x::Exceptions::RuntimeException);
    ASSERT_THROW((RowLayoutField<uint32_t, true>::create("t6", rowLayout, tupleBuffer)), x::Exceptions::RuntimeException);
}
