...
class PapiProfilerTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("PapiProfilerTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("SetUpTestCase PapiProfilerTest test case.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("TearDownTestCase PapiProfilerTest test case."); }
};
