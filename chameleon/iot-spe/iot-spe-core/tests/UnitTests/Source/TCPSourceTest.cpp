...
class TCPSourceTest : public Testing::BaseIntegrationTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("TCPSourceTest.log", x::LogLevel::LOG_DEBUG);
        x_DEBUG("TCPSOURCETEST::SetUpTestCase()");
    }

    void SetUp() override {
        Testing::BaseIntegrationTest::SetUp();
        x_DEBUG("TCPSOURCETEST::SetUp() MQTTSourceTest cases set up.");
    ...
    void TearDown() override {
        ...
        x_DEBUG("TCPSOURCETEST::TearDown() Tear down TCPSOURCETEST");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_DEBUG("TCPSOURCETEST::TearDownTestCases() Tear down TCPSOURCETEST test class."); }
...
TEST_F(TCPSourceTest, TCPSourcePrint) {
    ...
    tcpSourceType->setClientId("x-mqtt-test-client");
