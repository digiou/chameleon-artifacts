...
class OPCSourceTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("OPCSourceTest.log", x::LogLevel::LOG_DEBUG);
        x_DEBUG("OPCSOURCETEST::SetUpTestCase()");
    }

    void SetUp() {
        x_DEBUG("OPCSOURCETEST::SetUp() OPCSourceTest cases set up.");
    ...
    void TearDown() {
        nodeEngine->stop();
        nodeEngine.reset();
        x_DEBUG("OPCSOURCETEST::TearDown() Tear down OPCSourceTest");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_DEBUG("OPCSOURCETEST::TearDownTestCases() Tear down OPCSourceTest test class."); }
...
TEST_F(OPCSourceTest, OPCSourceValue) {
    ...
    x_DEBUG("OPCSOURCETEST::TEST_F(OPCSourceTest, OPCSourceValue) expected value is: {}. Received value is: {}",
              expected,
              value);
