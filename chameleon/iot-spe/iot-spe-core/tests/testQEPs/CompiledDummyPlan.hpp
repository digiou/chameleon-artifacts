...
#ifndef x_TESTS_TEST_QEPS_COMPILED_DUMMY_PLAN_HPP_
#define x_TESTS_TEST_QEPS_COMPILED_DUMMY_PLAN_HPP_
...
class CompiledDummyPlan : public HandCodedQueryExecutionPlan {
  public:
    ...
    bool firstPipelixtage(const TupleBuffer&) { return false; }
...
#endif// x_TESTS_TEST_QEPS_COMPILED_DUMMY_PLAN_HPP_
