...
nlohmann::json LocationService::convertLocationToJson(x::Spatial::DataTypes::Experimental::GeoLocation geoLocation) {
...
bool LocationService::updatePredictedReconnect(
    const std::vector<x::Spatial::Mobility::Experimental::ReconnectPoint>& addPredictions,
    const std::vector<x::Spatial::Mobility::Experimental::ReconnectPoint>& removePredictions) {
    (void) addPredictions;
    (void) removePredictions;
    x_NOT_IMPLEMENTED();//Will be implemented as part of #
}
}// namespace x
