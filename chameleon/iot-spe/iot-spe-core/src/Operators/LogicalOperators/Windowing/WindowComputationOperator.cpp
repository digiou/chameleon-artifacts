...
bool WindowComputationOperator::inferSchema(Optimizer::TypeInferencePhaseContext& typeInferencePhaseContext) {
    ...
    x_DEBUG("WindowComputationOperator: TypeInferencePhase: infer types for window operator with input schema {}",
...
void WindowComputationOperator::inferStringSignature() { x_NOT_IMPLEMENTED(); }
}// namespace x