...
MaterializedViewSinkDescriptor::MaterializedViewSinkDescriptor(uint64_t viewId,
    ...
    x_ASSERT(this->viewId > 0, "invalid materialized view id");
}
...
std::string MaterializedViewSinkDescriptor::toString() const { return "MaterializedViewSinkDescriptor"; }
...
uint64_t MaterializedViewSinkDescriptor::getViewId() const { return viewId; }
}// namespace x::Experimental::MaterializedView