...
void RenameSourceOperatorNode::inferStringSignature() {
    ...
    x_TRACE("RenameSourceOperatorNode: Inferring String signature for {}", operatorNode->toString());
    x_ASSERT(!children.empty(), "RenameSourceOperatorNode: Rename Source should have children.");
