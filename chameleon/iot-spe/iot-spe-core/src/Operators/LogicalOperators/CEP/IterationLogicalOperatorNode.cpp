...
void IterationLogicalOperatorNode::inferStringSignature() {
    ...
    x_TRACE("IterationLogicalOperatorNode: Inferring String signature for {}", operatorNode->toString());
    x_ASSERT(!children.empty(), "IterationLogicalOperatorNode: Iteration should have children.");
