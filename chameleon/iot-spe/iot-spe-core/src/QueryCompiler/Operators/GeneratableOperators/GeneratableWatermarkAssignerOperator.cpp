...
void GeneratableWatermarkAssignmentOperator::generateExecute(CodeGeneratorPtr codegen, PipelineContextPtr context) {
    if (auto eventTimeWatermarkStrategyDescriptor =
        ...
        if (!keyExpression->instanceOf<FieldAccessExpressionNode>()) {
            x_ERROR("GeneratableWatermarkAssignerOperator: watermark field has to be an FieldAccessExpression but it was a {}",
        ...
        x_ERROR("GeneratableWatermarkAssignerOperator: cannot create watermark strategy from descriptor");
    }
}
