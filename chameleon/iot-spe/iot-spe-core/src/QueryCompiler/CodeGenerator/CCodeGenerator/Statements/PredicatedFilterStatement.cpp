...
CodeExpressionPtr PredicatedFilterStatement::getCode() const {
    ...
    x_ASSERT(!predicateEvaluationGenerated.empty(),
               "PredicatedFilterstatement: predicateEvaluation did not generate valid code.");
    x_ASSERT(!predicatedCodeGenerated.empty(), "PredicatedFilterstatement: predicatedCode did not generate valid code.");
