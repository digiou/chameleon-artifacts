...
LegacyExpressionPtr TranslateToLegacyExpression::transformExpression(const ExpressionNodePtr& expression) {
    ...
    if (expression->instanceOf<ArithmeticalExpressionNode>()) {
        ...
        x_DEBUG("TranslateToLegacyPhase: Translate FieldAccessExpressionNode:  {}", expression->toString());
        ...
        x_DEBUG("TranslateToLegacyPhase: Translate WhenExpressionNode:  {}", whenExpression->toString());
        ...
        x_DEBUG("TranslateToLegacyPhase: Translate CaseExpressionNode:  {}", caseExpressionNode->toString());
    ...
    x_FATAL_ERROR("TranslateToLegacyPhase: No transformation implemented for this expression node: {}", expression->toString());
    x_NOT_IMPLEMENTED();
    ;
}
...
LegacyExpressionPtr TranslateToLegacyExpression::transformArithmeticalExpressions(const ExpressionNodePtr& expression) {
    ...
    x_FATAL_ERROR("TranslateToLegacyPhase: No transformation implemented for this arithmetical expression node: {}",
                    expression->toString());
    x_NOT_IMPLEMENTED();
}
...
LegacyExpressionPtr TranslateToLegacyExpression::transformLogicalExpressions(const ExpressionNodePtr& expression) {
    ...
    if (expression->instanceOf<OrExpressionNode>()) {
        ...
        x_FATAL_ERROR("TranslateToLegacyPhase: Unary expressions not supported in "
                        "legacy expressions: {}",
                        expression->toString());
        x_NOT_IMPLEMENTED();
    }
    x_FATAL_ERROR("TranslateToLegacyPhase: No transformation implemented for this "
