...
QueryCompilerOptionsPtr QueryCompilerOptions::createDefaultOptions() {
    ...
    hashOptions->setNumberOfPartitions(x::Runtime::Execution::DEFAULT_HASH_NUM_PARTITIONS);
    hashOptions->setPageSize(x::Runtime::Execution::DEFAULT_HASH_PAGE_SIZE);
    hashOptions->setPreAllocPageCnt(x::Runtime::Execution::DEFAULT_HASH_PREALLOC_PAGE_COUNT);
    hashOptions->setTotalSizeForDataStructures(x::Runtime::Execution::DEFAULT_HASH_TOTAL_HASH_TABLE_SIZE);
    options.setStreamJoinStratgy(QueryCompilation::StreamJoinStrategy::xTED_LOOP_JOIN);
...
void QueryCompilerOptions::setQueryCompiler(x::QueryCompilation::QueryCompilerOptions::QueryCompiler queryCompiler) {
