...
SerializableShapeType* ShapeTypeSerializationUtil::serializeShapeType(const ShapeExpressionNodePtr& shape,
    ...
    if (shapeType == ShapeType::Circle) {
        ...
        x_THROW_RUNTIME_ERROR("ShapeTypeSerializationUtil: serialization is not possible for " + shape->toString());
    }
    x_TRACE("ShapeTypeSerializationUtil:: serialized {} to {}", shape->toString(), serializedShape->SerializeAsString());
    return serializedShape;
}

ShapeExpressionNodePtr ShapeTypeSerializationUtil::deserializeShapeType(SerializableShapeType* serializedShapeType) {
    x_TRACE("ShapeTypeSerializationUtil:: de-serialized {}", serializedShapeType->DebugString());
    ...
    x_THROW_RUNTIME_ERROR("ShapeTypeSerializationUtil: shape type which is to be serialized not registered. "
