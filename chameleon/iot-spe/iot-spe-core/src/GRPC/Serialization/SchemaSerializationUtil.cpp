...
SerializableSchemaPtr SchemaSerializationUtil::serializeSchema(const SchemaPtr& schema, SerializableSchema* serializedSchema) {
    x_DEBUG("SchemaSerializationUtil:: serialize schema {}", schema->toString());
    ...
    if (schema->getLayoutType() == Schema::MemoryLayoutType::ROW_LAYOUT) {
        ...
        x_DEBUG("SchemaSerializationUtil:: serialize schema Row Layout");
    } else if (schema->getLayoutType() == Schema::MemoryLayoutType::COLUMNAR_LAYOUT) {
        serializedSchema->set_layouttype(SerializableSchema_MemoryLayoutType_COL_LAYOUT);
        x_DEBUG("SchemaSerializationUtil:: serialize schema Column Layout");
    }
...
SchemaPtr SchemaSerializationUtil::deserializeSchema(const SerializableSchema& serializedSchema) {
    ...
    x_DEBUG("SchemaSerializationUtil:: deserialize schema ");
    ...
    switch (serializedSchema.layouttype()) {
        case SerializableSchema_MemoryLayoutType_ROW_LAYOUT: {
            ...
            x_DEBUG("SchemaSerializationUtil:: deserialized row Layout");
            break;
        };
        case SerializableSchema_MemoryLayoutType_COL_LAYOUT: {
            ...
            x_DEBUG("SchemaSerializationUtil:: deserialized columnar Layout");
            break;
        }
        default: {
            x_ERROR("SchemaSerializationUtil:: Wrong memory layout in serialization format");
        }
    }
