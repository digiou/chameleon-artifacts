...
SerializableDataType* DataTypeSerializationUtil::serializeDataType(const DataTypePtr& dataType,
    ...
    if (dataType->isUndefined()) {
        ...
        x_THROW_RUNTIME_ERROR("DataTypeSerializationUtil: serialization is not possible for " + dataType->toString());
    }
    x_TRACE("DataTypeSerializationUtil:: serialized {} to {}", dataType->toString(), serializedDataType->SerializeAsString());
...
DataTypePtr DataTypeSerializationUtil::deserializeDataType(const SerializableDataType& serializedDataType) {
    x_TRACE("DataTypeSerializationUtil:: de-serialized {}", serializedDataType.DebugString());
    ...
    x_THROW_RUNTIME_ERROR("DataTypeSerializationUtil: data type which is to be serialized not registered. "
...
SerializableDataValue* DataTypeSerializationUtil::serializeDataValue(const ValueTypePtr& valueType,
    ...
    x_TRACE("DataTypeSerializationUtil:: serialized {} as {} ", valueType->toString(), serializedDataValue->DebugString());
...
ValueTypePtr DataTypeSerializationUtil::deserializeDataValue(const SerializableDataValue& serializedDataValue) {
    ...
    x_TRACE("DataTypeSerializationUtil:: de-serialized {}", serializedDataValue.DebugString());
