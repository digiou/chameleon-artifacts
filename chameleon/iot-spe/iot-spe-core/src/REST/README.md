...
The IoTSPE REST API is versioned, with specific versions being queryable by prefixing the url with the version prefix. 
...
### Getting IoTSPE Topology graph

To get the IoTSPE topology graph as JSON.

**API**: /query/x-topology\
**Verb**: GET\
**Response Code**: 200 OK
...
To get all queryIdAndCatalogEntryMapping registered at IoTSPE.
...
To get all queryIdAndCatalogEntryMapping with a specific status form IoTSPE.
