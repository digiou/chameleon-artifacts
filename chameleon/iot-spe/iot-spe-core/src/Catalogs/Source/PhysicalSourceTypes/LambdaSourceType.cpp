...
LambdaSourceType::LambdaSourceType(std::function<void(x::Runtime::TupleBuffer&, uint64_t)>&& generationFunction,
...
std::function<void(x::Runtime::TupleBuffer&, uint64_t)> LambdaSourceType::getGenerationFunction() const {
