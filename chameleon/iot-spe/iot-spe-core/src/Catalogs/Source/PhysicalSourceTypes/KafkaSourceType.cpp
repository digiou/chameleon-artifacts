...
KafkaSourceType::KafkaSourceType(std::map<std::string, std::string> sourceConfigMap) : KafkaSourceType() {
    x_INFO("KafkaSourceType: Init default Kafka source config object with values from command line args.");
    ...
    if (sourceConfigMap.find(Configurations::BROKERS_CONFIG) != sourceConfigMap.end()) {
        ...
        x_THROW_RUNTIME_ERROR("KafkaSourceConfig:: no brokers defined! Please define brokers.");
    }
    ...
    if (sourceConfigMap.find(Configurations::GROUP_ID_CONFIG) != sourceConfigMap.end()) {
        ...
        x_THROW_RUNTIME_ERROR("KafkaSourceConfig:: no groupId defined! Please define groupId.");
    }
    if (sourceConfigMap.find(Configurations::TOPIC_CONFIG) != sourceConfigMap.end()) {
        ...
        x_THROW_RUNTIME_ERROR("KafkaSourceConfig:: no topic defined! Please define topic.");
    }
    if (sourceConfigMap.find(Configurations::OFFSET_MODE_CONFIG) != sourceConfigMap.end()) {
        ...
        x_THROW_RUNTIME_ERROR("KafkaSourceConfig:: no offset defined! Please define offset.");
    }
...
KafkaSourceType::KafkaSourceType(Yaml::Node yamlConfig) : KafkaSourceType() {
    x_INFO("KafkaSourceType: Init default KAFKA source config object with values from YAML file.");
    ...
    if (!yamlConfig[Configurations::BROKERS_CONFIG].As<std::string>().empty()
        ...
        x_THROW_RUNTIME_ERROR("KafkaSourceType:: no brokers defined! Please define brokers.");
    }
    ...
    if (!yamlConfig[Configurations::GROUP_ID_CONFIG].As<std::string>().empty()
        ...
        x_THROW_RUNTIME_ERROR("KafkaSourceType:: no groupId defined! Please define groupId.");
    }
    if (!yamlConfig[Configurations::TOPIC_CONFIG].As<std::string>().empty()
        ...
        x_THROW_RUNTIME_ERROR("KafkaSourceType:: no topic defined! Please define topic.");
    }
    if (!yamlConfig[Configurations::OFFSET_MODE_CONFIG].As<std::string>().empty()
        ...
        x_THROW_RUNTIME_ERROR("KafkaSourceType:: no offset defined! Please define offset.");
    }
...
KafkaSourceType::KafkaSourceType()
    : PhysicalSourceType(SourceType::KAFKA_SOURCE),
      ...
      inputFormat(Configurations::ConfigurationOption<Configurations::InputFormat>::create(Configurations::INPUT_FORMAT_CONFIG,
                                                                                           ...
                                                                                           "input data format")) {
    x_INFO("KafkaSourceType: Init source config object with default values.");
}
