...
ArrowSourceType::ArrowSourceType()
    ...
    x_INFO("ArrowSourceTypeConfig: Init source config object with default values.");
}

ArrowSourceType::ArrowSourceType(std::map<std::string, std::string> sourceConfigMap) : ArrowSourceType() {
    x_INFO("ArrowSourceType: Init default Arrow source config object with values from command line.");
    if (sourceConfigMap.find(Configurations::FILE_PATH_CONFIG) != sourceConfigMap.end()) {
        ...
        x_THROW_RUNTIME_ERROR("ArrowSourceType:: no filePath defined! Please define a filePath using "
...
ArrowSourceType::ArrowSourceType(Yaml::Node yamlConfig) : ArrowSourceType() {
    x_INFO("ArrowSourceType: Init default Arrow source config object with values from YAML file.");
