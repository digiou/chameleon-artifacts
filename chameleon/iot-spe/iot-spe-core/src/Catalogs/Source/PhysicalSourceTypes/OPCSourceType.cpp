...
OPCSourceType::OPCSourceType(std::map<std::string, std::string> sourceConfigMap) : OPCSourceType() {
    x_INFO("OPCSourceType: Init default OPC source config object with values from command line args.");
    ...
    if (sourceConfigMap.find(Configurations::NAME_SPACE_INDEX_CONFIG) != sourceConfigMap.end()) {
        ...
        x_THROW_RUNTIME_ERROR("OPCSourceConfig:: no nodeIdentifier defined! Please define a nodeIdentifier.");
    }
    if (sourceConfigMap.find(Configurations::USER_NAME_CONFIG) != sourceConfigMap.end()) {
        ...
        x_THROW_RUNTIME_ERROR("OPCSourceConfig:: no userName defined! Please define a userName.");
    }
...
OPCSourceType::OPCSourceType(Yaml::Node yamlConfig) : OPCSourceType() {
    x_INFO("OPCSourceType: Init default OPC source config object with values from YAML file.");
    ...
    if (!yamlConfig[Configurations::NODE_IDENTIFIER_CONFIG].As<std::string>().empty()
        ...
        x_THROW_RUNTIME_ERROR("OPCSourceType:: no nodeIdentifier defined! Please define a nodeIdentifier.");
    }
    if (!yamlConfig[Configurations::USER_NAME_CONFIG].As<std::string>().empty()
        ...
        x_THROW_RUNTIME_ERROR("OPCSourceType:: no userName defined! Please define a userName.");
    }
...
OPCSourceType::OPCSourceType()
    ...
    x_INFO("OPCSourceType: Init source config object with default values.");
}
