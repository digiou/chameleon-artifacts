...
I2CBus::I2CBus(const char* filename) : GenericBus(filename, BusType::I2C) { x_INFO("I2CBus: Creating bus"); }

I2CBus::~I2CBus() { x_DEBUG("I2CBus: Destroying bus"); }
