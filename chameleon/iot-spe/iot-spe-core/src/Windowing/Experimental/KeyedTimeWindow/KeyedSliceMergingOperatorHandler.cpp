...
void KeyedSliceMergingOperatorHandler::start(Runtime::Execution::PipelineExecutionContextPtr,
                                             ...
                                             uint32_t) {
    x_DEBUG("start KeyedSliceMergingOperatorHandler");
    activeCounter++;
}

void KeyedSliceMergingOperatorHandler::stop(Runtime::QueryTerminationType queryTerminationType,
                                            Runtime::Execution::PipelineExecutionContextPtr) {
    x_DEBUG("stop KeyedSliceMergingOperatorHandler: {}", queryTerminationType);
}
...
KeyedSliceMergingOperatorHandler::~KeyedSliceMergingOperatorHandler() { x_DEBUG("Destruct SliceStagingWindowHandler"); }
