...
AddTopologyLinkRequestPtr AddTopologyLinkRequest::create(x::TopologyNodeId upstreamNodeId,
...
AddTopologyLinkRequest::AddTopologyLinkRequest(x::TopologyNodeId upstreamNodeId, x::TopologyNodeId downstreamNodeId)
