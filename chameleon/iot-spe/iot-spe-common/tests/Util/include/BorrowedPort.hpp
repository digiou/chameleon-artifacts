...
*/
#ifndef x_x_COMMON_TESTS_UTIL_BORROWEDPORT_HPP_
#define x_x_COMMON_TESTS_UTIL_BORROWEDPORT_HPP_
#include <cstdint>
namespace x::Testing {
...
/**
 * @brief A borrowed port from the port pool of x test base class.
...
#endif//x_x_COMMON_TESTS_UTIL_BORROWEDPORT_HPP_
