...
*/
#ifndef x_COMMON_INCLUDE_EXCEPTIONS_SIGNALHANDLING_HPP_
#define x_COMMON_INCLUDE_EXCEPTIONS_SIGNALHANDLING_HPP_
#include <exception>
#include <memory>
...
#endif// x_COMMON_INCLUDE_EXCEPTIONS_SIGNALHANDLING_HPP_
