...
*/
#ifndef x_COMMON_INCLUDE_EXCEPTIONS_ERRORLISTENER_HPP_
#define x_COMMON_INCLUDE_EXCEPTIONS_ERRORLISTENER_HPP_
...
#endif// x_COMMON_INCLUDE_EXCEPTIONS_ERRORLISTENER_HPP_
