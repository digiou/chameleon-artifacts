...
#ifndef x_COMMON_INCLUDE_UTIL_STDINT_HPP_
#define x_COMMON_INCLUDE_UTIL_STDINT_HPP_
#include <cstdint>
 ...
 */
constexpr uint8_t operator"" _u8(unsigned long long value) { return static_cast<uint8_t>(value); }
constexpr uint16_t operator"" _u16(unsigned long long value) { return static_cast<uint16_t>(value); }
constexpr uint32_t operator"" _u32(unsigned long long value) { return static_cast<uint32_t>(value); }
constexpr uint64_t operator"" _u64(unsigned long long value) { return static_cast<uint64_t>(value); }
 ...
 */
constexpr HelperStructLiterals<int8_t> operator"" _s8(unsigned long long value) { return HelperStructLiterals<int8_t>(value); }
...
#endif// x_COMMON_INCLUDE_UTIL_STDINT_HPP_
