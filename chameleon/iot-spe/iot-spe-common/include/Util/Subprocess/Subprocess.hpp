...
#ifndef x_COMMON_INCLUDE_UTIL_SUBPROCESS_SUBPROCESS_HPP_
#define x_COMMON_INCLUDE_UTIL_SUBPROCESS_SUBPROCESS_HPP_
#include <atomic>
#include <cstdio>
#include <iostream>
#include <thread>
...
#endif// x_COMMON_INCLUDE_UTIL_SUBPROCESS_SUBPROCESS_HPP_
