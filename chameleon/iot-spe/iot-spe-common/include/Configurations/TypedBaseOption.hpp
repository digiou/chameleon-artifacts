...
*/
#ifndef x_COMMON_INCLUDE_CONFIGURATIONS_TYPEDBASEOPTION_HPP_
#define x_COMMON_INCLUDE_CONFIGURATIONS_TYPEDBASEOPTION_HPP_
...
class TypedBaseOption : public BaseOption {
  public:
     ...
     * This is required to create xted options, e.g., a IntOption  that is part of a sequence.
     */
    TypedBaseOption();
...
#endif// x_COMMON_INCLUDE_CONFIGURATIONS_TYPEDBASEOPTION_HPP_
