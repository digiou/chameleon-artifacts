...
*/
#ifndef x_COMMON_INCLUDE_CONFIGURATIONS_SCALAROPTION_HPP_
#define x_COMMON_INCLUDE_CONFIGURATIONS_SCALAROPTION_HPP_
...
#endif// x_COMMON_INCLUDE_CONFIGURATIONS_SCALAROPTION_HPP_
