...
*/
#ifndef x_COMMON_INCLUDE_CONFIGURATIONS_BASEOPTION_HPP_
#define x_COMMON_INCLUDE_CONFIGURATIONS_BASEOPTION_HPP_
...
class BaseOption {
  ...
  protected:
     ...
     * If this option is xted it uses the identifier to lookup the particular children option.
     * @param identifier of the children option if the option is xted.
...
#endif// x_COMMON_INCLUDE_CONFIGURATIONS_BASEOPTION_HPP_
