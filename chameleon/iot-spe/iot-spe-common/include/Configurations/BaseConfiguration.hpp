...
#ifndef x_COMMON_INCLUDE_CONFIGURATIONS_BASECONFIGURATION_HPP_
#define x_COMMON_INCLUDE_CONFIGURATIONS_BASECONFIGURATION_HPP_
...
class BaseConfiguration : public BaseOption {
  public:
    ...
    /**
     * @brief Constructor for a xted configuration, which declares a specific name and description.
     * This is required for all xted configurations.
...
#endif// x_COMMON_INCLUDE_CONFIGURATIONS_BASECONFIGURATION_HPP_
