...
*/
#ifndef x_COMMON_INCLUDE_CONFIGURATIONS_SEQUENCEOPTION_HPP_
#define x_COMMON_INCLUDE_CONFIGURATIONS_SEQUENCEOPTION_HPP_
...
#endif// x_COMMON_INCLUDE_CONFIGURATIONS_SEQUENCEOPTION_HPP_
