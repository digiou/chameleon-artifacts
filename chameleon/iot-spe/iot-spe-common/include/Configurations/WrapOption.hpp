...
*/
#ifndef x_COMMON_INCLUDE_CONFIGURATIONS_WRAPOPTION_HPP_
#define x_COMMON_INCLUDE_CONFIGURATIONS_WRAPOPTION_HPP_
...
#endif// x_COMMON_INCLUDE_CONFIGURATIONS_WRAPOPTION_HPP_
