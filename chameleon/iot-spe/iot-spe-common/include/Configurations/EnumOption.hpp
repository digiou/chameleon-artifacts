...
*/
#ifndef x_COMMON_INCLUDE_CONFIGURATIONS_ENUMOPTION_HPP_
#define x_COMMON_INCLUDE_CONFIGURATIONS_ENUMOPTION_HPP_
...
/**
 * @brief This class defix an option, which has only the member of an enum as possible values.
 * @tparam EnumType
 */
...
#endif// x_COMMON_INCLUDE_CONFIGURATIONS_ENUMOPTION_HPP_
