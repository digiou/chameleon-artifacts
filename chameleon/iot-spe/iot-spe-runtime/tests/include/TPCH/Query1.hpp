...
*/
#ifndef x_x_RUNTIME_TESTS_INCLUDE_TPCH_Query1_HPP_
#define x_x_RUNTIME_TESTS_INCLUDE_TPCH_Query1_HPP_
...
class TPCH_Query1 {
  public:
    static PipelinePlan getPipelinePlan(std::unordered_map<TPCHTable, std::unique_ptr<x::Runtime::Table>>& tables,
     ...
     */
        ...
        auto l_lixtatusFiled = std::make_shared<ReadFieldExpression>("l_lixtatus");
        ...
        std::vector<Expressions::ExpressionPtr> keyFields = {l_returnflagField, l_lixtatusFiled};
...
#endif//x_x_RUNTIME_TESTS_INCLUDE_TPCH_Query1_HPP_
