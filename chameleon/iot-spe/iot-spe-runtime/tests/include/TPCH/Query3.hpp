...
*/
#ifndef x_x_RUNTIME_TESTS_INCLUDE_TPCH_Query3_HPP_
#define x_x_RUNTIME_TESTS_INCLUDE_TPCH_Query3_HPP_
...
class TPCH_Query3 {
  public:
    ...
    createPipeline1(PipelinePlan& plan, std::unordered_map<TPCHTable, std::unique_ptr<x::Runtime::Table>>& tables) {
...
#endif//x_x_RUNTIME_TESTS_INCLUDE_TPCH_Query3_HPP_
