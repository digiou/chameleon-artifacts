...
class TextTypeTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("TextTypeTest.log", x::LogLevel::LOG_DEBUG);
        x_DEBUG("Setup TextTypeTest test class.");
    }
    ...
    void SetUp() override {
        ...
        x_DEBUG("Setup TextTypeTest test case.")
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_DEBUG("Tear down TextTypeTest test class."); }
...
TEST_F(TextTypeTest, positionTest) {
    auto positionTest1 = Value<Text>("IoTSPE");
    auto positionTest2 = Value<Text>("NIoTSPE");
...
TEST_F(TextTypeTest, extractStringValueFromTupleBuffer) {
    ...
    *tupleBuffer.getBuffer<uint32_t>() = std::strlen(buf) + 1;
    ...
    auto textValue = x::Nautilus::TextValue::create(tupleBuffer, 5_u32);
    ...
    x_DEBUG("expected = {}, actual = {}", expected, actual);
