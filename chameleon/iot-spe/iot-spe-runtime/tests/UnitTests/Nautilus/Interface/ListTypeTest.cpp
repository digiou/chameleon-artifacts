...
class ListTypeTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("ListTypeTest.log", x::LogLevel::LOG_DEBUG);
        x_DEBUG("Setup ListTypeTest test class.");
    }
    ...
    void SetUp() override {
        ...
        x_DEBUG("Setup ListTypeTest test case.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_DEBUG("Tear down ListTypeTest test class."); }
