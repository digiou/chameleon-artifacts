...
class ChainedHashMapTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("HashTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup HashTest test class.");
    }
    void SetUp() override {
    ...
    static void TearDownTestCase() { x_INFO("Tear down HashTest test class."); }
};
...
TEST_F(ChainedHashMapTest, insertEntryTableTest) {
    ...
    x_INFO("Hash: {}", hash.getValue().toString());
