...
class Fixed2DArrayTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("FixedArrayTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup FixedArrayTest test class.");
    }
    void SetUp() override { Testing::BaseUnitTest::SetUp(); }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down FixedArrayTest test class."); }
};
