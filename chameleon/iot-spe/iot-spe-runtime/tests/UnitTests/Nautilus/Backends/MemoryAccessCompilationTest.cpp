...
class MemoryAccessCompilationTest : public Testing::BaseUnitTest, public AbstractCompilationBackendTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("MemoryAccessCompilationTest.log", x::LogLevel::LOG_DEBUG);
        x_DEBUG("Setup MemoryAccessCompilationTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_DEBUG("Tear down MemoryAccessCompilationTest test class."); }
};
