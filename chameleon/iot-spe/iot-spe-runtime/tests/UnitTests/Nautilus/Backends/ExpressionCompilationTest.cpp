...
class ExpressionExecutionTest : public Testing::BaseUnitTest, public AbstractCompilationBackendTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("ExpressionExecutionTest.log", x::LogLevel::LOG_DEBUG);
        x_DEBUG("Setup ExpressionExecutionTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down ExpressionExecutionTest test class."); }
};
