...
class TypeCompilationTest : public Testing::BaseUnitTest, public AbstractCompilationBackendTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("TypeCompilationTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup TypeCompilationTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down TypeCompilationTest test class."); }
...
TEST_P(TypeCompilationTest, compileListLengthFunctionTest) {
    ...
    listRef.value->ref = Nautilus::Tracing::ValueRef(INT32_MAX, 0, x::Nautilus::IR::Types::StampFactory::createAddressStamp());
