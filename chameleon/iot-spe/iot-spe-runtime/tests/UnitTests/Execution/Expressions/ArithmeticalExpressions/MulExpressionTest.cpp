...
class MulExpressionTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("MulExpressionTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup MulExpressionTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down MulExpressionTest test class."); }
};
