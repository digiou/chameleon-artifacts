...
class DivExpressionTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("DivExpressionTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup DivExpressionTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down DivExpressionTest test class."); }
};
