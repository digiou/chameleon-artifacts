...
class MatchingRegexTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("MatchingRegexTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup MatchingRegexTest test class.");
    }
    ...
    void SetUp() override {
        ...
        x_DEBUG("Setup MatchingRegexTest test case.")
    }
    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down MatchingRegexTest test class."); }
