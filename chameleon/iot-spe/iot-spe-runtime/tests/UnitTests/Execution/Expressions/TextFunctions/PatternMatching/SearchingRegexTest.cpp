...
class SearchingRegexTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("SearchingRegexTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup SearchingRegexTest test class.");
    }
    ...
    void SetUp() override {
        ...
        x_DEBUG("Setup SearchingRegexTest test case.")
    }
    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down SearchingRegexTest test class."); }
