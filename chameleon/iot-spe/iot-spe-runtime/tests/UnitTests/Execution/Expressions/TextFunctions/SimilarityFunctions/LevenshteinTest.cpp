...
class LevenshteinTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("LevenshteinTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup LevenshteinTest test class.");
    }
    ...
    void SetUp() override {
        ...
        x_DEBUG("Setup LevenshteinTest test case.")
    }
    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down LevenshteinTest class."); }
