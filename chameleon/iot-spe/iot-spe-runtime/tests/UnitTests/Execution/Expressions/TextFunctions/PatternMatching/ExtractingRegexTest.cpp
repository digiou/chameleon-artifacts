...
class ExtractingRegexTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("ExtractingRegexTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup ExtractingRegexTest test class.");
    }
    ...
    void SetUp() override {
        ...
        x_DEBUG("Setup ExtractingRegexTest test case.")
    }
    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down ExtractingRegexTest test class."); }
...
TEST_F(ExtractingRegexTest, evaluateExtractingRegex1) {
    ...
    // Simple Replace
    {
        ...
        x_DEBUG("{}", resultValue.as<Text>()->toString());
