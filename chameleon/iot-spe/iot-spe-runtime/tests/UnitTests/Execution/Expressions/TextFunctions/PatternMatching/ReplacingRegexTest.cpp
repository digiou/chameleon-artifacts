...
class ReplacingRegexTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("ReplacingRegexTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup ReplacingRegexTest test class.");
    }
    ...
    void SetUp() override {
        ...
        x_DEBUG("Setup ReplacingRegexTest test case.")
    }
    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down ReplacingRegexTest test class."); }
