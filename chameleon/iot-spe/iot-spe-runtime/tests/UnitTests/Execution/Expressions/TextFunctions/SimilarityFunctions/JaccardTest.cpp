...
class JaccardTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("JaccardTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup JaccardTest test class.");
    }
    ...
    void SetUp() override {
        ...
        x_DEBUG("Setup JaccardTest test case.")
    }
    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down JaccardTest class."); }
