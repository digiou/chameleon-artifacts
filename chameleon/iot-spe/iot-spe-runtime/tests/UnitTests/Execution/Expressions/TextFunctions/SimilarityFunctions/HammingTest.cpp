...
class HammingTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("HammingTestTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup HammingTestTest test class.");
    }
    ...
    void SetUp() override {
        ...
        x_DEBUG("Setup HammingTestTest test case.")
    }
    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down HammingTestTest class."); }
