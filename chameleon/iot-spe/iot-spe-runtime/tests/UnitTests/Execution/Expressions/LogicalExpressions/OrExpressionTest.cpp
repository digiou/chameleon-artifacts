...
class OrExpressionTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("OrExpressionTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup OrExpressionTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down OrExpressionTest test class."); }
};
