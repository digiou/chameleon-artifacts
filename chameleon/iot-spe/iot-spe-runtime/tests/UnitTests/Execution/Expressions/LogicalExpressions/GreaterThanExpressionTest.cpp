...
class GreaterThanExpressionTest : public Testing::BaseUnitTest {
  public:
    /* Will be called before any test in this class are executed. */
    static void SetUpTestCase() {
        x::Logger::setupLogging("GreaterThanExpressionTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup GreaterThanExpressionTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down GreaterThanExpressionTest test class."); }
};

TEST_F(GreaterThanExpressionTest, signedIntegers) {
    auto expression = BinaryExpressionWrapper<GreaterThanExpression>();
...
TEST_F(GreaterThanExpressionTest, UnsignedIntegers) {
    auto expression = BinaryExpressionWrapper<GreaterThanExpression>();
...
TEST_F(GreaterThanExpressionTest, FloatingPoints) {
    auto expression = BinaryExpressionWrapper<GreaterThanExpression>();
