...
class NegateExpressionTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("NegateExpressionTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup NegateExpressionTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down NegateExpressionTest test class."); }
};
