...
class EqualsExpressionTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("EqualsExpressionTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup EqualsExpressionTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down EqualsExpressionTest test class."); }
};
