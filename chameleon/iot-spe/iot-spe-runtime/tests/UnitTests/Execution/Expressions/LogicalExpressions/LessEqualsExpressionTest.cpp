...
class LessEqualsExpressionTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("LessEqualsExpressionTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup LessEqualsExpressionTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down LessEqualsExpressionTest test class."); }
};
