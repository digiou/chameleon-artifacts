...
class LessThanExpressionTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("LessThanExpressionTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup LessThanExpressionTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down LessThanExpressionTest test class."); }
};
...
TEST_F(LessThanExpressionTest, UnsignedIntegers) {
    auto expression = BinaryExpressionWrapper<LessThanExpression>();
