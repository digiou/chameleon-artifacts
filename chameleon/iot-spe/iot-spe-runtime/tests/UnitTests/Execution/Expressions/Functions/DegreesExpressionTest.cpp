...
class DegreesExpressionTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("DegreesExpressionTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup DegreesExpressionTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down DegreesExpressionTest test class."); }
};
