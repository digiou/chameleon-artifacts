...
class CeilExpressionTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("CeilExpressionTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup CeilExpressionTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down CeilExpressionTest test class."); }
};
