...
class MaxExpressionTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("MaxExpressionTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup MaxExpressionTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down MaxExpressionTest test class."); }
};
