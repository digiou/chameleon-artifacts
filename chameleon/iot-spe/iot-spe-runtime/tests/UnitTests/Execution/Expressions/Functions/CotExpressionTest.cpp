...
class CotExpressionTest : public Testing::BaseUnitTest {
  ...
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("CotExpressionTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup CotExpressionTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down CotExpressionTest test class."); }
};
