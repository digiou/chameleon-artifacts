...
class ExpExpressionTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("ExpExpressionTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup ExpExpressionTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down ExpExpressionTest test class."); }
};
