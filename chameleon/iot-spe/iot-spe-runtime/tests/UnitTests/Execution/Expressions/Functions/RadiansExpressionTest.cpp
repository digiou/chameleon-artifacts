...
class RadiansExpressionTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("RadiansExpressionTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup RadiansExpressionTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down RadiansExpressionTest test class."); }
};
