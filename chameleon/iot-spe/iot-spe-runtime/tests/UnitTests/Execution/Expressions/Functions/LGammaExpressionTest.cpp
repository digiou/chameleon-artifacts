...
class LGammaExpressionTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("LGammaExpressionTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup LGammaExpressionTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down LGammaExpressionTest test class."); }
};
