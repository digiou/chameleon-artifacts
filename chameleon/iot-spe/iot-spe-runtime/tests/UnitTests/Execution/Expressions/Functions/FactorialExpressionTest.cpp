...
class FactorialExpressionTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("FactorialExpressionTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup FactorialExpressionTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down FactorialExpressionTest test class."); }
};
