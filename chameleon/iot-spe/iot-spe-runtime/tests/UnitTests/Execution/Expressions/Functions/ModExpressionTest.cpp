...
class ModExpressionTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("ModExpressionTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup ModExpressionTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down ModExpressionTest test class."); }
};
