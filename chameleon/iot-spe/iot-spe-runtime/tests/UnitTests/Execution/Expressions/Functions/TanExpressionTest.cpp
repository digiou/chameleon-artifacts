...
class TanExpressionTest : public Testing::BaseUnitTest {
  ...
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("TanExpressionTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup TanExpressionTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down TanExpressionTest test class."); }
};
