...
class CbrtExpressionTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("CbrtExpressionTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup CbrtExpressionTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down CbrtExpressionTest test class."); }
};
