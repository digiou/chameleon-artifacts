...
class CosExpressionTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("CosExpressionTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup CosExpressionTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down CosExpressionTest test class."); }
};
