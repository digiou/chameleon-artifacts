...
class AcosExpressionTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("AcosExpressionTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup AcosExpressionTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down AcosExpressionTest test class."); }
};
