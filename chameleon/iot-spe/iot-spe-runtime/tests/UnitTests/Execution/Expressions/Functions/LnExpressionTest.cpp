...
class LnExpressionTest : public Testing::BaseUnitTest {
  ...
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("LnExpressionTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup LnExpressionTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down LnExpressionTest test class."); }
};
