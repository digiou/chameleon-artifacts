...
class GammaExpressionTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("GammaExpressionTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup GammaExpressionTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down GammaExpressionTest test class."); }
};
