...
class TruncExpressionTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("TruncExpressionTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup TruncExpressionTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down TruncExpressionTest test class."); }
};
