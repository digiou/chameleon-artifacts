...
class FloorExpressionTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("FloorExpressionTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup FloorExpressionTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down FloorExpressionTest test class."); }
};
