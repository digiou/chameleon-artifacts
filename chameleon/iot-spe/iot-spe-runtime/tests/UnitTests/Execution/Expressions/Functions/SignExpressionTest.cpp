...
class SignExpressionTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("SignExpressionTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup SignExpressionTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down SignExpressionTest test class."); }
};
