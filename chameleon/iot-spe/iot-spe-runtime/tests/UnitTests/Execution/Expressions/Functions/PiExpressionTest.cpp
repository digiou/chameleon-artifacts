...
class PiExpressionTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("PiExpressionTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup PiExpressionTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down PiExpressionTest test class."); }
};
