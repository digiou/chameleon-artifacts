...
class Atan2ExpressionTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("Atan2ExpressionTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup Atan2ExpressionTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down Atan2ExpressionTest test class."); }
};
