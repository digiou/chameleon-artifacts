...
class AtanExpressionTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("AtanExpressionTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup AtanExpressionTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down AtanExpressionTest test class."); }
};
