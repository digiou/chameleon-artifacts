...
class Log10ExpressionTest : public Testing::BaseUnitTest {
  ...
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("Log10ExpressionTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup Log10ExpressionTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down Log10ExpressionTest test class."); }
};
