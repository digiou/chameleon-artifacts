...
class BitcounterExpressionTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("BitcounterExpressionTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup BitcounterExpressionTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down BitcounterExpressionTest test class."); }
};
