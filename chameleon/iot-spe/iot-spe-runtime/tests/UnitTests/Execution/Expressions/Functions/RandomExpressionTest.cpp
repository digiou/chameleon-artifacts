...
class RandomExpressionTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("RandomExpressionTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup RandomExpressionTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down RandomExpressionTest test class."); }
};
