...
class NonKeyedThresholdWindowOperatorTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("NonKeyedThresholdWindowOperatorTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup NonKeyedThresholdWindowOperatorTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down NonKeyedThresholdWindowOperatorTest test class."); }
};
