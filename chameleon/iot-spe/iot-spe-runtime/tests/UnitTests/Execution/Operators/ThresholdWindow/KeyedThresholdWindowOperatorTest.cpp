...
class KeyedThresholdWindowOperatorTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("ThresholdWindowOperatorTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup ThresholdWindowOperatorTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down ThresholdWindowOperatorTest test class."); }
};
