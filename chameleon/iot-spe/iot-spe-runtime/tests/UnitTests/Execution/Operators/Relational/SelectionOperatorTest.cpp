...
class SelectionOperatorTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("SelectionOperatorTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup SelectionOperatorTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down SelectionOperatorTest test class."); }
};
