...
class MapOperatorTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("MapOperatorTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup MapOperatorTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down MapOperatorTest test class."); }
};
