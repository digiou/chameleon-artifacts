...
class InferModelOperatorTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("InferModelOperatorTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup InferModelOperatorTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down InferModelOperatorTest test class."); }
};

/**
 * @brief Tests the infer model operator for bool input.
 */
TEST_F(InferModelOperatorTest, testInferModelForBoolInput) {
    std::string f1 = "f1";
    std::string f2 = "f2";
    std::string f3 = "f3";
    std::string f4 = "f4";
    ...
    auto handler = std::make_shared<InferModelHandler>(std::string(TEST_DATA_DIRECTORY) + "iris_95acc.tflite");
 ...
 */
TEST_F(InferModelOperatorTest, testInferModelForFloatInput) {
    std::string f1 = "f1";
    std::string f2 = "f2";
    std::string f3 = "f3";
    std::string f4 = "f4";
 ...
 */
TEST_F(InferModelOperatorTest, testInferModelForIntInput) {
    std::string f1 = "f1";
    std::string f2 = "f2";
    std::string f3 = "f3";
    std::string f4 = "f4";
