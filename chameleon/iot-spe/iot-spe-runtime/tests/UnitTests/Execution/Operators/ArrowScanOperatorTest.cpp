...
class ArrowScanOperatorTest : public Testing::BaseUnitTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("ArrowScanOperatorTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup ArrowScanOperatorTest test class.");
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { x_INFO("Tear down ArrowScanOperatorTest test class."); }
};
