...
class SortPipelineTest : public Testing::BaseUnitTest, public AbstractPipelineExecutionTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("SortPipelineTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup SortPipelineTest test class.");
    }

    /* Will be called before a test is executed. */
    void SetUp() override {
        Testing::BaseUnitTest::SetUp();
        x_INFO("Setup SortPipelineTest test case.");
    ...
    static void TearDownTestCase() { x_INFO("Tear down SortPipelineTest test class."); }
};
