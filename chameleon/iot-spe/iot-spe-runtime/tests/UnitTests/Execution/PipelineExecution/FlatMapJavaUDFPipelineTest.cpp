...
class FlatMapJavaUDFPipelineTest : public testing::Test, public AbstractPipelineExecutionTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("FlatMapJavaUDFPipelineTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup FlatMapJavaUDFPipelineTest test class.");
    }

    /* Will be called before a test is executed. */
    void SetUp() override {
        x_INFO("Setup FlatMapJavaUDFPipelineTest test case.");
 ...
 */
TEST_P(FlatMapJavaUDFPipelineTest, scanMapEmitPipelixtringMap) {
    ...
    auto handler =
        initMapHandler("stream.IoTSPE.StringFlatMapFunction", "flatMap", "java.lang.String", "java.util.Collection", schema);
...
TEST_P(FlatMapJavaUDFPipelineTest, scanMapEmitPipelineComplexMap) {
    ...
    auto executablePipeline = provider->create(pipeline, options);
    auto handler = initMapHandler("stream.IoTSPE.ComplexPojoFlatMapFunction",
                                  "flatMap",
