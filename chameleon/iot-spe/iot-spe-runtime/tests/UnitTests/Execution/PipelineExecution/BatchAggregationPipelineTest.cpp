...
class BatchAggregationPipelineTest : public Testing::BaseUnitTest, public AbstractPipelineExecutionTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("BatchAggregationPipelineTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup BatchAggregationPipelineTest test class.");
    }

    /* Will be called before a test is executed. */
    void SetUp() override {
        Testing::BaseUnitTest::SetUp();
        x_INFO("Setup BatchAggregationPipelineTest test case.");
    ...
    static void TearDownTestCase() { x_INFO("Tear down BatchAggregationPipelineTest test class."); }
};
