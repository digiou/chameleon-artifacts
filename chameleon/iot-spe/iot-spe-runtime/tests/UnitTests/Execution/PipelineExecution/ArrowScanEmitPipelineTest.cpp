...
class ArrowScanEmitPipelineTest : public Testing::BaseUnitTest, public AbstractPipelineExecutionTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("ArrowScanEmitPipelineTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup ArrowScanEmitPipelineTest test class.");
    }

    /* Will be called before a test is executed. */
    void SetUp() override {
        Testing::BaseUnitTest::SetUp();
        x_INFO("Setup ArrowScanEmitPipelineTest test case.");
    ...
    static void TearDownTestCase() { x_INFO("Tear down ArrowScanEmitPipelineTest test class."); }
};
