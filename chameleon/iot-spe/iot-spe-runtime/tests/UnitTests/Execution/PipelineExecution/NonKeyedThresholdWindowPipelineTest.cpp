...
class NonKeyedThresholdWindowPipelineTest : public Testing::BaseUnitTest, public AbstractPipelineExecutionTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("NonKeyedThresholdWindowPipelineTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup NonKeyedThresholdWindowPipelineTest test class.");
    }

    /* Will be called before a test is executed. */
    void SetUp() override {
        Testing::BaseUnitTest::SetUp();
        x_INFO("Setup NonKeyedThresholdWindowPipelineTest test case.");
    ...
    static void TearDownTestCase() { x_INFO("Tear down NonKeyedThresholdWindowPipelineTest test class."); }
};
