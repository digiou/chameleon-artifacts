...
class BatchJoinPipelineTest : public Testing::BaseUnitTest, public AbstractPipelineExecutionTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("BatchJoinPipelineTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup BatchJoinPipelineTest test class.");
    }

    /* Will be called before a test is executed. */
    void SetUp() override {
        Testing::BaseUnitTest::SetUp();
        x_INFO("Setup BatchJoinPipelineTest test case.");
    ...
    static void TearDownTestCase() { x_INFO("Tear down BatchJoinPipelineTest test class."); }
};
