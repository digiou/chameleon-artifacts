...
class MapJavaUDFPipelineTest : public testing::Test, public AbstractPipelineExecutionTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("MapJavaUDFPipelineTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup MapJavaUDFPipelineTest test class.");
    }

    /* Will be called before a test is executed. */
    void SetUp() override {
        x_INFO("Setup MapJavaUDFPipelineTest test case.");
...
TEST_P(MapJavaUDFPipelineTest, scanMapEmitPipelineIntegerMap) {
    ...
    auto handler = initMapHandler("stream.IoTSPE.IntegerMapFunction", "map", "java.lang.Integer", "java.lang.Integer", schema);
 ...
 */
TEST_P(MapJavaUDFPipelineTest, scanMapEmitPipelixhortMap) {
    ...
    auto executablePipeline = provider->create(pipeline, options);
    auto handler = initMapHandler("stream.IoTSPE.ShortMapFunction", "map", "java.lang.Short", "java.lang.Short", schema);
    auto pipelineContext = MockedPipelineExecutionContext({handler});
...
TEST_P(MapJavaUDFPipelineTest, scanMapEmitPipelineByteMap) {
    ...
    auto executablePipeline = provider->create(pipeline, options);
    auto handler = initMapHandler("stream.IoTSPE.ByteMapFunction", "map", "java.lang.Byte", "java.lang.Byte", schema);
    auto pipelineContext = MockedPipelineExecutionContext({handler});
...
TEST_P(MapJavaUDFPipelineTest, scanMapEmitPipelineLongMap) {
    ...
    auto executablePipeline = provider->create(pipeline, options);
    auto handler = initMapHandler("stream.IoTSPE.LongMapFunction", "map", "java.lang.Long", "java.lang.Long", schema);
    auto pipelineContext = MockedPipelineExecutionContext({handler});
...
TEST_P(MapJavaUDFPipelineTest, scanMapEmitPipelineDoubleMap) {
    ...
    auto executablePipeline = provider->create(pipeline, options);
    auto handler = initMapHandler("stream.IoTSPE.DoubleMapFunction", "map", "java.lang.Double", "java.lang.Double", schema);
    auto pipelineContext = MockedPipelineExecutionContext({handler});
...
TEST_P(MapJavaUDFPipelineTest, scanMapEmitPipelineBooleanMap) {
    ...
    auto executablePipeline = provider->create(pipeline, options);
    auto handler = initMapHandler("stream.IoTSPE.BooleanMapFunction", "map", "java.lang.Boolean", "java.lang.Boolean", schema);
    auto pipelineContext = MockedPipelineExecutionContext({handler});
 ...
 */
TEST_P(MapJavaUDFPipelineTest, scanMapEmitPipelixtringMap) {
    ...
    auto executablePipeline = provider->create(pipeline, options);
    auto handler = initMapHandler("stream.IoTSPE.StringMapFunction", "map", "java.lang.String", "java.lang.String", schema);
...
TEST_P(MapJavaUDFPipelineTest, scanMapEmitPipelineComplexMap) {
    ...
    auto executablePipeline = provider->create(pipeline, options);
    auto handler = initMapHandler("stream.IoTSPE.ComplexPojoMapFunction",
                                  "map",
                                  "stream.IoTSPE.ComplexPojo",
                                  "stream.IoTSPE.ComplexPojo",
                                  schema);
