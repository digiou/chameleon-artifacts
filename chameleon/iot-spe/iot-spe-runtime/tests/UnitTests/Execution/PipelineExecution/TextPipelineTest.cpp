...
class TextPipelineTest : public Testing::BaseUnitTest, public AbstractPipelineExecutionTest {
  public:
    ...
    static void SetUpTestCase() {
        x::Logger::setupLogging("TextPipelineTest.log", x::LogLevel::LOG_DEBUG);
        x_INFO("Setup TextPipelineTest test class.");
    }

    /* Will be called before a test is executed. */
    void SetUp() override {
        Testing::BaseUnitTest::SetUp();
        x_INFO("Setup TextPipelineTest test case.");
    ...
    static void TearDownTestCase() { x_INFO("Tear down TextPipelineTest test class."); }
};
