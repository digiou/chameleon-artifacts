...
namespace x::Runtime::Execution::Aggregation {
...
AggregationFunction::AggregationFunction(PhysicalTypePtr inputType,
                                         ...
                                         Nautilus::Record::RecordFieldIdentifier resultFieldIdentifier)
        : inputType(std::move(inputType)), resultType(std::move(resultType)), inputExpression(std::move(inputExpression)),
        inputTsExpression(std::move(inputTsExpression)), resultFieldIdentifier(std::move(resultFieldIdentifier)) {}
    ...
    if (physicalType->isBasicType()) {
        ...
        switch (basicType->nativeType) {
            ...
            default: {
                ...
                type << physicalType;
                x_ERROR("Aggregation Function::load: Physical Type: {} is currently not supported", type.str());
                x_NOT_IMPLEMENTED();
            };
        }
    } else {
        ...
        x_ERROR("Aggregation Function::load: Physical Type: {} is not a basic type and is currently not supported",
                  typeAsString.str());
        x_NOT_IMPLEMENTED();
    }
}
    ...
    if (physicalType->isBasicType()) {
        ...
        switch (basicType->nativeType) {
            ...
            default: {
                std::stringstream type;
                type << physicalType;
                x_ERROR("Aggregation Function::createMinValue: Physical Type: {} is currently not supported", type.str());
                x_NOT_IMPLEMENTED();
            };
        }
    } else {
        ...
        x_ERROR("Aggregation Function::createMinValue: Physical Type: {} is not a basic type and is currently not supported",
                  typeString.str());
        x_NOT_IMPLEMENTED();
    }
}
    ...
    if (physicalType->isBasicType()) {
        ...
        switch (basicType->nativeType) {
            ...
            default: {
                std::stringstream type;
                type << physicalType;
                x_ERROR("Aggregation Function::createMaxValue: Physical Type: {} is currently not supported", type.str());
                x_NOT_IMPLEMENTED();
            };
        }
    } else {
        std::stringstream typeString;
        typeString << physicalType;
        x_ERROR("Aggregation Function::createMaxValue: Physical Type: {} is not a basic type and is currently not supported",
                  typeString.str());
        x_NOT_IMPLEMENTED();
    }
}
