...
void HyperLogLogDistinctCountApproximation::lift(Nautilus::Value<Nautilus::MemRef> memref, Nautilus::Record& record) {
    ...
    x::Nautilus::Interface::MurMur3HashFunction murMur3HashFunction;
    auto inputValue = inputExpression->execute(record);
    x::Nautilus::Interface::HashFunction::HashValue hashValueNautilus = murMur3HashFunction.calculate(inputValue);
