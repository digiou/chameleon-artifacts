...
extern "C" __attribute__((always_inline)) void* x__Runtime__TupleBuffer__getBuffer(void* thisPtr) {
...
// extern "C" __attribute__((always_inline)) uint64_t x__Runtime__TupleBuffer__getNumberOfTuples(void *thisPtr) {
...
// extern "C" __attribute__((always_inline)) void x__Runtime__TupleBuffer__setNumberOfTuples(void *thisPtr, uint64_t numberOfTuples) {
//    x::Runtime::TupleBuffer *tupleBuffer = static_cast<x::Runtime::TupleBuffer*>(thisPtr);
