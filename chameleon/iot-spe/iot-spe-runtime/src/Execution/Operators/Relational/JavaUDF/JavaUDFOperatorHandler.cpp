...
JavaUDFOperatorHandler::JavaUDFOperatorHandler(const std::string& className,
                                               ...
                                               x::SchemaPtr udfInputSchema,
                                               x::SchemaPtr udfOutputSchema,
...
void JavaUDFOperatorHandler::start(x::Runtime::Execution::PipelineExecutionContextPtr,
                                   x::Runtime::StateManagerPtr,
                                   uint32_t) {}
