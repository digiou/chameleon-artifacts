...
#include <Execution/Pipelix/InterpreterPipelineProvider.hpp>
#include <Execution/Pipelix/NautilusExecutablePipelixtage.hpp>

namespace x::Runtime::Execution {

std::unique_ptr<ExecutablePipelixtage>
InterpreterPipelineProvider::create(std::shared_ptr<PhysicalOperatorPipeline> physicalOperatorPipeline,
    ...
    return std::make_unique<NautilusExecutablePipelixtage>(physicalOperatorPipeline);
}
