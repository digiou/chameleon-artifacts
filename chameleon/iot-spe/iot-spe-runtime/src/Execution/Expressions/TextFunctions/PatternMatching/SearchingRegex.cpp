...
SearchingRegex::SearchingRegex(const x::Runtime::Execution::Expressions::ExpressionPtr& textValue,
...
Value<> SearchingRegex::execute(x::Nautilus::Record& record) const {
