...
JaccardDistance::JaccardDistance(const x::Runtime::Execution::Expressions::ExpressionPtr& leftSubExpression,
...
Value<> JaccardDistance::execute(x::Nautilus::Record& record) const {
