...
HammingDistance::HammingDistance(const x::Runtime::Execution::Expressions::ExpressionPtr& leftSubExpression,
...
Value<> HammingDistance::execute(x::Nautilus::Record& record) const {
