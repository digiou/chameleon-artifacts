...
JaroSimilarity::JaroSimilarity(const x::Runtime::Execution::Expressions::ExpressionPtr& leftSubExpression,
                               const x::Runtime::Execution::Expressions::ExpressionPtr& rightSubExpression,
                               const x::Runtime::Execution::Expressions::ExpressionPtr& flagExpression)
...
Value<> JaroSimilarity::execute(x::Nautilus::Record& record) const {
    ...
    if (leftValue->isType<Text>() && rightValue->isType<Text>() && flagValue->isType<Boolean>()) {
        ...
        x_THROW_RUNTIME_ERROR("This expression is only defined on input arguments that are Text and a Boolean for the Winkler "
