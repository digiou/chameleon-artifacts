...
CosExpression::CosExpression(const x::Runtime::Execution::Expressions::ExpressionPtr& leftSubExpression)
...
Value<> CosExpression::execute(x::Nautilus::Record& record) const {
