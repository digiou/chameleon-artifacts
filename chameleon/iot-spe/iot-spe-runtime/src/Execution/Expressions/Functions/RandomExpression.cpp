...
RandomExpression::RandomExpression(x::Runtime::Execution::Expressions::ExpressionPtr subExpression)
...
Value<> RandomExpression::execute(x::Nautilus::Record& record) const {
