...
LGammaExpression::LGammaExpression(const x::Runtime::Execution::Expressions::ExpressionPtr& SubExpression)
...
Value<> LGammaExpression::execute(x::Nautilus::Record& record) const {
