...
SqrtExpression::SqrtExpression(const x::Runtime::Execution::Expressions::ExpressionPtr& subExpression)
...
Value<> SqrtExpression::execute(x::Nautilus::Record& record) const {
