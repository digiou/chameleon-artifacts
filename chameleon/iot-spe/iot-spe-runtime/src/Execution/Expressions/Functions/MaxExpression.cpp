...
MaxExpression::MaxExpression(const x::Runtime::Execution::Expressions::ExpressionPtr& leftSubExpression,
...
Value<> MaxExpression::execute(x::Nautilus::Record& record) const {
