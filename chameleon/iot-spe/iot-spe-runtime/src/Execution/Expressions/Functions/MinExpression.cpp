...
MinExpression::MinExpression(const x::Runtime::Execution::Expressions::ExpressionPtr& leftSubExpression,
...
Value<> MinExpression::execute(x::Nautilus::Record& record) const {
