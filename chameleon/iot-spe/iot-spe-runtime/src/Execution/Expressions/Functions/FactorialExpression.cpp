...
FactorialExpression::FactorialExpression(const x::Runtime::Execution::Expressions::ExpressionPtr& SubExpression)
...
Value<> FactorialExpression::execute(x::Nautilus::Record& record) const {
