...
TruncExpression::TruncExpression(const x::Runtime::Execution::Expressions::ExpressionPtr& subExpression)
...
Value<> TruncExpression::execute(x::Nautilus::Record& record) const {
