...
PowerExpression::PowerExpression(const x::Runtime::Execution::Expressions::ExpressionPtr& leftSubExpression,
...
Value<> PowerExpression::execute(x::Nautilus::Record& record) const {
