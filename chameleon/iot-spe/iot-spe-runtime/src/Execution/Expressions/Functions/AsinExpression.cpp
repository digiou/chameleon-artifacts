...
AsinExpression::AsinExpression(const x::Runtime::Execution::Expressions::ExpressionPtr& radians) : radians(radians) {}
...
Value<> AsinExpression::execute(x::Nautilus::Record& record) const {
