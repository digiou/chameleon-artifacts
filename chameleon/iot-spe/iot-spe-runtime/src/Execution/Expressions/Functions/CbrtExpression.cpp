...
CbrtExpression::CbrtExpression(const x::Runtime::Execution::Expressions::ExpressionPtr& subExpression)
...
Value<> CbrtExpression::execute(x::Nautilus::Record& record) const {
