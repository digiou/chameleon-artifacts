...
AtanExpression::AtanExpression(const x::Runtime::Execution::Expressions::ExpressionPtr& leftSubExpression)
...
Value<> AtanExpression::execute(x::Nautilus::Record& record) const {
