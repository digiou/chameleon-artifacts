...
FloorExpression::FloorExpression(const x::Runtime::Execution::Expressions::ExpressionPtr& leftSubExpression)
...
Value<> FloorExpression::execute(x::Nautilus::Record& record) const {
