...
AcosExpression::AcosExpression(const x::Runtime::Execution::Expressions::ExpressionPtr& Expression) : Expression(Expression) {}
...
Value<> AcosExpression::execute(x::Nautilus::Record& record) const {
