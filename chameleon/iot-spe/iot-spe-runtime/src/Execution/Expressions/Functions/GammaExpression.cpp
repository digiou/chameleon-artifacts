...
GammaExpression::GammaExpression(const x::Runtime::Execution::Expressions::ExpressionPtr& subExpression)
...
Value<> GammaExpression::execute(x::Nautilus::Record& record) const {
