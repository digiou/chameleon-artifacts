...
CotExpression::CotExpression(const x::Runtime::Execution::Expressions::ExpressionPtr& radians) : radians(radians) {}
...
Value<> CotExpression::execute(x::Nautilus::Record& record) const {
