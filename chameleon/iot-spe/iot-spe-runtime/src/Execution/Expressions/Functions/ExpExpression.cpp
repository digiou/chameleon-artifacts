...
ExpExpression::ExpExpression(const x::Runtime::Execution::Expressions::ExpressionPtr& subExpression)
...
Value<> ExpExpression::execute(x::Nautilus::Record& record) const {
