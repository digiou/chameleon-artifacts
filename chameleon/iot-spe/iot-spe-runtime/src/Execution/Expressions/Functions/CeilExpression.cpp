...
CeilExpression::CeilExpression(const x::Runtime::Execution::Expressions::ExpressionPtr& subExpression)
...
Value<> CeilExpression::execute(x::Nautilus::Record& record) const {
