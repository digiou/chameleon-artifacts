...
Atan2Expression::Atan2Expression(const x::Runtime::Execution::Expressions::ExpressionPtr& leftSubExpression,
...
Value<> Atan2Expression::execute(x::Nautilus::Record& record) const {
