...
ModExpression::ModExpression(const x::Runtime::Execution::Expressions::ExpressionPtr& leftSubExpression,
...
Value<> ModExpression::execute(x::Nautilus::Record& record) const {
