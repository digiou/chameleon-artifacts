...
SinExpression::SinExpression(const x::Runtime::Execution::Expressions::ExpressionPtr& subExpression)
...
Value<> SinExpression::execute(x::Nautilus::Record& record) const {
