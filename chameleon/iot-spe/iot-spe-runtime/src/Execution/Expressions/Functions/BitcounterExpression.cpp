...
BitcounterExpression::BitcounterExpression(const x::Runtime::Execution::Expressions::ExpressionPtr& SubExpression)
    : SubExpression(SubExpression) {}

uint32_t bitcounter(uint64_t number) { return std::popcount(number); }

Value<> BitcounterExpression::execute(x::Nautilus::Record& record) const {
