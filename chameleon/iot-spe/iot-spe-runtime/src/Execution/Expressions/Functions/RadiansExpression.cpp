...
RadiansExpression::RadiansExpression(const x::Runtime::Execution::Expressions::ExpressionPtr& SubExpression)
    : SubExpression(SubExpression) {}

double calculateRadians(double x) { return (x * M_PI) / 180; }
Value<> RadiansExpression::execute(x::Nautilus::Record& record) const {
