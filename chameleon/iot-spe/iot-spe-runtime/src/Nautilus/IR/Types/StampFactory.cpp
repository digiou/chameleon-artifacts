...
StampPtr StampFactory::createUInt8Stamp() {
    return std::make_shared<IntegerStamp>(IntegerStamp::BitWidth::I8, IntegerStamp::SignedxsSemantics::Unsigned);
}

StampPtr StampFactory::createUInt16Stamp() {
    return std::make_shared<IntegerStamp>(IntegerStamp::BitWidth::I16, IntegerStamp::SignedxsSemantics::Unsigned);
}

StampPtr StampFactory::createUInt32Stamp() {
    return std::make_shared<IntegerStamp>(IntegerStamp::BitWidth::I32, IntegerStamp::SignedxsSemantics::Unsigned);
}

StampPtr StampFactory::createUInt64Stamp() {
    return std::make_shared<IntegerStamp>(IntegerStamp::BitWidth::I64, IntegerStamp::SignedxsSemantics::Unsigned);
}

StampPtr StampFactory::createInt8Stamp() {
    return std::make_shared<IntegerStamp>(IntegerStamp::BitWidth::I8, IntegerStamp::SignedxsSemantics::Signed);
}

StampPtr StampFactory::createInt16Stamp() {
    return std::make_shared<IntegerStamp>(IntegerStamp::BitWidth::I16, IntegerStamp::SignedxsSemantics::Signed);
}

StampPtr StampFactory::createInt32Stamp() {
    return std::make_shared<IntegerStamp>(IntegerStamp::BitWidth::I32, IntegerStamp::SignedxsSemantics::Signed);
}

StampPtr StampFactory::createInt64Stamp() {
    return std::make_shared<IntegerStamp>(IntegerStamp::BitWidth::I64, IntegerStamp::SignedxsSemantics::Signed);
}
