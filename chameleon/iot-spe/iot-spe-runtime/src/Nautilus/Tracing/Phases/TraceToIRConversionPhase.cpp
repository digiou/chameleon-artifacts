...
std::shared_ptr<x::Nautilus::IR::IRGraph> TraceToIRConversionPhase::apply(std::shared_ptr<ExecutionTrace> trace) {
    auto phaseContext = IRConversionContext(std::move(trace));
    return phaseContext.process();
};

std::shared_ptr<x::Nautilus::IR::IRGraph> TraceToIRConversionPhase::IRConversionContext::process() {
    ...
    auto intV = cast<x::Nautilus::IR::Types::IntegerStamp>(returnType);
    auto functionOperation = std::make_shared<x::Nautilus::IR::Operations::FunctionOperation>(
        "execute",
        /*argumentTypes*/ std::vector<x::Nautilus::IR::Operations::PrimitiveStamp>{},
...
x::Nautilus::IR::BasicBlockPtr TraceToIRConversionPhase::IRConversionContext::processBlock(int32_t scope, Block& block) {
    // create new frame and block
    ValueFrame blockFrame;
    std::vector<std::shared_ptr<x::Nautilus::IR::Operations::BasicBlockArgument>> blockArguments;
    for (auto& arg : block.arguments) {
        auto argumentIdentifier = createValueIdentifier(arg);
        auto blockArgument = std::make_shared<x::Nautilus::IR::Operations::BasicBlockArgument>(argumentIdentifier, arg.type);
        blockArguments.emplace_back(blockArgument);
        blockFrame.setValue(argumentIdentifier, blockArgument);
    }

    x::Nautilus::IR::BasicBlockPtr irBasicBlock =
        std::make_shared<x::Nautilus::IR::BasicBlock>(std::to_string(block.blockId),
                                                        scope,
                                                        /*operations*/ std::vector<x::Nautilus::IR::Operations::OperationPtr>{},
...
void TraceToIRConversionPhase::IRConversionContext::processOperation(int32_t scope,
                                                                     ValueFrame& frame,
                                                                     Block& currentBlock,
                                                                     x::Nautilus::IR::BasicBlockPtr& currentIrBlock,
    ...
    switch (operation.op) {
        ...
        case OpCode::RETURN: {
            if (std::get<ValueRef>(operation.result).type->isVoid()) {
                auto operation = std::make_shared<x::Nautilus::IR::Operations::ReturnOperation>();
                currentIrBlock->addOperation(operation);
            } else {
                auto returnValue = frame.getValue(createValueIdentifier(operation.input[0]));
                auto operation = std::make_shared<x::Nautilus::IR::Operations::ReturnOperation>(returnValue);
                currentIrBlock->addOperation(operation);
            }
...
void TraceToIRConversionPhase::IRConversionContext::processJMP(int32_t scope,
                                                               ValueFrame& frame,
                                                               x::Nautilus::IR::BasicBlockPtr& block,
                                                               TraceOperation& operation) {
    std::stringstream operationAsString;
    operationAsString << operation;
    x_DEBUG("current block {} {}", block->getIdentifier(), operationAsString.str());
    auto blockRef = get<BlockRef>(operation.input[0]);
    x::Nautilus::IR::Operations::BasicBlockInvocation blockInvocation;
...
void TraceToIRConversionPhase::IRConversionContext::processCMP(int32_t scope,
    ...
    auto ifOperation = std::make_shared<x::Nautilus::IR::Operations::IfOperation>(booleanValue);
...
void TraceToIRConversionPhase::IRConversionContext::processAdd(int32_t,
                                                               ValueFrame& frame,
                                                               x::Nautilus::IR::BasicBlockPtr& currentBlock,
                                                               TraceOperation& operation) {
    ...
    auto addOperation = std::make_shared<x::Nautilus::IR::Operations::AddOperation>(resultIdentifier, leftInput, rightInput);
...
void TraceToIRConversionPhase::IRConversionContext::processSub(int32_t,
    ...
    auto rightInput = frame.getValue(createValueIdentifier(operation.input[1]));
    auto resultIdentifier = createValueIdentifier(operation.result);
    auto subOperation = std::make_shared<x::Nautilus::IR::Operations::SubOperation>(resultIdentifier, leftInput, rightInput);
...
void TraceToIRConversionPhase::IRConversionContext::processMul(int32_t,
    ...
    auto rightInput = frame.getValue(createValueIdentifier(operation.input[1]));
    auto resultIdentifier = createValueIdentifier(operation.result);
    auto mulOperation = std::make_shared<x::Nautilus::IR::Operations::MulOperation>(resultIdentifier, leftInput, rightInput);
...
void TraceToIRConversionPhase::IRConversionContext::processDiv(int32_t,
    ...
    auto rightInput = frame.getValue(createValueIdentifier(operation.input[1]));
    auto resultIdentifier = createValueIdentifier(operation.result);
    auto divOperation = std::make_shared<x::Nautilus::IR::Operations::DivOperation>(resultIdentifier, leftInput, rightInput);
...
void TraceToIRConversionPhase::IRConversionContext::processMod(int32_t,
    ...
    auto rightInput = frame.getValue(createValueIdentifier(operation.input[1]));
    auto resultIdentifier = createValueIdentifier(operation.result);
    auto modOperation = std::make_shared<x::Nautilus::IR::Operations::ModOperation>(resultIdentifier, leftInput, rightInput);
...
void TraceToIRConversionPhase::IRConversionContext::processNegate(int32_t,
    ...
    auto resultIdentifier = createValueIdentifier(operation.result);
    auto negateOperation = std::make_shared<x::Nautilus::IR::Operations::NegateOperation>(resultIdentifier, input);
...
void TraceToIRConversionPhase::IRConversionContext::processLessThan(int32_t,
    ...
    x::Nautilus::IR::Operations::CompareOperation::Comparator comparator;
    comparator = x::Nautilus::IR::Operations::CompareOperation::Comparator::LT;

    auto resultIdentifier = createValueIdentifier(operation.result);
    auto compareOperation = std::make_shared<x::Nautilus::IR::Operations::CompareOperation>(
        resultIdentifier,
        leftInput,
        rightInput,
        x::Nautilus::IR::Operations::CompareOperation::Comparator::LT);
...
void TraceToIRConversionPhase::IRConversionContext::processGreaterThan(int32_t,
    ...
    x::Nautilus::IR::Operations::CompareOperation::Comparator comparator;
    comparator = x::Nautilus::IR::Operations::CompareOperation::Comparator::GT;
    ...
    auto compareOperation = std::make_shared<x::Nautilus::IR::Operations::CompareOperation>(
        ...
        leftInput,
        rightInput,
        x::Nautilus::IR::Operations::CompareOperation::Comparator::GT);
    frame.setValue(resultIdentifier, compareOperation);
    currentBlock->addOperation(compareOperation);
}
void TraceToIRConversionPhase::IRConversionContext::processEquals(int32_t,
    ...
    auto compareOperation = std::make_shared<x::Nautilus::IR::Operations::CompareOperation>(
        ...
        leftInput,
        rightInput,
        x::Nautilus::IR::Operations::CompareOperation::Comparator::EQ);
    frame.setValue(resultIdentifier, compareOperation);
    currentBlock->addOperation(compareOperation);
}
void TraceToIRConversionPhase::IRConversionContext::processAnd(int32_t,
    ...
    auto rightInput = frame.getValue(createValueIdentifier(operation.input[1]));
    auto resultIdentifier = createValueIdentifier(operation.result);
    auto andOperation = std::make_shared<x::Nautilus::IR::Operations::AndOperation>(resultIdentifier, leftInput, rightInput);
...
void TraceToIRConversionPhase::IRConversionContext::processOr(int32_t,
    ...
    auto rightInput = frame.getValue(createValueIdentifier(operation.input[1]));
    auto resultIdentifier = createValueIdentifier(operation.result);
    auto orOperation = std::make_shared<x::Nautilus::IR::Operations::OrOperation>(resultIdentifier, leftInput, rightInput);
...
void TraceToIRConversionPhase::IRConversionContext::processBitWiseAnd(int32_t,
    ...
    auto resultIdentifier = createValueIdentifier(operation.result);
    auto orOperation =
        std::make_shared<x::Nautilus::IR::Operations::BitWiseAndOperation>(resultIdentifier, leftInput, rightInput);
    frame.setValue(resultIdentifier, orOperation);
    currentBlock->addOperation(orOperation);
}
void TraceToIRConversionPhase::IRConversionContext::processBitWiseOr(int32_t,
    ...
    auto resultIdentifier = createValueIdentifier(operation.result);
    auto orOperation =
        std::make_shared<x::Nautilus::IR::Operations::BitWiseOrOperation>(resultIdentifier, leftInput, rightInput);
    frame.setValue(resultIdentifier, orOperation);
    currentBlock->addOperation(orOperation);
}
void TraceToIRConversionPhase::IRConversionContext::processBitWiseXor(int32_t,
    ...
    auto resultIdentifier = createValueIdentifier(operation.result);
    auto orOperation =
        std::make_shared<x::Nautilus::IR::Operations::BitWiseXorOperation>(resultIdentifier, leftInput, rightInput);
    frame.setValue(resultIdentifier, orOperation);
    currentBlock->addOperation(orOperation);
}
void TraceToIRConversionPhase::IRConversionContext::processBitWiseLeftShift(int32_t,
    ...
    auto resultIdentifier = createValueIdentifier(operation.result);
    auto orOperation =
        std::make_shared<x::Nautilus::IR::Operations::BitWiseLeftShiftOperation>(resultIdentifier, leftInput, rightInput);
    frame.setValue(resultIdentifier, orOperation);
    currentBlock->addOperation(orOperation);
}
void TraceToIRConversionPhase::IRConversionContext::processBitWiseRightShift(int32_t,
    ...
    auto resultIdentifier = createValueIdentifier(operation.result);
    auto orOperation =
        std::make_shared<x::Nautilus::IR::Operations::BitWiseRightShiftOperation>(resultIdentifier, leftInput, rightInput);
    frame.setValue(resultIdentifier, orOperation);
    currentBlock->addOperation(orOperation);
}
void TraceToIRConversionPhase::IRConversionContext::processLoad(int32_t,
    ...
    //auto constOperation = std::make_shared<x::Nautilus::IR::Operations::LoadOperation>(createValueIdentifier(operation.result),
    //                                                                      createValueIdentifier(operation.input[0]),
    //                                                                      x::Nautilus::IR::Operations::Operation::BasicType::VOID);
    ...
    auto loadOperation = std::make_shared<x::Nautilus::IR::Operations::LoadOperation>(resultIdentifier, address, resultType);
...
void TraceToIRConversionPhase::IRConversionContext::processStore(int32_t,
    ...
    auto storeOperation = std::make_shared<x::Nautilus::IR::Operations::StoreOperation>(address, value);
...
void TraceToIRConversionPhase::IRConversionContext::processCall(int32_t,
    ...
    auto inputArguments = std::vector<x::Nautilus::IR::Operations::OperationWPtr>{};
    ...
    auto resultType = std::holds_alternative<None>(operation.result) ? x::Nautilus::IR::Types::StampFactory::createVoidStamp()
                                                                     : std::get<ValueRef>(operation.result).type;
    auto resultIdentifier = createValueIdentifier(operation.result);
    auto proxyCallOperation = std::make_shared<x::Nautilus::IR::Operations::ProxyCallOperation>(
        x::Nautilus::IR::Operations::ProxyCallOperation::ProxyCallType::Other,
...
void TraceToIRConversionPhase::IRConversionContext::processConst(int32_t,
    ...
    auto resultIdentifier = createValueIdentifier(operation.result);
    x::Nautilus::IR::Operations::OperationPtr constOperation;
    if (auto* i8 = cast_if<Int8>(valueRef.value.get())) {
        ...
        constOperation = std::make_shared<x::Nautilus::IR::Operations::ConstFloatOperation>(resultIdentifier,
                                                                                              float32->getValue(),
                                                                                              float32->getType());
        ...
        constOperation =
            std::make_shared<x::Nautilus::IR::Operations::ConstBooleanOperation>(resultIdentifier, boolean->getValue());
    } else {
        x_THROW_RUNTIME_ERROR("Can't create const for value");
    }
...
void TraceToIRConversionPhase::IRConversionContext::processCast(int32_t,
    ...
    auto input = frame.getValue(createValueIdentifier(operation.input[0]));
    auto resultType = std::get<ValueRef>(operation.result).type;
    auto castOperation = std::make_shared<x::Nautilus::IR::Operations::CastOperation>(resultIdentifier, input, resultType);
