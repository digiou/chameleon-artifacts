...
ValueRef::ValueRef(uint32_t blockId, uint32_t operationId, x::Nautilus::IR::Types::StampPtr type)
...
ValueRef createNextRef(const x::Nautilus::IR::Types::StampPtr& stamp) {
    if (auto ctx = Nautilus::Tracing::TraceContext::get()) {
        return ctx->createNextRef(stamp);
    }
    // create default value.
    return ValueRef(0 /* blockId */, 0 /*operationId */, x::Nautilus::IR::Types::StampFactory::createVoidStamp());
}
