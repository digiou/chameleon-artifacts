...
ValueRef TraceContext::createNextRef(const x::Nautilus::IR::Types::StampPtr& type) {
...
std::shared_ptr<ExecutionTrace> TraceContext::apply(const std::function<x::Nautilus::Tracing::ValueRef()>& function) {
    ...
    x_DEBUG("Iterations: {}", symbolicExecutionContext.getIterations());
