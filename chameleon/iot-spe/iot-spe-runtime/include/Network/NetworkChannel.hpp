...
#ifndef x_RUNTIME_INCLUDE_NETWORK_NETWORKCHANNEL_HPP_
#define x_RUNTIME_INCLUDE_NETWORK_NETWORKCHANNEL_HPP_
...
/**
 * @brief This class represent the network channel for data transfer that x uses to send data among nodes.
...
class NetworkChannel : public detail::NetworkEventSender<detail::NetworkDataSender<detail::BaseNetworkChannel>> {
  ...
  public:
     ...
     * @param channelId the remote x channel id to connect to
     ...
     * @param xPartition the remote x partition to connect to
...
/**
 * @brief This class represent the network channel for event transfer that x uses to send events among nodes.
...
#endif// x_RUNTIME_INCLUDE_NETWORK_NETWORKCHANNEL_HPP_
