...
*/
#ifndef x_RUNTIME_INCLUDE_NETWORK_PARTITIONREGISTRATIONSTATUS_HPP_
#define x_RUNTIME_INCLUDE_NETWORK_PARTITIONREGISTRATIONSTATUS_HPP_
#include <cstdint>
namespace x::Network {
/**
 * @brief This enum represent the life-cycle of a x partition in the partition manager:
...
#endif// x_RUNTIME_INCLUDE_NETWORK_PARTITIONREGISTRATIONSTATUS_HPP_
