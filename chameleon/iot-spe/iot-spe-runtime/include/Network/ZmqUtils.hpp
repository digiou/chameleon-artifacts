...
#ifndef x_RUNTIME_INCLUDE_NETWORK_ZMQUTILS_HPP_
#define x_RUNTIME_INCLUDE_NETWORK_ZMQUTILS_HPP_
...
void sendMessage(zmq::socket_t& zmqSocket, Arguments&&... args) {
    ...
    x_ASSERT2_FMT(ret.has_value(), "send failed");
...
void sendMessageNoHeader(zmq::socket_t& zmqSocket, Arguments&&... args) {
    ...
    x_ASSERT2_FMT(!!zmqSocket.send(sendMsg, flags), "send failed");
}
...
#endif// x_RUNTIME_INCLUDE_NETWORK_ZMQUTILS_HPP_
