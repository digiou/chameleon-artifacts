...
#ifndef x_RUNTIME_INCLUDE_NETWORK_EVENTBUFFERMESSAGE_HPP_
#define x_RUNTIME_INCLUDE_NETWORK_EVENTBUFFERMESSAGE_HPP_

#include <Network/NetworkMessage.hpp>

namespace x::Network::Messages {
...
#endif// x_RUNTIME_INCLUDE_NETWORK_EVENTBUFFERMESSAGE_HPP_
