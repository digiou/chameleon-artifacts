...
#ifndef x_RUNTIME_INCLUDE_NETWORK_DETAIL_NETWORKEVENTSENDER_HPP_
#define x_RUNTIME_INCLUDE_NETWORK_DETAIL_NETWORKEVENTSENDER_HPP_
...
class NetworkEventSender : public BaseChannelType {
  public:
    ...
    template<Runtime::IsxEvent Event, typename... Arguments>
...
#endif// x_RUNTIME_INCLUDE_NETWORK_DETAIL_NETWORKEVENTSENDER_HPP_
