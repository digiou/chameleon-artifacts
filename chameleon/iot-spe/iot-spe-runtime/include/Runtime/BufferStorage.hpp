...
#ifndef x_RUNTIME_INCLUDE_RUNTIME_BUFFERSTORAGE_HPP_
#define x_RUNTIME_INCLUDE_RUNTIME_BUFFERSTORAGE_HPP_
...
class BufferStorage : public AbstractBufferStorage {
  ...
  public:
    ...
    /**
     * @brief Inserts a tuple buffer for a given x partition
     * @param xPartition destination
     * @param bufferPtr pointer to the buffer that will be stored
     */
    void insertBuffer(x::Runtime::TupleBuffer bufferPtr) override;
     ...
     */
    std::optional<x::Runtime::TupleBuffer> getTopElementFromQueue() const;
...
#endif// x_RUNTIME_INCLUDE_RUNTIME_BUFFERSTORAGE_HPP_
