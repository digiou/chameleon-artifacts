...
#ifndef x_RUNTIME_INCLUDE_RUNTIME_EXECUTION_PIPELINEEXECUTIONCONTEXT_HPP_
#define x_RUNTIME_INCLUDE_RUNTIME_EXECUTION_PIPELINEEXECUTIONCONTEXT_HPP_
...
class PipelineExecutionContext : public std::enable_shared_from_this<PipelineExecutionContext> {
  ...
  public:
    /**
     * @brief The PipelineExecutionContext is passed to the compiled pipeline and enables interaction with the x Runtime.
  ...
  private:
    ...
    */
     ...
     */
    const std::vector<std::shared_ptr<x::Runtime::Execution::OperatorHandler>> operatorHandlers;
...
#endif// x_RUNTIME_INCLUDE_RUNTIME_EXECUTION_PIPELINEEXECUTIONCONTEXT_HPP_
