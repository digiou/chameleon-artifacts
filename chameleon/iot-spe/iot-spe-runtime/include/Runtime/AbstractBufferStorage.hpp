...
#ifndef x_RUNTIME_INCLUDE_RUNTIME_ABSTRACTBUFFERSTORAGE_HPP_
#define x_RUNTIME_INCLUDE_RUNTIME_ABSTRACTBUFFERSTORAGE_HPP_
...
class AbstractBufferStorage {
  public:
     ...
     */
    virtual void insertBuffer(x::Runtime::TupleBuffer bufferPtr) = 0;
...
#endif// x_RUNTIME_INCLUDE_RUNTIME_ABSTRACTBUFFERSTORAGE_HPP_
