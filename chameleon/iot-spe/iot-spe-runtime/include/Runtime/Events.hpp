...
*/
#ifndef x_RUNTIME_INCLUDE_RUNTIME_EVENTS_HPP_
#define x_RUNTIME_INCLUDE_RUNTIME_EVENTS_HPP_
...
namespace x::Runtime {
/// this enum defix the event that can occur in the system runtime
enum class EventType : uint8_t { kInvalidEvent, kCustomEvent, kStartSourceEvent };

template<typename T>
concept IsxEvent = requires(T t) { t.getEventType(); };
...
/**
 * @brief This is the base event type. All events supported in x shall inherit from this class
 */
class BaseEvent {
  public:
    /**
...
#endif// x_RUNTIME_INCLUDE_RUNTIME_EVENTS_HPP_
