...
#ifndef x_RUNTIME_INCLUDE_RUNTIME_HARDWAREMANAGER_HPP_
#define x_RUNTIME_INCLUDE_RUNTIME_HARDWAREMANAGER_HPP_
...
class HardwareManager {
  ...
  public:
     ...
     * @return
     */
    xDefaultMemoryAllocatorPtr getGlobalAllocator() const;
  ...
  private:
    xDefaultMemoryAllocatorPtr globalAllocator;
#ifdef x_USE_ONE_QUEUE_PER_NUMA_NODE
...
#endif// x_RUNTIME_INCLUDE_RUNTIME_HARDWAREMANAGER_HPP_
