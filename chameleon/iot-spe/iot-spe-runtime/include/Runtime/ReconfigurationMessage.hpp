...
#ifndef x_RUNTIME_INCLUDE_RUNTIME_RECONFIGURATIONMESSAGE_HPP_
#define x_RUNTIME_INCLUDE_RUNTIME_RECONFIGURATIONMESSAGE_HPP_
...
class ReconfigurationMessage {
  ...
  public:
    ...
    explicit ReconfigurationMessage(const QueryId queryId,
        ...
        refCnt.store(0);
        x_ASSERT(this->userdata.has_value(), "invalid userdata");
    }
    ...
    explicit ReconfigurationMessage(const QueryId queryId,
        ...
        x_ASSERT(this->instance, "invalid instance");
        x_ASSERT(this->userdata.has_value(), "invalid userdata");
    ...
    [[nodiscard]] T getUserData() const {
        x_ASSERT2_FMT(userdata.has_value(), "invalid userdata");
...
#endif// x_RUNTIME_INCLUDE_RUNTIME_RECONFIGURATIONMESSAGE_HPP_
