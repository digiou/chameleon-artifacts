...
#ifndef x_RUNTIME_INCLUDE_RUNTIME_BUFFERMANAGER_HPP_
#define x_RUNTIME_INCLUDE_RUNTIME_BUFFERMANAGER_HPP_
...
class BufferManager : public std::enable_shared_from_this<BufferManager>,
  ...
  public:
    ...
    explicit BufferManager(
        ...
        std::shared_ptr<std::pmr::memory_resource> memoryResource = std::make_shared<xDefaultMemoryAllocator>(),
...
#endif// x_RUNTIME_INCLUDE_RUNTIME_BUFFERMANAGER_HPP_
