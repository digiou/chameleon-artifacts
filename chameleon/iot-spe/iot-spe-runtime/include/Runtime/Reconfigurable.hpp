...
#ifndef x_RUNTIME_INCLUDE_RUNTIME_RECONFIGURABLE_HPP_
#define x_RUNTIME_INCLUDE_RUNTIME_RECONFIGURABLE_HPP_
...
/**
* @brief x components that require to be reconfigured at Runtime need to
...
* the reconfiguration.
*/
class Reconfigurable : public x::detail::virtual_enable_shared_from_this<Reconfigurable, false> {
  public:
    ~Reconfigurable() x_NOEXCEPT(false) override = default;
...
#endif// x_RUNTIME_INCLUDE_RUNTIME_RECONFIGURABLE_HPP_
