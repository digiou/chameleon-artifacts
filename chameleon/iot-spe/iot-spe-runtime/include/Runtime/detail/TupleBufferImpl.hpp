...
#ifndef x_RUNTIME_INCLUDE_RUNTIME_DETAIL_TUPLEBUFFERIMPL_HPP_
#define x_RUNTIME_INCLUDE_RUNTIME_DETAIL_TUPLEBUFFERIMPL_HPP_
...
class alignas(64) BufferControlBlock {
  public:
    ...
    * Note that this is going to be deprecated in future x versions
 ...
 */
class MemorySegment {
    friend class x::Runtime::TupleBuffer;
    friend class x::Runtime::LocalBufferPool;
    friend class x::Runtime::FixedSizeBufferPool;
    friend class x::Runtime::BufferManager;
    friend class x::Runtime::detail::BufferControlBlock;
...
#endif// x_RUNTIME_INCLUDE_RUNTIME_DETAIL_TUPLEBUFFERIMPL_HPP_
