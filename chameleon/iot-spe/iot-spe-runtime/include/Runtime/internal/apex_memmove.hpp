#ifndef x_RUNTIME_INCLUDE_RUNTIME_INTERNAL_APEX_MEMMOVE_HPP_
#define x_RUNTIME_INCLUDE_RUNTIME_INTERNAL_APEX_MEMMOVE_HPP_
...
#endif// x_RUNTIME_INCLUDE_RUNTIME_INTERNAL_APEX_MEMMOVE_HPP_
