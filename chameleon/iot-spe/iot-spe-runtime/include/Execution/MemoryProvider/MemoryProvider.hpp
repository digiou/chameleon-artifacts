...
*/
#ifndef x_RUNTIME_INCLUDE_EXECUTION_MEMORYPROVIDER_MEMORYPROVIDER_HPP_
#define x_RUNTIME_INCLUDE_EXECUTION_MEMORYPROVIDER_MEMORYPROVIDER_HPP_

#include <Nautilus/Interface/Record.hpp>
#include <Runtime/RuntimeForwardRefs.hpp>

namespace x::Runtime::Execution::MemoryProvider {
...
class MemoryProvider {
  public:
     ...
     * @param projections: Defix which fields of the record are accessed. Empty projections means all fields.
     ...
     */
    virtual void write(Nautilus::Value<x::Nautilus::UInt64>& recordIndex,
                       Nautilus::Value<Nautilus::MemRef>& bufferAddress,
                       x::Nautilus::Record& rec) const = 0;
...
#endif// x_RUNTIME_INCLUDE_EXECUTION_MEMORYPROVIDER_MEMORYPROVIDER_HPP_
