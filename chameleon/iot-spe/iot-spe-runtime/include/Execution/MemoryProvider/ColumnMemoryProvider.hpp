...
*/
#ifndef x_RUNTIME_INCLUDE_EXECUTION_MEMORYPROVIDER_COLUMNMEMORYPROVIDER_HPP_
#define x_RUNTIME_INCLUDE_EXECUTION_MEMORYPROVIDER_COLUMNMEMORYPROVIDER_HPP_
...
class ColumnMemoryProvider final : public MemoryProvider {
  public:
    ...
    void write(Nautilus::Value<x::Nautilus::UInt64>& recordIndex,
               Nautilus::Value<Nautilus::MemRef>& bufferAddress,
               x::Nautilus::Record& rec) const override;
...
#endif// x_RUNTIME_INCLUDE_EXECUTION_MEMORYPROVIDER_COLUMNMEMORYPROVIDER_HPP_
