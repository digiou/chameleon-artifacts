...
#ifndef x_RUNTIME_INCLUDE_EXECUTION_EXPRESSIONS_TEXTFUNCTIONS_PATTERNMATCHING_EXTRACTINGREGEX_HPP_
#define x_RUNTIME_INCLUDE_EXECUTION_EXPRESSIONS_TEXTFUNCTIONS_PATTERNMATCHING_EXTRACTINGREGEX_HPP_
...
* @param idx as Integer defix at what position in the textValue matching starts (only the first match is returned), use 0 for the first
*/
...
#endif// x_RUNTIME_INCLUDE_EXECUTION_EXPRESSIONS_TEXTFUNCTIONS_PATTERNMATCHING_EXTRACTINGREGEX_HPP_
