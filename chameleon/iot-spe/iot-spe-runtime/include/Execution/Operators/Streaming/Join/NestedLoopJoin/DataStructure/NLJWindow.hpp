...
#ifndef x_RUNTIME_INCLUDE_EXECUTION_OPERATORS_STREAMING_JOIN_xTEDLOOPJOIN_DATASTRUCTURE_NLJWINDOW_HPP_
#define x_RUNTIME_INCLUDE_EXECUTION_OPERATORS_STREAMING_JOIN_xTEDLOOPJOIN_DATASTRUCTURE_NLJWINDOW_HPP_
...
/**
 * @brief This class represents a single window for the xted loop join. It stores all values for the left and right stream.
...
class NLJWindow : public StreamWindow {
  public:
    ...
    /**
     * @brief combix the PagedVectors for the left and right side. Afterwards, all tuples are stored in the first
...
#endif// x_RUNTIME_INCLUDE_EXECUTION_OPERATORS_STREAMING_JOIN_xTEDLOOPJOIN_DATASTRUCTURE_NLJWINDOW_HPP_
