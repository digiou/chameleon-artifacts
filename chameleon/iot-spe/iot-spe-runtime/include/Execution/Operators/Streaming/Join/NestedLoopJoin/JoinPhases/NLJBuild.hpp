...
#ifndef x_RUNTIME_INCLUDE_EXECUTION_OPERATORS_STREAMING_JOIN_xTEDLOOPJOIN_JOINPHASES_NLJBUILD_HPP_
#define x_RUNTIME_INCLUDE_EXECUTION_OPERATORS_STREAMING_JOIN_xTEDLOOPJOIN_JOINPHASES_NLJBUILD_HPP_
...
class NLJBuild : public ExecutableOperator {
  ...
  public:
     ...
     */
    class LocalxtedLoopJoinState : public Operators::OperatorState {
      public:
        LocalxtedLoopJoinState(const Value<MemRef>& operatorHandler,
     ...
     */
    void updateLocalJoinState(LocalxtedLoopJoinState* localJoinState,
...
#endif// x_RUNTIME_INCLUDE_EXECUTION_OPERATORS_STREAMING_JOIN_xTEDLOOPJOIN_JOINPHASES_NLJBUILD_HPP_
