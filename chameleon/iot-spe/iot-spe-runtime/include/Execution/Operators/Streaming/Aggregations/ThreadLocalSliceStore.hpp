...
*/
#ifndef x_RUNTIME_INCLUDE_EXECUTION_OPERATORS_STREAMING_AGGREGATIONS_THREADLOCALSLICESTORE_HPP_
#define x_RUNTIME_INCLUDE_EXECUTION_OPERATORS_STREAMING_AGGREGATIONS_THREADLOCALSLICESTORE_HPP_
  ...
  public:
    ...
    SliceTypePtr& findSliceByTs(uint64_t ts) {
        ...
        if (sliceIter == slices.rend()) {
            ...
            x_THROW_RUNTIME_ERROR("Error during slice lookup: We looked for ts: " << ts << " current front: "
...
#endif// x_RUNTIME_INCLUDE_EXECUTION_OPERATORS_STREAMING_AGGREGATIONS_THREADLOCALSLICESTORE_HPP_