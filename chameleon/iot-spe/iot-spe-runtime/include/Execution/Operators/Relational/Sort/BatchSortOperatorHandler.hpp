...
#ifndef x_RUNTIME_INCLUDE_EXECUTION_OPERATORS_RELATIONAL_SORT_BATCHSORTOPERATORHANDLER_HPP_
#define x_RUNTIME_INCLUDE_EXECUTION_OPERATORS_RELATIONAL_SORT_BATCHSORTOPERATORHANDLER_HPP_
...
class BatchSortOperatorHandler : public Runtime::Execution::OperatorHandler,
                                 public x::detail::virtual_enable_shared_from_this<BatchSortOperatorHandler, false> {
  public:
    /**
    ...
    explicit BatchSortOperatorHandler(const std::vector<PhysicalTypePtr>& dataTypes,
        ...
        x_ASSERT(dataTypes.size() == fieldIdentifiers.size(), "Data types and field identifiers must have the same size");
    ...
    void setup(Runtime::Execution::PipelineExecutionContext&) {
        ...
        auto tempAllocator = std::make_unique<xDefaultMemoryAllocator>();
...
#endif// x_RUNTIME_INCLUDE_EXECUTION_OPERATORS_RELATIONAL_SORT_BATCHSORTOPERATORHANDLER_HPP_
