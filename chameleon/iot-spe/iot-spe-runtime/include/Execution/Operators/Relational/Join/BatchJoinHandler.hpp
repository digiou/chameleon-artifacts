...
#ifndef x_RUNTIME_INCLUDE_EXECUTION_OPERATORS_RELATIONAL_JOIN_BATCHJOINHANDLER_HPP_
#define x_RUNTIME_INCLUDE_EXECUTION_OPERATORS_RELATIONAL_JOIN_BATCHJOINHANDLER_HPP_
...
class BatchJoinHandler : public Runtime::Execution::OperatorHandler,
                         public x::detail::virtual_enable_shared_from_this<BatchJoinHandler, false> {
...
#endif// x_RUNTIME_INCLUDE_EXECUTION_OPERATORS_RELATIONAL_JOIN_BATCHJOINHANDLER_HPP_
