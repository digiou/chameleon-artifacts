...
*/
#ifndef x_RUNTIME_INCLUDE_EXECUTION_OPERATORS_RELATIONAL_LIMIT_HPP_
#define x_RUNTIME_INCLUDE_EXECUTION_OPERATORS_RELATIONAL_LIMIT_HPP_
...
class LimitOperatorHandler : public Runtime::Execution::OperatorHandler,
                             public ::x::detail::virtual_enable_shared_from_this<LimitOperatorHandler, false> {
  public:
    /**
...
#endif// x_RUNTIME_INCLUDE_EXECUTION_OPERATORS_RELATIONAL_LIMIT_HPP_
