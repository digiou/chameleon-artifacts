...
#ifndef x_RUNTIME_INCLUDE_EXECUTION_PIPELIx_EXECUTABLEPIPELINEPROVIDER_HPP_
#define x_RUNTIME_INCLUDE_EXECUTION_PIPELIx_EXECUTABLEPIPELINEPROVIDER_HPP_
...
class ExecutablePipelineProvider {
  public:
     ...
     * @return std::unique_ptr<ExecutablePipelixtage>
     */
    virtual std::unique_ptr<ExecutablePipelixtage> create(std::shared_ptr<PhysicalOperatorPipeline> physicalOperatorPipeline,
                                                            const Nautilus::CompilationOptions&) = 0;
    virtual ~ExecutablePipelineProvider() = default;
};

using ExecutablePipelineProviderRegistry = x::Util::NamedPluginRegistry<ExecutablePipelineProvider>;

}// namespace x::Runtime::Execution

#endif// x_RUNTIME_INCLUDE_EXECUTION_PIPELIx_EXECUTABLEPIPELINEPROVIDER_HPP_
