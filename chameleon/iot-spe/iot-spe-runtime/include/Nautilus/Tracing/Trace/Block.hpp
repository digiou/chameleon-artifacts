...
*/
#ifndef x_RUNTIME_INCLUDE_NAUTILUS_TRACING_TRACE_BLOCK_HPP_
#define x_RUNTIME_INCLUDE_NAUTILUS_TRACING_TRACE_BLOCK_HPP_
...
class Block {
  public:
    ...
    /**
     * @brief Check if this block defix a specific ValueRef as a parameter or result of an operation
     * @param ref
     * @return
     */
    ...
    /**
     * @brief defix the id of this block.
     */
    uint32_t blockId;

    /**
     * @brief defix the type of this block.
     */
    Type type;
    ...
    /**
     * @brief Defix a list of operations this block contains.
     */
...
#endif// x_RUNTIME_INCLUDE_NAUTILUS_TRACING_TRACE_BLOCK_HPP_
