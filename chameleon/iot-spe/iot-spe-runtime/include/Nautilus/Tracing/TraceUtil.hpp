...
#ifndef x_RUNTIME_INCLUDE_NAUTILUS_TRACING_TRACEUTIL_HPP_
#define x_RUNTIME_INCLUDE_NAUTILUS_TRACING_TRACEUTIL_HPP_
#include <Nautilus/Tracing/Trace/OpCode.hpp>
namespace x::Nautilus::Tracing {
class ValueRef;
}

namespace x::Nautilus::Tracing::TraceUtil {
...
#endif// x_RUNTIME_INCLUDE_NAUTILUS_TRACING_TRACEUTIL_HPP_
