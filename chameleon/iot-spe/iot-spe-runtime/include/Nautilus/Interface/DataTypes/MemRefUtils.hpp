...
#ifndef x_RUNTIME_INCLUDE_NAUTILUS_INTERFACE_DATATYPES_MEMREFUTILS_HPP_
#define x_RUNTIME_INCLUDE_NAUTILUS_INTERFACE_DATATYPES_MEMREFUTILS_HPP_
...
namespace x::Nautilus::MemRefUtils {
...
#define getMember(objectReference, classType, member)                                                                            \
    (objectReference + ((uint64_t) __builtin_offsetof(classType, member))).as<x::Nautilus::MemRef>()

}// namespace x::Nautilus::MemRefUtils
#endif// x_RUNTIME_INCLUDE_NAUTILUS_INTERFACE_DATATYPES_MEMREFUTILS_HPP_
