...
*/
#ifndef x_RUNTIME_INCLUDE_NAUTILUS_INTERFACE_PAGEDVECTOR_PAGEDVECTOR_HPP_
#define x_RUNTIME_INCLUDE_NAUTILUS_INTERFACE_PAGEDVECTOR_PAGEDVECTOR_HPP_
...
class PagedVector {
  public:
    ...
    /**
     * @brief Combix this PagedVector with another one by adding the other.pages to these pages
...
#endif// x_RUNTIME_INCLUDE_NAUTILUS_INTERFACE_PAGEDVECTOR_PAGEDVECTOR_HPP_
