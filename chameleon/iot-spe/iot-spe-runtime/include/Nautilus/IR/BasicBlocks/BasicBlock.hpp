...
#ifndef x_RUNTIME_INCLUDE_NAUTILUS_IR_BASICBLOCKS_BASICBLOCK_HPP_
#define x_RUNTIME_INCLUDE_NAUTILUS_IR_BASICBLOCKS_BASICBLOCK_HPP_
...
class BasicBlock : public std::enable_shared_from_this<BasicBlock> {
  public:
    /**
     * @brief BasicBlock used for control flow in x IR
...
#endif// x_RUNTIME_INCLUDE_NAUTILUS_IR_BASICBLOCKS_BASICBLOCK_HPP_
