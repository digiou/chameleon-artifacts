...
*/
#ifndef x_RUNTIME_INCLUDE_NAUTILUS_IR_TYPES_FLOATSTAMP_HPP_
#define x_RUNTIME_INCLUDE_NAUTILUS_IR_TYPES_FLOATSTAMP_HPP_
...
class FloatStamp : public Stamp {
  public:
     ...
     * @param bitWidth defix the width of the float, can be 32, and 64bit.
     */
...
#endif// x_RUNTIME_INCLUDE_NAUTILUS_IR_TYPES_FLOATSTAMP_HPP_
