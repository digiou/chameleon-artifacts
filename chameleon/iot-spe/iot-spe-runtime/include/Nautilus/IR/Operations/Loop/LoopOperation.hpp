...
#ifndef x_RUNTIME_INCLUDE_NAUTILUS_IR_OPERATIONS_LOOP_LOOPOPERATION_HPP_
#define x_RUNTIME_INCLUDE_NAUTILUS_IR_OPERATIONS_LOOP_LOOPOPERATION_HPP_
...
/**
 * @brief Iterates over a buffer. Loads a record on each iteration. Contains operations which are xted inside of the LoopBlock.
...
#endif// x_RUNTIME_INCLUDE_NAUTILUS_IR_OPERATIONS_LOOP_LOOPOPERATION_HPP_
