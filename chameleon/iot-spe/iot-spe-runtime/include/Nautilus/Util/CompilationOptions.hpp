...
*/
#ifndef x_RUNTIME_INCLUDE_NAUTILUS_UTIL_COMPILATIONOPTIONS_HPP_
#define x_RUNTIME_INCLUDE_NAUTILUS_UTIL_COMPILATIONOPTIONS_HPP_
#include <cstdint>
#include <string>
namespace x::Nautilus {

/**
 * @brief Defix a set of compilation options for nautilus compilation backends.
 */
...
#endif// x_RUNTIME_INCLUDE_NAUTILUS_UTIL_COMPILATIONOPTIONS_HPP_
