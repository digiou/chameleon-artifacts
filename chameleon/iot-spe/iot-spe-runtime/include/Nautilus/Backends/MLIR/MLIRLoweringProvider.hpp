...
#ifndef x_RUNTIME_INCLUDE_NAUTILUS_BACKENDS_MLIR_MLIRLOWERINGPROVIDER_HPP_
#define x_RUNTIME_INCLUDE_NAUTILUS_BACKENDS_MLIR_MLIRLOWERINGPROVIDER_HPP_
...
class MLIRLoweringProvider {
  ...
  private:
    ...
    x::ProxyFunctions ProxyFunctions;
    ...
    /**
     * @brief Get the Bit Width from a basic x type.
     * @param type: Basic x type.
...
#endif// x_RUNTIME_INCLUDE_NAUTILUS_BACKENDS_MLIR_MLIRLOWERINGPROVIDER_HPP_
