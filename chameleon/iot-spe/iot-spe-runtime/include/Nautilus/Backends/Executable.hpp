...
#ifndef x_RUNTIME_INCLUDE_NAUTILUS_BACKENDS_EXECUTABLE_HPP_
#define x_RUNTIME_INCLUDE_NAUTILUS_BACKENDS_EXECUTABLE_HPP_
#include <any>
#include <memory>
#include <string>
#include <variant>
...
class Executable {
  ...
  protected:
    ...
    /**
     * @brief Determix if the executable can be called by a function ptr
     * @return bool
     */
...
#endif// x_RUNTIME_INCLUDE_NAUTILUS_BACKENDS_EXECUTABLE_HPP_
