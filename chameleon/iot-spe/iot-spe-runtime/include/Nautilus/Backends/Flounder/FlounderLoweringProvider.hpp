...
*/
#ifndef x_RUNTIME_INCLUDE_NAUTILUS_BACKENDS_FLOUNDER_FLOUNDERLOWERINGPROVIDER_HPP_
#define x_RUNTIME_INCLUDE_NAUTILUS_BACKENDS_FLOUNDER_FLOUNDERLOWERINGPROVIDER_HPP_
...
class FlounderLoweringProvider {
  public:
    ...
    std::unique_ptr<flounder::Executable> lower(std::shared_ptr<IR::IRGraph> ir, const x::DumpHelper& helper);
  ...
  private:
    ...
    class LoweringContext {
      public:
        ...
        std::unique_ptr<flounder::Executable> process(flounder::Compiler& compiler, const x::DumpHelper&);
...
#endif// x_RUNTIME_INCLUDE_NAUTILUS_BACKENDS_FLOUNDER_FLOUNDERLOWERINGPROVIDER_HPP_
