...
*/
#ifndef x_RUNTIME_INCLUDE_NAUTILUS_BACKENDS_BCINTERPRETER_BYTECODE_HPP_
#define x_RUNTIME_INCLUDE_NAUTILUS_BACKENDS_BCINTERPRETER_BYTECODE_HPP_
...
namespace x::Nautilus::Backends::BC {

/**
 * @brief This defix the central register file for the byte-code interpreter.
...
/**
 * @brief Defix an enum of all byte codes.
 */
...
/**
 * @brief Defix a function call target, that contains all information's necessary to call a function
 */
...
/**
 * @brief Defix a call operation for our bytecode interpreter.
...
/**
 * @brief Defix an and in the bytecode interpreter
 * @tparam RegisterType
 * @param c
 * @param regs
 */
...
/**
 * @brief Defix an or in the bytecode interpreter
 * @tparam RegisterType
 * @param c
 * @param regs
 */
...
/**
 * @brief Defix an not in the bytecode interpreter
 * @tparam RegisterType
 * @param c
 * @param regs
 */
...
/**
 * @brief Defix an add in the bytecode interpreter
 * @tparam RegisterType
 * @param c
 * @param regs
 */
...
/**
 * @brief Defix an sub in the bytecode interpreter
 * @tparam RegisterType
 * @param c
 * @param regs
 */
...
/**
 * @brief Defix an mul in the bytecode interpreter
 * @tparam RegisterType
 * @param c
 * @param regs
 */
...
/**
 * @brief Defix a div in the bytecode interpreter
 * @tparam RegisterType
 * @param c
 * @param regs
 */
...
/**
 * @brief Defix an equals in the bytecode interpreter
 * @tparam RegisterType
 * @param c
 * @param regs
 */
...
/**
 * @brief Defix an less than in the bytecode interpreter
 * @tparam RegisterType
 * @param c
 * @param regs
 */
...
/**
 * @brief Defix an greater than in the bytecode interpreter
 * @tparam RegisterType
 * @param c
 * @param regs
 */
...
/**
 * @brief Defix an load in the bytecode interpreter
 * @tparam RegisterType
 * @param c
 * @param regs
 */
...
/**
 * @brief Defix an store in the bytecode interpreter
 * @tparam RegisterType
 * @param c
 * @param regs
 */
...
/**
 * @brief Defix a cast in the bytecode interpreter
 * @tparam RegisterType
 * @param c
 * @param regs
 */
...
/**
 * @brief Defix a final branch terminator operation
 */
struct BranchOp {
    short nextBlock;
};
...
#endif// x_RUNTIME_INCLUDE_NAUTILUS_BACKENDS_BCINTERPRETER_BYTECODE_HPP_
