...
#ifndef x_DATA_TYPES_INCLUDE_COMMON_PHYSICALTYPES_PHYSICALTYPE_HPP_
#define x_DATA_TYPES_INCLUDE_COMMON_PHYSICALTYPES_PHYSICALTYPE_HPP_
...
/**
 * @brief The physical data type represents the physical representation of a x data type.
 */
class PhysicalType {
  public:
...
#endif// x_DATA_TYPES_INCLUDE_COMMON_PHYSICALTYPES_PHYSICALTYPE_HPP_
