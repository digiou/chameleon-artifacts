...
#ifndef x_DATA_TYPES_INCLUDE_COMMON_PHYSICALTYPES_BASICPHYSICALTYPE_HPP_
#define x_DATA_TYPES_INCLUDE_COMMON_PHYSICALTYPES_BASICPHYSICALTYPE_HPP_

#include <Common/PhysicalTypes/PhysicalType.hpp>
namespace x {

/**
 * @brief The BasicPhysicalType represents x data types, which can be directly mapped to a native c++ type.
 */
class BasicPhysicalType final : public PhysicalType {
  public:
     ...
     * @param nativeType the native type of the x type.
     */
...
#endif// x_DATA_TYPES_INCLUDE_COMMON_PHYSICALTYPES_BASICPHYSICALTYPE_HPP_
