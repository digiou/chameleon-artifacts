...
#ifndef x_DATA_TYPES_INCLUDE_COMMON_PHYSICALTYPES_PHYSICALTYPEUTIL_HPP_
#define x_DATA_TYPES_INCLUDE_COMMON_PHYSICALTYPES_PHYSICALTYPEUTIL_HPP_

#include <Common/ExecutableType/xType.hpp>
#include <cstdint>

namespace x::PhysicalTypes {
...
bool isSamePhysicalType(PhysicalTypePtr physicalType) {
    ...
    } else if constexpr (std::is_base_of_v<xType, Type>) {
...
#endif// x_DATA_TYPES_INCLUDE_COMMON_PHYSICALTYPES_PHYSICALTYPEUTIL_HPP_
