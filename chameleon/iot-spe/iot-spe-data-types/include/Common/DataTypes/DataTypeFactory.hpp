...
#ifndef x_DATA_TYPES_INCLUDE_COMMON_DATATYPES_DATATYPEFACTORY_HPP_
#define x_DATA_TYPES_INCLUDE_COMMON_DATATYPES_DATATYPEFACTORY_HPP_
...
class DataTypeFactory {
  ...
  public:
    ...
    */
     ...
     *        Has only support for non-xted array types.
     *
     ...
     *        For instance: DataTypePtr: ArrayType with componentType int, values = {42, 21}.
     *
     * @param type: ArrayType type (not xted).
     *
     * @param values the value as a vector of strings, which represent the individual values.
     */
...
#endif// x_DATA_TYPES_INCLUDE_COMMON_DATATYPES_DATATYPEFACTORY_HPP_
